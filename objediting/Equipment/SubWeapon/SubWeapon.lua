...
createEquipmentItem('I0G0', '超位魔法残章·天空坠落', {
  ...
  score = 12500,
  activelyUsed = true,
  tooltipExtended = '|cffccffff[副武器/法典]-超位法术|r|n|cffffcc99等级：A|n评分：12500|r|n|cffffffcc[基础属性]|r|n智力+90|n魔法伤害+30%|n魔法穿透+26%|n魔法值+1800|n冷却缩减+15%|n|cffffffcc[装备效果]|r|n使用·天空坠落：引导2.5秒（可被移动或强控制中断）后，对目标点500范围敌人造成1800+智力×7的魔法伤害，冷却90秒。|n|cFF808080残章只保留了一页，却足以让高空的法阵重新注视地面。|r',
  description = '|cffccffff[副武器/法典]-超位法术|r|n|cffffcc99等级：A|n评分：12500|r|n|cffffffcc[基础属性]|r|n智力+90|n魔法伤害+30%|n魔法穿透+26%|n魔法值+1800|n冷却缩减+15%|n|cffffffcc[装备效果]|r|n使用·天空坠落：引导2.5秒（可被移动或强控制中断）后，对目标点500范围敌人造成1800+智力×7的魔法伤害，冷却90秒。|n|cFF808080残章只保留了一页，却足以让高空的法阵重新注视地面。|r',
})
...
createEquipmentItem('I0G2', '黑翼守护重盾', {
  ...
  score = 12000,
  activelyUsed = true,
  tooltipExtended = '|cffccffff[副武器/盾牌]-前排/护卫|r|n|cffffcc99等级：A|n评分：12000|r|n|cffffffcc[基础属性]|r|n生命值+4800|n护甲+60|n物理抗性+18%|n控制抗性+30%|n全属性+30|n|cffffffcc[装备效果]|r|n使用·守护者之职责：引导1秒后与一名友方英雄建立8秒守护连接；自身获得最大生命12%的护盾，目标获得最大生命10%的护盾，均持续8秒。连接期间目标35%的直接伤害转移给自身；自身生命≤20%时连接提前结束，冷却45秒。|n|cFF808080黑翼沿盾缘向内收拢，像一名永不离开至尊身前的守护者。|r',
  description = '|cffccffff[副武器/盾牌]-前排/护卫|r|n|cffffcc99等级：A|n评分：12000|r|n|cffffffcc[基础属性]|r|n生命值+4800|n护甲+60|n物理抗性+18%|n控制抗性+30%|n全属性+30|n|cffffffcc[装备效果]|r|n使用·守护者之职责：引导1秒后与一名友方英雄建立8秒守护连接；自身获得最大生命12%的护盾，目标获得最大生命10%的护盾，均持续8秒。连接期间目标35%的直接伤害转移给自身；自身生命≤20%时连接提前结束，冷却45秒。|n|cFF808080黑翼沿盾缘向内收拢，像一名永不离开至尊身前的守护者。|r',
})
