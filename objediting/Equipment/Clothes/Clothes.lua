...
createEquipmentItem('I0FO', '最后阵地重铠', {
  ...
  level = 6,
  score = 10200,
  tooltipExtended = '|cffccffff[衣服/重甲]-守阵/承压|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4200|n护甲+50|n力量+45|n控制抗性+30%|n|cffffffcc[装备效果]|r|n最后阵地：战斗中在首次驻留位置160范围内持续停留3秒后，每秒叠加1层守阵。每层护甲+18、物理抗性+12%、控制抗性+20%，独立持续2.2秒，最多3层；移动超过160后停止叠层，现有层数按剩余时间消失。|n|cFF808080每一道凹痕都记着一次没有后退的防线。|r',
  description = '|cffccffff[衣服/重甲]-守阵/承压|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4200|n护甲+50|n力量+45|n控制抗性+30%|n|cffffffcc[装备效果]|r|n最后阵地：战斗中在首次驻留位置160范围内持续停留3秒后，每秒叠加1层守阵。每层护甲+18、物理抗性+12%、控制抗性+20%，独立持续2.2秒，最多3层；移动超过160后停止叠层，现有层数按剩余时间消失。|n|cFF808080每一道凹痕都记着一次没有后退的防线。|r',
})
...
createEquipmentItem('I0FU', '裂誓战躯重铠', {
  ...
  level = 6,
  score = 6900,
  tooltipExtended = '|cffccffff[衣服/重甲]-前排/低血防御|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+38|n力量+30|n控制抗性+25%|n|cffffffcc[装备效果]|r|n残誓不退：受伤后生命≤35%时，获得物理抗性+25%、魔法抗性+18%、控制抗性+40%，持续6秒；移动速度降低25%，冷却45秒。|n|cFF808080裂开的誓纹仍向内收紧，让这副战躯沉重得无法轻易后退。|r',
  description = '|cffccffff[衣服/重甲]-前排/低血防御|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+38|n力量+30|n控制抗性+25%|n|cffffffcc[装备效果]|r|n残誓不退：受伤后生命≤35%时，获得物理抗性+25%、魔法抗性+18%、控制抗性+40%，持续6秒；移动速度降低25%，冷却45秒。|n|cFF808080裂开的誓纹仍向内收紧，让这副战躯沉重得无法轻易后退。|r',
})
...
createEquipmentItem('I0G4', '真祖女武神血铠', {
  ...
  level = 6,
  score = 10200,
  tooltipExtended = '|cffccffff[衣服/铠甲]-前排/低血反攻|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4000|n护甲+48|n攻击速度+30%|n控制抗性+25%|n魔法抗性+18%|n|cffffffcc[装备效果]|r|n血宴武装：受到不低于最大生命值6%的直接伤害时获得1枚血晶，最多3枚，每2秒至多获得1枚，血晶持续12秒并刷新持续时间。生命≤35%时消耗全部血晶：获得最大生命值（5%+每枚血晶4%）的护盾和每枚血晶+18%攻速，均持续6秒。|n|cFF808080银黑铠片间嵌着三枚沉睡血晶，只在濒危时回应真正的战意。|r',
  description = '|cffccffff[衣服/铠甲]-前排/低血反攻|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4000|n护甲+48|n攻击速度+30%|n控制抗性+25%|n魔法抗性+18%|n|cffffffcc[装备效果]|r|n血宴武装：受到不低于最大生命值6%的直接伤害时获得1枚血晶，最多3枚，每2秒至多获得1枚，血晶持续12秒并刷新持续时间。生命≤35%时消耗全部血晶：获得最大生命值（5%+每枚血晶4%）的护盾和每枚血晶+18%攻速，均持续6秒。|n|cFF808080银黑铠片间嵌着三枚沉睡血晶，只在濒危时回应真正的战意。|r',
})
