...
createEquipmentItem('I0FO', '最后阵地重铠', {
  ...
  level = 6,
  score = 10200,
  tooltipExtended = '|cffccffff[衣服/重甲]-守阵/承压|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4200|n护甲+50|n力量+45|n控制抗性+30%|n|cffffffcc[装备效果]|r|n最后阵地：在小范围内保持站位后建立守阵状态，提高护甲、减伤与抗硬直；离开较远后结束。|n|cFF808080每一道凹痕都记着一次没有后退的防线。|r',
  description = '|cffccffff[衣服/重甲]-守阵/承压|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4200|n护甲+50|n力量+45|n控制抗性+30%|n|cffffffcc[装备效果]|r|n最后阵地：在小范围内保持站位后建立守阵状态，提高护甲、减伤与抗硬直；离开较远后结束。|n|cFF808080每一道凹痕都记着一次没有后退的防线。|r',
})
...
createEquipmentItem('I0FU', '裂誓战躯重铠', {
  ...
  level = 6,
  score = 6900,
  tooltipExtended = '|cffccffff[衣服/重甲]-前排/低血防御|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+38|n力量+30|n控制抗性+25%|n|cffffffcc[装备效果]|r|n残誓不退：生命首次降至较低比例时进入重躯状态，获得减伤与抗硬直，但移动速度降低。|n|cFF808080裂开的誓纹仍向内收紧，让这副战躯沉重得无法轻易后退。|r',
  description = '|cffccffff[衣服/重甲]-前排/低血防御|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+38|n力量+30|n控制抗性+25%|n|cffffffcc[装备效果]|r|n残誓不退：生命首次降至较低比例时进入重躯状态，获得减伤与抗硬直，但移动速度降低。|n|cFF808080裂开的誓纹仍向内收紧，让这副战躯沉重得无法轻易后退。|r',
})
...
createEquipmentItem('I0G4', '真祖女武神血铠', {
  ...
  level = 6,
  score = 10200,
  tooltipExtended = '|cffccffff[衣服/铠甲]-前排/低血反攻|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4000|n护甲+48|n攻击速度+30%|n控制抗性+25%|n魔法抗性+18%|n|cffffffcc[装备效果]|r|n血宴武装：承受高额直接伤害时积累血晶，低生命时消耗血晶获得护盾和短时攻速。|n|cFF808080银黑铠片间嵌着三枚沉睡血晶，只在濒危时回应真正的战意。|r',
  description = '|cffccffff[衣服/铠甲]-前排/低血反攻|r|n|cffffcc99等级：B++|n评分：10200|r|n|cffffffcc[基础属性]|r|n生命值+4000|n护甲+48|n攻击速度+30%|n控制抗性+25%|n魔法抗性+18%|n|cffffffcc[装备效果]|r|n血宴武装：承受高额直接伤害时积累血晶，低生命时消耗血晶获得护盾和短时攻速。|n|cFF808080银黑铠片间嵌着三枚沉睡血晶，只在濒危时回应真正的战意。|r',
})
