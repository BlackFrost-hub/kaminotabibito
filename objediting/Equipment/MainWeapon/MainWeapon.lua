...
dofile('Equipment/MainWeapon/Sword/ChapterMinionDrops.lua')
dofile('Equipment/MainWeapon/AxeHammer/AxeHammer.lua')
dofile('Equipment/MainWeapon/AxeHammer/ChapterMinionDrops.lua')
dofile('Equipment/MainWeapon/Staff/Staff.lua')
dofile('Equipment/MainWeapon/Staff/ChapterMinionDrops.lua')
...
dofile('Equipment/MainWeapon/Bow/ChapterMinionDrops.lua')
