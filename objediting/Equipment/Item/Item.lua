...
createEquipmentItem('I0FS', '安魂守墓灯', {
  ...
  level = 6,
  score = 10100,
  tooltipExtended = '|cffccffff[饰品/辅助]-治疗/延迟保护|r|n|cffffcc99等级：B++|n评分：10100|r|n|cffffffcc[基础属性]|r|n冷却缩减+14%|n技能治疗率+25%|n魔法恢复+32|n生命值+2200|n控制抗性+22%|n|cffffffcc[装备效果]|r|n安魂余光：治疗或护盾作用于生命≤50%的友方时，进入2秒观察。期间未受伤则恢复6%最大生命值与250点魔法；生命仍≤50%时会再次进入2秒观察。受伤则获得物理与魔法抗性+15%，持续4秒。|n|cFF808080灯里的魂火不为墓地照路，只替仍在战斗的人保留片刻安宁。|r',
  description = '|cffccffff[饰品/辅助]-治疗/延迟保护|r|n|cffffcc99等级：B++|n评分：10100|r|n|cffffffcc[基础属性]|r|n冷却缩减+14%|n技能治疗率+25%|n魔法恢复+32|n生命值+2200|n控制抗性+22%|n|cffffffcc[装备效果]|r|n安魂余光：治疗或护盾作用于生命≤50%的友方时，进入2秒观察。期间未受伤则恢复6%最大生命值与250点魔法；生命仍≤50%时会再次进入2秒观察。受伤则获得物理与魔法抗性+15%，持续4秒。|n|cFF808080灯里的魂火不为墓地照路，只替仍在战斗的人保留片刻安宁。|r',
})
...
createEquipmentItem('I0FZ', '月白归静圣铃', {
  ...
  level = 6,
  score = 6900,
  tooltipExtended = '|cffccffff[饰品/辅助]-保护/控制缓冲|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n冷却缩减+12%|n技能治疗率+22%|n魔法消耗减少+10%|n生命值+1500|n眩晕抗性+18%|n|cffffffcc[装备效果]|r|n净誓余辉：对生命≤45%的友方施加治疗或护盾时，使其获得物理抗性和魔抗+15%、眩晕抗性+30%，持续5秒；同一目标冷却10秒。|n|cFF808080铃声落下时，躁动的灵识会像月光下的水面一样重新归静。|r',
  description = '|cffccffff[饰品/辅助]-保护/控制缓冲|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n冷却缩减+12%|n技能治疗率+22%|n魔法消耗减少+10%|n生命值+1500|n眩晕抗性+18%|n|cffffffcc[装备效果]|r|n净誓余辉：对生命≤45%的友方施加治疗或护盾时，使其获得物理抗性和魔抗+15%、眩晕抗性+30%，持续5秒；同一目标冷却10秒。|n|cFF808080铃声落下时，躁动的灵识会像月光下的水面一样重新归静。|r',
})
