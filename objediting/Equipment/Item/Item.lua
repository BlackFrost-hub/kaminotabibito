-- Accessory, bracer, special, and generic item-slot equipment.
...
createEquipmentItem('I0EB', '纯净水源吊坠', {
  ...
  level = 6,
  score = 6800,
  tooltipExtended = '|cffccffff[道具/饰品]-生存/恢复|r|n|cffffcc99等级：B|n评分：6800|r|n|cffffffcc[基础属性]|r|n生命值+2600|n魔法抗性+25%|n治疗效果+20%|n生命恢复+120|n|cffffffcc[特效]|r|n净水回响：受到伤害时恢复5%最大生命值，冷却18秒。|n|cFF808080污染水域中仅存的一缕清流被封入吊坠，像在浊浪里固执发光。|r',
...
createEquipmentItem('I0E0', '执法者徽记', {
  ...
  level = 6,
  score = 6400,
  tooltipExtended = '|cffccffff[道具/戒指/饰品]-通用/控制|r|n|cffffcc99等级：B-|n评分：6400|r|n|cffffffcc[基础属性]|r|n全属性+32|n护甲+15|n冷却缩减+10%|n|cffffffcc[特效]|r|n秩序守护：攻击时有10%概率使目标沉默2秒；同一目标8秒内只触发一次。|n|cFF808080执法者徽记曾用于标记城防裁决，表面的月白纹路仍残留审判余温。|r',
  description = '|cffccffff[道具/戒指/饰品]-通用/控制|r|n|cffffcc99等级：B-|n评分：6400|r|n|cffffffcc[基础属性]|r|n全属性+32|n护甲+15|n冷却缩减+10%|n|cffffffcc[特效]|r|n秩序守护：攻击时有10%概率使目标沉默2秒；同一目标8秒内只触发一次。|n|cFF808080执法者徽记曾用于标记城防裁决，表面的月白纹路仍残留审判余温。|r',
})
...
createEquipmentItem('I0E1', '月光锁链护腕', {
  ...
  level = 6,
  score = 6200,
  tooltipExtended = '|cffccffff[道具/戒指/饰品]-敏捷/反制|r|n|cffffcc99等级：B-|n评分：6200|r|n|cffffffcc[基础属性]|r|n敏捷+45|n攻击速度+50%|n生命值+600|n|cffffffcc[特效]|r|n束缚反击：自身受到控制时，获得2秒30%减伤，并反弹本次伤害30%；冷却12秒。|n|cFF808080护腕上缠绕着断裂的月光锁链，越是挣扎，越能听见细碎银响。|r',
  description = '|cffccffff[道具/戒指/饰品]-敏捷/反制|r|n|cffffcc99等级：B-|n评分：6200|r|n|cffffffcc[基础属性]|r|n敏捷+45|n攻击速度+50%|n生命值+600|n|cffffffcc[特效]|r|n束缚反击：自身受到控制时，获得2秒30%减伤，并反弹本次伤害30%；冷却12秒。|n|cFF808080护腕上缠绕着断裂的月光锁链，越是挣扎，越能听见细碎银响。|r',
})
...
createEquipmentItem('I0EK', '双卫之誓', {
  ...
  level = 7,
  score = 9500,
  tooltipExtended = '|cffccffff[道具/饰品]-均衡/守护|r|n|cffffcc99等级：B++|n评分：9500|r|n|cffffffcc[基础属性]|r|n全属性+38|n护甲+22|n魔法抗性+20%|n生命值+2200|n|cFF808080两名护卫的誓约被熔火与寒焰一同封存，像一枚沉默的战印。|r',
  description = '|cffccffff[道具/饰品]-均衡/守护|r|n|cffffcc99等级：B++|n评分：9500|r|n|cffffffcc[基础属性]|r|n全属性+38|n护甲+22|n魔法抗性+20%|n生命值+2200|n|cFF808080两名护卫的誓约被熔火与寒焰一同封存，像一枚沉默的战印。|r',
})
...
createEquipmentItem('I0EL', '炽凰尾羽', {
  ...
  level = 7,
  score = 9000,
  tooltipExtended = '|cffccffff[道具/材料]-敏捷/火焰|r|n|cffffcc99等级：B+|n评分：9000|r|n|cffffffcc[基础属性]|r|n敏捷+45|n攻击速度+35%|n火属性伤害+20%|n|cFF808080菲尼克斯尔坠落的尾羽仍有余烬，羽脉里像流着细小的熔岩。|r',
  description = '|cffccffff[道具/材料]-敏捷/火焰|r|n|cffffcc99等级：B+|n评分：9000|r|n|cffffffcc[基础属性]|r|n敏捷+45|n攻击速度+35%|n火属性伤害+20%|n|cFF808080菲尼克斯尔坠落的尾羽仍有余烬，羽脉里像流着细小的熔岩。|r',
})
...
createEquipmentItem('I0EM', '熔岩结晶护符', {
  ...
  level = 7,
  score = 9200,
  tooltipExtended = '|cffccffff[道具/饰品]-生存/火抗|r|n|cffffcc99等级：B+|n评分：9200|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+28|n火属性抗性+25%|n生命恢复+100|n|cFF808080熔岩冷却后形成的护符，裂隙里仍保留着火山心脏的颜色。|r',
  description = '|cffccffff[道具/饰品]-生存/火抗|r|n|cffffcc99等级：B+|n评分：9200|r|n|cffffffcc[基础属性]|r|n生命值+3000|n护甲+28|n火属性抗性+25%|n生命恢复+100|n|cFF808080熔岩冷却后形成的护符，裂隙里仍保留着火山心脏的颜色。|r',
})
...
createEquipmentItem('I0FB', '腐朽孢子秘瓶', {
  ...
  level = 6,
  score = 6950,
  tooltipExtended = '|cffccffff[特殊/饰品]-持续伤害|r|n|cffffcc99等级：B|n评分：6950|r|n|cffffffcc[基础属性]|r|n智力+45|n魔法伤害+22%|n持续伤害+16%|n暗属性伤害+16%|n魔法穿透+16%|n|cffffffcc[特效]|r|n腐朽孢子：技能造成伤害时，有12%概率对目标300范围敌人造成攻击力25%的暗属性伤害，冷却4秒。|n|cFF808080瓶中孢子像灰绿色星尘一样浮沉，越靠近魔力越躁动。|r',
  description = '|cffccffff[特殊/饰品]-持续伤害|r|n|cffffcc99等级：B|n评分：6950|r|n|cffffffcc[基础属性]|r|n智力+45|n魔法伤害+22%|n持续伤害+16%|n暗属性伤害+16%|n魔法穿透+16%|n|cffffffcc[特效]|r|n腐朽孢子：技能造成伤害时，有12%概率对目标300范围敌人造成攻击力25%的暗属性伤害，冷却4秒。|n|cFF808080瓶中孢子像灰绿色星尘一样浮沉，越靠近魔力越躁动。|r',
})
...
createEquipmentItem('I0FS', '安魂守墓灯', {
  ...
  level = 6,
  score = 10100,
  tooltipExtended = '|cffccffff[饰品/辅助]-治疗/延迟保护|r|n|cffffcc99等级：B++|n评分：10100|r|n|cffffffcc[基础属性]|r|n冷却缩减+14%|n技能治疗率+25%|n魔法恢复+32|n生命值+2200|n控制抗性+22%|n|cffffffcc[装备效果]|r|n安魂余光：治疗或护盾作用于生命≤50%的友方时，进入2秒观察。期间未受伤则恢复6%最大生命值（0.25秒内）；受伤则获得物理与魔法抗性+15%，持续4秒。|n|cFF808080灯里的魂火不为墓地照路，只替仍在战斗的人保留片刻安宁。|r',
  description = '|cffccffff[饰品/辅助]-治疗/延迟保护|r|n|cffffcc99等级：B++|n评分：10100|r|n|cffffffcc[基础属性]|r|n冷却缩减+14%|n技能治疗率+25%|n魔法恢复+32|n生命值+2200|n控制抗性+22%|n|cffffffcc[装备效果]|r|n安魂余光：治疗或护盾作用于生命≤50%的友方时，进入2秒观察。期间未受伤则恢复6%最大生命值（0.25秒内）；受伤则获得物理与魔法抗性+15%，持续4秒。|n|cFF808080灯里的魂火不为墓地照路，只替仍在战斗的人保留片刻安宁。|r',
})
...
createEquipmentItem('I0FY', '双钥归一棱镜', {
  ...
  level = 6,
  score = 6950,
  tooltipExtended = '|cffccffff[饰品/全能]-普攻/技能混合|r|n|cffffcc99等级：B|n评分：6950|r|n|cffffffcc[基础属性]|r|n全属性+28|n攻击力+90|n技能伤害+16%|n冷却缩减+8%|n|cffffffcc[装备效果]|r|n双钥共鸣：纯普攻获得武魂钥、非装备技能伤害获得灵识钥，钥匙各持续6秒；两钥同时存在时，对当前目标260范围敌人造成180+攻击力55%的魔法伤害，并获得最大生命值6%的护盾，持续4秒，冷却6秒。|n|cFF808080暗金与冷蓝两道灵印在棱镜中心归一，缺少任何一侧都无法点亮。|r',
  description = '|cffccffff[饰品/全能]-普攻/技能混合|r|n|cffffcc99等级：B|n评分：6950|r|n|cffffffcc[基础属性]|r|n全属性+28|n攻击力+90|n技能伤害+16%|n冷却缩减+8%|n|cffffffcc[装备效果]|r|n双钥共鸣：纯普攻获得武魂钥、非装备技能伤害获得灵识钥，钥匙各持续6秒；两钥同时存在时，对当前目标260范围敌人造成180+攻击力55%的魔法伤害，并获得最大生命值6%的护盾，持续4秒，冷却6秒。|n|cFF808080暗金与冷蓝两道灵印在棱镜中心归一，缺少任何一侧都无法点亮。|r',
})
...
createEquipmentItem('I0FZ', '月白归静圣铃', {
  ...
  level = 6,
  score = 6900,
  tooltipExtended = '|cffccffff[饰品/辅助]-保护/控制缓冲|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n冷却缩减+12%|n技能治疗率+22%|n魔法消耗减少+10%|n生命值+1500|n控制抗性+18%|n|cffffffcc[装备效果]|r|n净誓余辉：对生命≤45%的友方施加治疗或护盾时，使其获得物理/魔法抗性+15%、控制抗性+30%，持续5秒；同一目标冷却10秒。|n|cFF808080铃声落下时，躁动的灵识会像月光下的水面一样重新归静。|r',
  description = '|cffccffff[饰品/辅助]-保护/控制缓冲|r|n|cffffcc99等级：B|n评分：6900|r|n|cffffffcc[基础属性]|r|n冷却缩减+12%|n技能治疗率+22%|n魔法消耗减少+10%|n生命值+1500|n控制抗性+18%|n|cffffffcc[装备效果]|r|n净誓余辉：对生命≤45%的友方施加治疗或护盾时，使其获得物理/魔法抗性+15%、控制抗性+30%，持续5秒；同一目标冷却10秒。|n|cFF808080铃声落下时，躁动的灵识会像月光下的水面一样重新归静。|r',
})
...
createEquipmentItem('I0G1', '光辉翠绿宝石', {
  ...
  level = 6,
  score = 11500,
  tooltipExtended = '|cffccffff[饰品/宝石]-通用生存|r|n|cffffcc99等级：A|n评分：11500|r|n|cffffffcc[基础属性]|r|n生命值+4500|n护甲+55|n魔法抗性+25%|n全属性+40|n|cffffffcc[装备效果]|r|n光辉翠绿体：获得1层宝石防护，持续22秒，每20秒刷新；完全抵挡下一次伤害达到800或最大生命值8%（取较高值）的非装备直接物理伤害。|n|cFF808080翠绿薄壳并不拒绝所有伤害，只等待真正值得它碎裂的一击。|r',
  description = '|cffccffff[饰品/宝石]-通用生存|r|n|cffffcc99等级：A|n评分：11500|r|n|cffffffcc[基础属性]|r|n生命值+4500|n护甲+55|n魔法抗性+25%|n全属性+40|n|cffffffcc[装备效果]|r|n光辉翠绿体：获得1层宝石防护，持续22秒，每20秒刷新；完全抵挡下一次伤害达到800或最大生命值8%（取较高值）的非装备直接物理伤害。|n|cFF808080翠绿薄壳并不拒绝所有伤害，只等待真正值得它碎裂的一击。|r',
})
