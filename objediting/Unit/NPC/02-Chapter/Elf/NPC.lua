...
local elfPotionCrafter = UnitDefinition:new('nEPN', 'nhef')
elfPotionCrafter:setName('精灵药水合成师')
elfPotionCrafter:setNameEditorSuffix('')
elfPotionCrafter:setTooltipBasic('精灵药水合成师')
elfPotionCrafter:setTooltipExtended('出售精灵药水合成所需的制作媒介。')
elfPotionCrafter:setDescription('出售精灵药水合成所需的制作媒介。')
elfPotionCrafter:setNormalAbilities('Asid,Aneu,Avul,Apit')
elfPotionCrafter:setItemsSold('I0HE')
elfPotionCrafter:setCanFlee(false)
