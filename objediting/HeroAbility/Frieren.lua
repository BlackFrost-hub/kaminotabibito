...
local ICONS = {
  Q = 'ReplaceableTextures\\CommandButtons\\HeroSkill\\BTNFrierenQ.blp',
  W = 'ReplaceableTextures\\CommandButtons\\HeroSkill\\BTNFrierenW.blp',
  E = 'ReplaceableTextures\\CommandButtons\\HeroSkill\\BTNFrierenE.blp',
  R = 'ReplaceableTextures\\CommandButtons\\HeroSkill\\BTNFrierenR.blp',
  D = 'ReplaceableTextures\\CommandButtons\\HeroSkill\\BTNFrierenD.blp',
}
local DISABLED_ICONS = {
  Q = 'ReplaceableTextures\\CommandButtonsDisabled\\HeroSkill\\DISBTNFrierenQ.blp',
  W = 'ReplaceableTextures\\CommandButtonsDisabled\\HeroSkill\\DISBTNFrierenW.blp',
  E = 'ReplaceableTextures\\CommandButtonsDisabled\\HeroSkill\\DISBTNFrierenE.blp',
  R = 'ReplaceableTextures\\CommandButtonsDisabled\\HeroSkill\\DISBTNFrierenR.blp',
  D = 'ReplaceableTextures\\CommandButtonsDisabled\\HeroSkill\\DISBTNFrierenD.blp',
}
...
createPlayerHeroChannelAbility('AFE1', '芙莉莲-飞行魔法·高处观察（E）', {
  ...
  tooltip = '飞行魔法·高处观察（E）', tooltipExtended = '技能说明：升空并向目标方向飞行，在高处观察周围；落地时冲击敌人，飞行期间降低受到的伤害。|n伤害：落地造成攻击力160%的魔法伤害。|n施法距离：飞行600距离|n观察范围：半径500|n伤害范围：落点半径220|n飞行高度：约250|n观察持续时间：2秒|n伤害减免：40%|n冷却时间：12秒|n魔法消耗：最大魔法值的7%',
