...
createPlayerHeroChannelAbility('AMQ1', '朱雀院红叶-飞燕·穿（Q）', {
  ...
  icon = ICONS.Q, iconTurnOff = DISABLED_ICONS.Q, hotkey = 'Q', buttonX = 0, buttonY = 2,
  cooldown = 6, manaCost = 50, percentManaCost = 0.045,
})
...
createPlayerHeroChannelAbility('AMW1', '朱雀院红叶-水镜·返刃（W）', {
  ...
  icon = ICONS.W, iconTurnOff = DISABLED_ICONS.W, hotkey = 'W', buttonX = 1, buttonY = 2,
  cooldown = 10, manaCost = 100, percentManaCost = 0.055,
})
...
createPlayerHeroChannelAbility('AME1', '朱雀院红叶-三叶·散华（E）', {
  ...
  icon = ICONS.E, iconTurnOff = DISABLED_ICONS.E, hotkey = 'E', buttonX = 2, buttonY = 2,
  cooldown = 9, manaCost = 150, percentManaCost = 0.065,
})
...
createPlayerHeroChannelAbility('AMR1', '朱雀院红叶-奥义·红叶一闪（R）', {
  ...
  icon = ICONS.R, iconTurnOff = DISABLED_ICONS.R, hotkey = 'R', buttonX = 3, buttonY = 2,
  cooldown = 65, manaCost = 300, percentManaCost = 0.13,
})
