...
createPlayerHeroChannelAbility('AIW1', '伊蕾娜-镜界护符（W）', {
  ...
  icon = ICONS.W, iconTurnOff = DISABLED_ICONS.W, hotkey = 'W', buttonX = 1, buttonY = 2, cooldown = 10, manaCost = 100, percentManaCost = 0.07,
})
...
createPlayerHeroChannelAbility('AIE1', '伊蕾娜-扫帚·远行（E）', {
  ...
  icon = ICONS.E, iconTurnOff = DISABLED_ICONS.E, hotkey = 'E', buttonX = 2, buttonY = 2, cooldown = 12, manaCost = 150, percentManaCost = 0.075,
})
