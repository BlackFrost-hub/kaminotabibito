...
local bSun = UnitDefinition:new('bSun', 'ewsp')
bSun:setNormalAbilities('Aloc')
bSun:setCollisionSize(0.0)
bSun:setName('SFB_Unit')
bSun:setModelFile('.mdl')
bSun:setStructuresBuilt('')
bSun:setUpgradesUsed('')
bSun:setUnitSoundSet('')
bSun:setAnimationCastBackswing(0.0)
bSun:setMovementType(MovementType.Fly)
bSun:setUnitClassification('ancient')
bSun:setHitPointsRegenerationType('always')
bSun:setManaMaximum(10000)
bSun:setManaRegeneration(1000.0)
bSun:setManaInitialAmount(1000)
bSun:setFoodProduced(0)
bSun:setHitPointsMaximumBase(10000)
bSun:setHitPointsRegenerationRate(100.0)
bSun:setHideMinimapDisplay(true)
bSun:setSightRadiusDay(0)
bSun:setSightRadiusNight(0)
bSun:setTurnRate(3.0)
bSun:setPropulsionWindowdegrees(360.0)
