...
function createBossChannelAbility(id, name, options)
  ...
  ability:setCooldown(1, options.cooldown ~= nil and options.cooldown or 1)
  ...
  ability:setTargetsAllowed(1, options.targetsAllowed or 'ground,air,enemy,neutral,nonsapper')
