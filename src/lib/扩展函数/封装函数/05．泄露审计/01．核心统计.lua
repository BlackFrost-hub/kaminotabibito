...
____exports.alive = __TS__New(Map)
____exports.types = {
    "timer",
    "group",
    "trigger",
...
function ____exports.track(self, ____type, handle, tag)
    ...
    ____exports.alive:set(
        ____exports.leakKey(nil, ____type, handle),
...
function ____exports.untrack(self, ____type, handle)
    ...
    local s = ____exports.stats[____type]
    if ____exports.alive:delete(____exports.leakKey(nil, ____type, handle)) then
