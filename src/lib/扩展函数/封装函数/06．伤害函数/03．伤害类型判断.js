...
import { YDWEIsEventDamageType, YDWEIsEventAttackDamage, YDWEIsEventRangedDamage, YDWEIsEventPhysicalDamage, YDWEIsEventAttackType, } from "./02．伤害事件数据";
// 判断是否是魔法伤害
