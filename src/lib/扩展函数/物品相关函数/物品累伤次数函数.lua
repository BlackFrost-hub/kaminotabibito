...
local function _____67E5_627E_5355_4F4D_6307_5B9A_88C5_5907(unit, itemTypeId)
...
-- @returns 是否超过阈值
____exports["单位物品累伤次数"] = function(unit, _____88C5_5907_540D, _____53D7_5230_4F24_5BB3, _____6BD4_4F8B, _____9608_503C)
    ...
    local item = _____67E5_627E_5355_4F4D_6307_5B9A_88C5_5907(unit, itemTypeId)
    if item == nil then
        return false
    end
    ...
    if addCount > 0 then
        local currentCharges = GetItemCharges(item)
    ...
    return GetItemCharges(item) > _____9608_503C
end
