...
function ____exports.registerBridge(self)
    ...
    expose(nil, "添加单位暂停", suspend["添加单位暂停"])
    expose(nil, "移除单位暂停", suspend["移除单位暂停"])
    expose(nil, "设置单位暂停时间", suspend["设置单位暂停时间"])
    expose(nil, "增加单位暂停时间", suspend["增加单位暂停时间"])
    expose(nil, "减少单位暂停时间", suspend["减少单位暂停时间"])
    expose(nil, "单位是否暂停", suspend["单位是否暂停"])
    expose(nil, "获取单位暂停剩余时间", suspend["获取单位暂停剩余时间"])
