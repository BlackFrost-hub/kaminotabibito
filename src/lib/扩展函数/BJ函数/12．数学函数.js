...
// ===========================================================================
/** 实数绝对值 - RAbsBJ */
export function RAbsBJ(a) {
    return a < 0 ? -a : a;
}
/** 实数符号 - RSignBJ（返回 ±1） */
export function RSignBJ(a) {
    return a < 0 ? -1 : (a > 0 ? 1 : 0);
}
/** 整数绝对值 - IAbsBJ */
export function IAbsBJ(a) {
    const ia = jass.R2I(a);
    return ia < 0 ? -ia : ia;
}
/** 整数符号 - ISignBJ（返回 ±1） */
export function ISignBJ(a) {
    const ia = jass.R2I(a);
...
export function GetRandomPercentageBJ() {
...
// ===========================================================================
/** 整数取模 - ModuloInteger */
export function ModuloInteger(dividend, divisor) {
...
/** 实数取模 - ModuloReal */
export function ModuloReal(dividend, divisor) {
    if (divisor === 0)
        return 0;
 ...
 */
export function AngleBetweenPoints(locA, locB) {
 ...
 */
export function DistanceBetweenPoints(locA, locB) {
    if (locA == null || locB == null)
        return 0;
    const dx = jass.GetLocationX(locB) - jass.GetLocationX(locA);
    const dy = jass.GetLocationY(locB) - jass.GetLocationY(locA);
...
/** 实数最大值 - RMaxBJ */
export function RMaxBJ(a, b) {
    return a < b ? b : a;
}
/** 实数最小值 - RMinBJ */
export function RMinBJ(a, b) {
    return a < b ? a : b;
}
// ===========================================================================
// 百分比转换函数
// ===========================================================================
/** 百分比转整数 - PercentToInt */
export function PercentToInt(percentage, max) {
    return jass.R2I(percentage * 0.01 * max);
}
/** 百分比转255 - PercentTo255 */
export function PercentTo255(percentage) {
