...
function ____exports.GetSoundDurationBJ(self, soundHandle)
...
function ____exports.GetTransmissionDuration(self, soundHandle, timeType, timeVal)
    ...
    if timeType == ____exports.bj_TIMETYPE_ADD then
        duration = ____exports.GetSoundDurationBJ(nil, soundHandle) + timeVal
    elseif timeType == ____exports.bj_TIMETYPE_SET then
        duration = timeVal
    elseif timeType == ____exports.bj_TIMETYPE_SUB then
        duration = ____exports.GetSoundDurationBJ(nil, soundHandle) - timeVal
    else
        duration = ____exports.GetSoundDurationBJ(nil, soundHandle)
    end
    if duration < 0 then
        duration = 0
    end
...
function ____exports.IsDawnDuskEnabled(self)
