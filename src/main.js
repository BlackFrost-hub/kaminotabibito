...
// ---------- 03．技能系统 ----------
const 显示技能名字 = require("系统.03．技能系统.01．显示技能名字");
if (typeof 显示技能名字.initShowSkillName === "function")
    显示技能名字.initShowSkillName();
// ---------- 04．伤害系统 ----------
...
// ---------- 05．Buff系统 ----------
const buffPoolCore = require("系统.05．Buff系统.00．Buff系统");
if (typeof buffPoolCore.initBuffSystem === "function")
    buffPoolCore.initBuffSystem();
require("系统.05．Buff系统.03．BuffJASS桥接");
// ---------- 07．地形系统 ----------
const 区域传送 = require("系统.07．地形系统.03．区域传送");
if (typeof 区域传送.init区域传送 === "function")
    区域传送.init区域传送();
const 激活传送点 = require("系统.07．地形系统.05．激活传送点");
if (typeof 激活传送点.init激活传送点 === "function")
    激活传送点.init激活传送点();
// ---------- 08．任务系统 ----------
// 任务系统初始化
const 任务管理器 = require("系统.08．任务系统.02．任务管理器");
if (typeof 任务管理器.init === "function")
    任务管理器.init();
...
const 任务UI = require("系统.08．任务系统.03．任务UI");
if (typeof 任务UI.init === "function")
    任务UI.init();
if (typeof 任务UI.registerHotkey === "function")
    任务UI.registerHotkey();
const buffUI = require("系统.05．Buff系统.02．BuffUI");
if (typeof buffUI.init === "function")
    buffUI.init();
// ---------- 12．测试系统 ----------
