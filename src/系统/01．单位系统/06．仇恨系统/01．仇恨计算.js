...
const { 获取映射攻击者 } = require("系统.04．伤害系统.04．伤害映射");
const { addThreat } = require("系统.01．单位系统.06．仇恨系统.00．仇恨存储");
...
function onDamage(target, attacker, applied, _damageType) {
