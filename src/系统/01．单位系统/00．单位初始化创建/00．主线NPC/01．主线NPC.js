...
export const MAIN_STORY_NPCS = {};
function createNeutralPassive(unitId, x, y, facingDeg) {
 ...
 */
export function createMainStoryNPCs() {
    ...
    // 可选：同步到全局表，便于后续系统读取
    globalThis.__MAIN_STORY_NPCS__ = MAIN_STORY_NPCS;
    return MAIN_STORY_NPCS;
}
/**
 * 等价于 JASS 的 TriggerRegisterTimerEventSingle(..., 1.00)
 */
export function initMainStoryNPCsWithDelay(delaySec = 1.0) {
