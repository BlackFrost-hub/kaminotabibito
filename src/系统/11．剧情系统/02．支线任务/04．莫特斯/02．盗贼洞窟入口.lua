...
local safeTriggerAddAction = ____require_result_2.safeTriggerAddAction
local safeDestroyTrigger = ____require_result_2.safeDestroyTrigger
...
local ____require_result_7 = require("系统.07．地形系统.09．动态矩形区域注册表.02．动态矩形区域动作")
local _____6309_914D_7F6E_952E_6CE8_518C_52A8_6001_77E9_5F62_533A_57DF = ____require_result_7["按配置键注册动态矩形区域"]
...
local function _____64AD_653E_5B88_536B_7B2C_4E94_6BB5_5BF9_767D()
    ...
    _____5E7F_64AD_5355_4F4D_63D0_793A(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前洞窟守卫"], "首领就在深处。真有胆子，就自己走到他面前。不过进了这座洞的人，从没活着出去过。", 5200)
    addDelayedCallback(
        _____53D6_5E7F_64AD_5B8C_6574_64AD_653E_6BEB_79D2(5200),
        ____on_9996_6B21_5165_53E3_5BF9_767D_7ED3_675F
    )
end
local function _____64AD_653E_5B88_536B_7B2C_56DB_6BB5_5BF9_767D()
    if not _____5355_4F4D_5B58_6D3B(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前入口英雄"]) then
        ____on_9996_6B21_5165_53E3_5BF9_767D_7ED3_675F()
        return
    end
    _____5E7F_64AD_5355_4F4D_63D0_793A(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前入口英雄"], "我们来查盗贼团和分离教派的关系。让开。", 3200)
    addDelayedCallback(
        _____53D6_5E7F_64AD_5B8C_6574_64AD_653E_6BEB_79D2(3200),
        _____64AD_653E_5B88_536B_7B2C_4E94_6BB5_5BF9_767D
    )
end
local function _____64AD_653E_5B88_536B_7B2C_4E09_6BB5_5BF9_767D()
    if not _____5355_4F4D_5B58_6D3B(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前洞窟守卫"]) then
        ____on_9996_6B21_5165_53E3_5BF9_767D_7ED3_675F()
        return
    end
    _____5E7F_64AD_5355_4F4D_63D0_793A(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前洞窟守卫"], "那两个领头的命倒是够硬，居然还能爬回去。怎么，你们也来替他们送死？", 4800)
    addDelayedCallback(
        _____53D6_5E7F_64AD_5B8C_6574_64AD_653E_6BEB_79D2(4800),
        _____64AD_653E_5B88_536B_7B2C_56DB_6BB5_5BF9_767D
    )
end
local function _____64AD_653E_5B88_536B_7B2C_4E8C_6BB5_5BF9_767D()
    if not _____5355_4F4D_5B58_6D3B(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前入口英雄"]) then
        ____on_9996_6B21_5165_53E3_5BF9_767D_7ED3_675F()
        return
    end
    _____5E7F_64AD_5355_4F4D_63D0_793A(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前入口英雄"], "就是你们袭击了沙漠里的佣兵团？", 2800)
    addDelayedCallback(
        _____53D6_5E7F_64AD_5B8C_6574_64AD_653E_6BEB_79D2(2800),
        _____64AD_653E_5B88_536B_7B2C_4E09_6BB5_5BF9_767D
    )
end
local function _____64AD_653E_5B88_536B_7B2C_4E00_6BB5_5BF9_767D()
    if not _____5355_4F4D_5B58_6D3B(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前洞窟守卫"]) then
        ____on_9996_6B21_5165_53E3_5BF9_767D_7ED3_675F()
        return
    end
    _____5E7F_64AD_5355_4F4D_63D0_793A(_____83AB_7279_65AF_8FD0_884C_72B6_6001["当前洞窟守卫"], "站住！谁准你们闯进来的？这地方不欢迎活人。", 3400)
    addDelayedCallback(
        _____53D6_5E7F_64AD_5B8C_6574_64AD_653E_6BEB_79D2(3400),
        _____64AD_653E_5B88_536B_7B2C_4E8C_6BB5_5BF9_767D
    )
end
local function _____6682_505C_9644_8FD1_5C0F_602A_5E76_627E_5B88_536B(_____82F1_96C4)
    ...
    while true do
        do
            ...
            local ____83AB_7279_65AF_8FD0_884C_72B6_6001__5F53_524D_6682_505C_5C0F_602A_8 = _____83AB_7279_65AF_8FD0_884C_72B6_6001["当前暂停小怪"]
            ____83AB_7279_65AF_8FD0_884C_72B6_6001__5F53_524D_6682_505C_5C0F_602A_8[#____83AB_7279_65AF_8FD0_884C_72B6_6001__5F53_524D_6682_505C_5C0F_602A_8 + 1] = _____5355_4F4D
...
local function _____5F00_59CB_9996_6B21_5165_53E3_6F14_51FA(_____82F1_96C4)
    ...
    _____64AD_653E_5B88_536B_7B2C_4E00_6BB5_5BF9_767D()
end
...
____exports["初始化莫特斯隐藏副本"] = function()
    ...
    if not _____53E5_67C4_6709_6548(_____5165_53E3_77E9_5F62) or not _____53E5_67C4_6709_6548(_____533A_57DF) or not _____53E5_67C4_6709_6548(_____89E6_53D1_5668) then
    ...
    if safeTriggerAddAction(_____89E6_53D1_5668, ____on_6C38_4E45_5165_53E3_8FDB_5165) == nil then
        RemoveRegion(_____533A_57DF)
        safeDestroyTrigger(_____89E6_53D1_5668)
        debugLogForce(_____83AB_7279_65AF_6A21_5757_540D, "永久入口动作注册失败")
        return
    end
    RegionAddRect(_____533A_57DF, _____5165_53E3_77E9_5F62)
    registerEnterRegionTrigger(_____89E6_53D1_5668, _____533A_57DF, nil)
    _____83AB_7279_65AF_8FD0_884C_72B6_6001["永久入口区域"] = _____533A_57DF
    _____83AB_7279_65AF_8FD0_884C_72B6_6001["永久入口触发器"] = _____89E6_53D1_5668
