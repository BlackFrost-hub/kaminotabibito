...
function _____6267_884CBoss_6218_542F_52A8_6B65_9AA4(_____6B65_9AA4)
    ...
    local ____8BFB_53D6_5355_4F4D_5F15_7528_result_7 = _____8BFB_53D6_5355_4F4D_5F15_7528(_____6B65_9AA4["Boss引用"])
    if ____8BFB_53D6_5355_4F4D_5F15_7528_result_7 == nil then
        ____8BFB_53D6_5355_4F4D_5F15_7528_result_7 = _____8BFB_53D6_5355_4F4D_5F15_7528(_____6B65_9AA4["Boss名"] and "Boss." .. tostring(_____6B65_9AA4["Boss名"]) or nil)
    end
    local bossUnit = ____8BFB_53D6_5355_4F4D_5F15_7528_result_7
...
function _____6267_884C_5F53_524D_5267_60C5_6B65_9AA4()
    ...
    repeat
        local ____switch101 = _____6B65_9AA4.type
        local ____cond101 = ____switch101 == "dialog"
        if ____cond101 then
            _____6267_884C_5BF9_767D_6B65_9AA4(_____6B65_9AA4)
            return
        end
        ____cond101 = ____cond101 or ____switch101 == "broadcast"
        if ____cond101 then
            _____6267_884C_5E7F_64AD_6B65_9AA4(_____6B65_9AA4)
            return
        end
        ____cond101 = ____cond101 or ____switch101 == "wait"
        if ____cond101 then
            _____6267_884C_7B49_5F85_6B65_9AA4(_____6B65_9AA4)
            return
        end
        ____cond101 = ____cond101 or ____switch101 == "runAction"
        if ____cond101 then
            _____6267_884C_81EA_5B9A_4E49_52A8_4F5C_6B65_9AA4(_____6B65_9AA4)
            return
        end
        ____cond101 = ____cond101 or ____switch101 == "startBossFight"
        if ____cond101 then
            _____6267_884CBoss_6218_542F_52A8_6B65_9AA4(_____6B65_9AA4)
            return
        end
        ____cond101 = ____cond101 or ____switch101 == "giveItem"
        if ____cond101 then
...
local function _____6267_884C_8DF3_8FC7_6A21_5F0F_6B65_9AA4_903B_8F91(_____6B65_9AA4)
    repeat
        local ____switch89 = _____6B65_9AA4.type
        local ____cond89 = ____switch89 == "dialog" or ____switch89 == "broadcast" or ____switch89 == "wait"
        if ____cond89 then
            return
        end
        ____cond89 = ____cond89 or ____switch89 == "runAction"
        if ____cond89 then
            _____83B7_53D6_6267_884C_4E3B_7EBF_5267_60C5_52A8_4F5C_51FD_6570()(_____6B65_9AA4["动作ID"], _____6B65_9AA4["参数"] or ({}))
            return
        end
        ____cond89 = ____cond89 or ____switch89 == "startBossFight"
        if ____cond89 then
            do
                local ____8BFB_53D6_5355_4F4D_5F15_7528_result_8 = _____8BFB_53D6_5355_4F4D_5F15_7528(_____6B65_9AA4["Boss引用"])
                if ____8BFB_53D6_5355_4F4D_5F15_7528_result_8 == nil then
                    ____8BFB_53D6_5355_4F4D_5F15_7528_result_8 = _____8BFB_53D6_5355_4F4D_5F15_7528(_____6B65_9AA4["Boss名"] and "Boss." .. tostring(_____6B65_9AA4["Boss名"]) or nil)
                end
                local bossUnit = ____8BFB_53D6_5355_4F4D_5F15_7528_result_8
                _____542F_52A8_5267_60C5Boss_6218(bossUnit)
                return
            end
        end
        ____cond89 = ____cond89 or ____switch89 == "giveItem"
        if ____cond89 then
            do
                local itemName = _____6B65_9AA4["物品名"]
                if itemName ~= nil and itemName ~= "" then
