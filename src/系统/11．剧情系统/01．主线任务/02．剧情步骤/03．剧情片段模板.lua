...
____exports["紧凑剧情片段模板"] = {
    ...
    ["默认倍速"] = 1,
    ["默认对白持续时间"] = 3,
    ["对白列表"] = {{["序号"] = 1, ["说话者"] = "系统", ["文本"] = "|cffffff00『系统提示』：|r这里填写剧情提示文本。", ["持续时间"] = 3}, {["序号"] = 2, ["说话者"] = "|cffffcc99『重要角色』|r", ["文本"] = "这里填写正式剧情对白。", ["持续时间"] = 4.5}},
    ["动作时间线"] = {{
        ["序号"] = 1,
        ["挂点"] = "beforeDialog",
        ["对白序号"] = 1,
