...
____exports["地精洞窟演出紧凑剧情片段"] = {
    ...
    ["动作时间线"] = {
        ...
        },
        {
            ...
            ["名称"] = "关闭黑幕并切入祭坛镜头",
            ["参数"] = {["关闭电影滤镜"] = true, ["开启区域音乐"] = "gg_snd_JQBGM01 @ 地精洞窟.演出音乐区域", ["旧JASS功能清单"] = "DisplayCineFilter(false) / SetStackedSoundBJ(true, gg_snd_JQBGM01, 全局变量矩形区域102) / CreateUnit(演员1-6) / CameraSetupApplyForceDuration"}
        },
        {
            ["序号"] = 4,
            ["挂点"] = "afterDialog",
        ...
        },
        {
            ...
            ["对白序号"] = 4,
            ["跳过也执行"] = true,
            ["动作ID"] = "JLC精灵村_地精洞窟演出收尾",
            ["名称"] = "洞窟演出结束恢复玩家控制与镜头",
            ["参数"] = {["玩家英雄组恢复控制"] = true, ["玩家英雄组取消无敌"] = true, ["镜头恢复方式"] = "恢复进入电影模式前每个玩家的镜头目标距离与高度偏移", ["旧JASS功能清单"] = "CinematicModeBJ(false) / ResetToGameCameraForPlayer / PanCameraToTimedLocForPlayer / PauseUnit(false) / SetUnitInvulnerable(false)"}
        }
    }
}
