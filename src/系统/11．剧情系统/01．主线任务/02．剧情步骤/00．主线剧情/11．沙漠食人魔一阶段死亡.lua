...
local ____exports = {}
local _____6062_590D_73A9_5BB6_82F1_96C4_63A7_5236, PauseUnit, DestroyGroup, FirstOfGroup, GroupRemoveUnit, _____73A9_5BB6_82F1_96C4_5EF6_8FDF_6062_590DID, _____73A9_5BB6_82F1_96C4_6682_505C_7EC4
...
____exports["执行沙漠食人魔二阶段演出收束"] = function()
    ...
    if _____88C2_9699 ~= nil and _____88C2_9699 ~= 0 then
        EC_CreateEffect(
            "war3mapImported\\blackhole.mdx",
            GetUnitX(_____88C2_9699),
            GetUnitY(_____88C2_9699),
            0,
            270,
            2,
            1,
