...
local function ____on_730E_9B42_8303_56F4_89E6_53D1()
    ...
    _____5199_5165_5F53_524D_5267_60C5_52A8_4F5C_4E0A_4E0B_6587({["片段ID"] = "elven_city_hunter_start", ["触发配置名"] = "猎魂范围入口", ["触发单位"] = _____89E6_53D1_5355_4F4D})
    ...
    _____64AD_653E_4E3B_7EBF_5267_60C5_7247_6BB5("elven_city_hunter_start")
end
____exports["执行克林姆德王接见"] = function()
end
...
____exports["克林姆德王接见剧情动作注册表"] = {["JLC精灵城_克林姆德王接见"] = ____exports["执行克林姆德王接见"], ["JLC精灵城_接见金币提示"] = ____exports["执行接见金币提示"], ["JLC精灵城_创建猎魂入口"] = _____6267_884C_521B_5EFA_730E_9B42_5165_53E3}
return ____exports
