...
local _____5C01_5370_6838_5FC3_5165_53E3_77E9_5F62_952E = "剧情.封印核心入口"
...
local _____5F53_524D_5C01_5370_6838_5FC3_5965_65AF_7279_5229_4E00_4E16_8BB0_5F55
...
local function _____521B_5EFA_4E03_8272_95EA_7535(_____72B6_6001)
    ...
    do
        local i = 0
        while i < #____exports["封印核心七色闪电配置表"] do
            local _____914D_7F6E = ____exports["封印核心七色闪电配置表"][i + 1]
...
____exports["清理封印核心收束说话者"] = function()
    local _____8BB0_5F55 = _____5F53_524D_5C01_5370_6838_5FC3_5965_65AF_7279_5229_4E00_4E16_8BB0_5F55
    ...
    _____6E05_7406_5267_60C5_8FD0_884C_65F6_5355_4F4D(_____8BB0_5F55["运行时键"])
    _____5F53_524D_5C01_5370_6838_5FC3_5965_65AF_7279_5229_4E00_4E16_8BB0_5F55 = nil
end
...
____exports["布置封印核心纯对白"] = function()
    ...
    _____5E94_7528_7B2C_4E09_7AE0_7535_5F71_955C_5934(48)
...
____exports["执行清理封印核心收束"] = function(______53C2_6570)
    ____exports["清理封印核心收束说话者"]()
end
____exports["封印核心场景剧情动作注册表"] = {
    ["第三章_布置封印核心纯对白"] = ____exports["执行布置封印核心纯对白"],
    ["第三章_创建封印核心七色光束"] = ____exports["执行创建封印核心七色光束"],
    ["第三章_结束封印核心纯对白"] = ____exports["执行结束封印核心纯对白"],
    ["第三章_清理封印核心入口"] = ____exports["执行清理封印核心入口"],
    ["第三章_清理封印核心收束"] = ____exports["执行清理封印核心收束"]
}
return ____exports
