...
____exports["猎魂试探剧情动作注册表"] = {["JLC精灵城_猎魂试探"] = ____exports["执行猎魂试探"], ["JLC精灵城_猎魂解除对峙"] = ____exports["执行猎魂解除对峙"], ["JLC精灵城_清理猎魂运行时引用"] = ____exports["执行清理猎魂运行时引用"], ["JLC精灵城_预置树魔首领随从"] = ____exports["执行树魔首领战前随从预置"]}
return ____exports
