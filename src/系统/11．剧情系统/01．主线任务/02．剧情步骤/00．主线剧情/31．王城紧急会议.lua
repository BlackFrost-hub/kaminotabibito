...
____exports["王城紧急会议剧情动作注册表"] = {["JLC精灵城_前往会议室任务"] = ____exports["布置王城会议席位"], ["JLC精灵城_紧急会议"] = ____exports["执行紧急会议"], ["JLC精灵城_启动王城攻城战"] = ____exports["执行启动王城攻城战"], ["JLC精灵城_准备耶提尔菲利斯协战"] = ____exports["执行准备耶提尔菲利斯协战"]}
return ____exports
