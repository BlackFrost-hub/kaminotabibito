...
local _____5F52_4F4D_5185_52A1_603B_7BA1_8BED_7EF4 = ____31_FF0E_738B_57CE_7D27_6025_4F1A_8BAE["归位内务总管语维"]
...
local _____6253_5F00Boss_6B7B_4EA1_9996_9886_5956_52B1UI = ____require_result_3["打开Boss死亡首领奖励UI"]
local ____require_result_4 = require("系统.02．物品系统.18．首领奖励选择.01．奖励配置表.15．主线_里科特战利品")
local _____91CC_79D1_7279_5956_52B1_6C60ID = ____require_result_4["里科特奖励池ID"]
...
____exports["执行语维章节末归位"] = function()
    _____5F52_4F4D_5185_52A1_603B_7BA1_8BED_7EF4()
end
____exports["执行布置王宫密室受伤现场"] = function()
    local _____65E7_91CC_79D1_7279 = _____8BFB_53D6_8BED_4E49_5355_4F4D_5F15_7528("Boss.里科特")
    if _____65E7_91CC_79D1_7279 ~= nil and _____65E7_91CC_79D1_7279 ~= 0 then
        RemoveUnit(_____65E7_91CC_79D1_7279)
    end
    YDUserDataClearSafe("string", "Boss", "里科特", "unit")
    _____6E05_7406_5267_60C5_8FD0_884C_65F6_5355_4F4D("Boss.里科特")
    local _____91CC_79D1_7279_5267_60C5_58F3 = _____8BFB_53D6_6216_521B_5EFA_5E76_5B9A_4F4D_738B_5BAB_5BC6_5BA4_5267_60C5_5355_4F4D("Boss.里科特", "里科特", _____738B_5BAB_5BC6_5BA4_573A_666F_7AD9_4F4D_8868["里科特密室"])
    if _____91CC_79D1_7279_5267_60C5_58F3 ~= nil and _____91CC_79D1_7279_5267_60C5_58F3 ~= 0 then
        PauseUnit(_____91CC_79D1_7279_5267_60C5_58F3, true)
        SetUnitInvulnerable(_____91CC_79D1_7279_5267_60C5_58F3, true)
    end
...
____exports["执行打开里科特首领奖励"] = function()
    addDelayedCallback(
        100,
        function()
            _____6253_5F00Boss_6B7B_4EA1_9996_9886_5956_52B1UI(_____91CC_79D1_7279_5956_52B1_6C60ID)
        end
    )
end
____exports["第二章后续承接剧情动作注册表"] = {
    ["SW01死亡事件_章节末最终收束"] = ____exports["执行章节末最终收束"],
    ["JLC精灵城_语维章节末归位"] = ____exports["执行语维章节末归位"],
    ["JLC精灵城_布置王宫密室受伤现场"] = ____exports["执行布置王宫密室受伤现场"],
    ["JLC精灵城_里科特战后撤离"] = ____exports["执行里科特战后撤离"],
    ["主线.打开里科特首领奖励"] = ____exports["执行打开里科特首领奖励"]
}
return ____exports
