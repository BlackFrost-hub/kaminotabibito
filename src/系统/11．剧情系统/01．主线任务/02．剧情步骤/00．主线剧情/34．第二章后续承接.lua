...
____exports["第二章后续承接剧情动作注册表"] = {["SW01死亡事件_章节末最终收束"] = ____exports["执行章节末最终收束"], ["JLC精灵城_布置王宫密室受伤现场"] = ____exports["执行布置王宫密室受伤现场"], ["JLC精灵城_里科特战后撤离"] = ____exports["执行里科特战后撤离"], ["主线.打开里科特首领奖励"] = ____exports["执行打开里科特首领奖励"]}
return ____exports
