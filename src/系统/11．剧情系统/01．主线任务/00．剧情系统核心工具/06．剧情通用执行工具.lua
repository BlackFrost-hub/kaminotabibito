...
local ____exports = {}
local _____8BFB_53D6_5168_5C40_53E5_67C4, _____5207_6362_533A_57DF_97F3_4E50_8868_8FBE_5F0F, _____64AD_653E_97F3_6548_8868_8FBE_5F0F, jglobals, _____5207_6362_533A_57DF_80CC_666F_97F3_4E50_8868_8FBE_5F0F, PlaySoundBJ
...
local _____521B_5EFA_53EF_53D6_6D88_4EFB_52A1_7EC4 = ____require_result_0["创建可取消任务组"]
...
local safeForForce = ____require_result_3.safeForForce
...
local ForGroupBJ = ____require_result_6.ForGroupBJ
local SetTimeOfDay = ____require_result_6.SetTimeOfDay
local ____require_result_7 = require("lib.扩展函数.BJ函数.07．杂项")
local GetPlayersAll = ____require_result_7.GetPlayersAll
local ____require_result_8 = require("系统.07．地形系统.07．区域背景音乐.04．区域背景音乐运行时")
_____5207_6362_533A_57DF_80CC_666F_97F3_4E50_8868_8FBE_5F0F = ____require_result_8["切换区域背景音乐表达式"]
local ____require_result_9 = require("系统.07．地形系统.09．动态矩形区域注册表.index")
local _____83B7_53D6_77E9_5F62_533A_57DF = ____require_result_9["获取矩形区域"]
local ____require_result_10 = require("lib.扩展函数.BJ函数.14．音效函数")
PlaySoundBJ = ____require_result_10.PlaySoundBJ
local ____require_result_11 = require("lib.扩展函数.BJ函数.02．单位与英雄")
local ModifyHeroStat = ____require_result_11.ModifyHeroStat
...
local ____require_result_14 = require("系统.03．技能系统.04．快捷键技能.02．按Ctrl切换背包")
local _____79FB_9664_73A9_5BB6_4E3B_526F_80CC_5305_7269_54C1 = ____require_result_14["移除玩家主副背包物品"]
local ____require_result_15 = require("系统.02．物品系统.13．物品名反查")
local _____6309_540D_5B57_53CD_67E5_7269_54C1ID = ____require_result_15["按名字反查物品ID"]
local ____require_result_16 = require("系统.01．单位系统.08．单位配置表.02．Boss配置表")
local _____6309_540D_5B57_53CD_67E5Boss_5355_4F4DID = ____require_result_16["按名字反查Boss单位ID"]
...
local ____require_result_18 = require("系统.08．任务系统.01．任务数据")
local questDB = ____require_result_18.questDB
local QuestType = ____require_result_18.QuestType
local QuestStatus = ____require_result_18.QuestStatus
local ____require_result_19 = require("系统.08．任务系统.02．任务管理器")
local _____89E6_53D1_4EFB_52A1UI_5237_65B0 = ____require_result_19["触发任务UI刷新"]
local ____require_result_20 = require("系统.11．剧情系统.01．主线任务.00．剧情系统核心工具.03．剧情Boss预置桥接")
local _____521B_5EFA_5E76_51BB_7ED3_5267_60C5Boss_9884_7F6E = ____require_result_20["创建并冻结剧情Boss预置"]
local ____require_result_21 = require("系统.03．技能系统.06．AI自动使用技能.03．Boss战启动桥接.01．Boss战运行.03．Boss战运行驱动")
local _____542F_52A8Boss_6218_8FD0_884C = ____require_result_21["启动Boss战运行"]
...
local _____5267_60C5_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C_6765_6E90 = "剧情系统:玩家英雄控制"
...
local _____73A9_5BB6_7EC4_89C6_91CE_4E0A_4E0B_6587_6808 = {}
local _____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808 = {}
local _____5EF6_8FDF_6267_884C_4EFB_52A1_7EC4 = _____521B_5EFA_53EF_53D6_6D88_4EFB_52A1_7EC4()
...
____exports["读取语义单位引用"] = function(_____5F15_7528)
    ...
    local _____8FD0_884C_65F6_5355_4F4D = _____8BFB_53D6_5267_60C5_8FD0_884C_65F6_5355_4F4D(_____5F15_7528)
    ...
    local _____5019_9009_8868_540D_5217_8868 = {"主线NPC", "ZX", "Boss", "Boss战"}
    do
        local i = 0
...
____exports["读取触发单位"] = function()
    ...
    return _____8BFB_53D6_5267_60C5_8FD0_884C_65F6_5355_4F4D("剧情.当前触发单位")
end
local function _____4ECE_5355_4F4D_79FB_9664_6307_5B9A_7269_54C1(unit, _____7269_54C1_540D)
    ...
    return _____79FB_9664_73A9_5BB6_4E3B_526F_80CC_5305_7269_54C1(unit, itemTypeId)
end
local function ____on_8BBE_7F6E_679A_4E3E_82F1_96C4_6682_505C_65E0_654C()
    ...
    if _____5F53_524D_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C then
        if _____5F53_524D_73A9_5BB6_82F1_96C4_65E0_654C then
            _____6682_505C_5E76_8BBE_7F6E_65E0_654C_5B89_5168(unit, _____5267_60C5_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C_6765_6E90)
        else
            _____6DFB_52A0_5355_4F4D_6682_505C(unit, _____5267_60C5_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C_6765_6E90)
        end
    else
        if not _____89E3_9664_6682_505C_5E76_53D6_6D88_65E0_654C_5B89_5168(unit, _____5267_60C5_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C_6765_6E90) then
            _____79FB_9664_5355_4F4D_6682_505C(unit, _____5267_60C5_73A9_5BB6_82F1_96C4_63A7_5236_6682_505C_6765_6E90)
        end
    end
end
...
local function ____on_8C03_6574_679A_4E3E_73A9_5BB6_91D1_5E01()
    local delta = _____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808[#_____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808]
    local whichPlayer = GetEnumPlayer()
    if delta == nil or whichPlayer == nil or whichPlayer == 0 then
        return
    end
    AdjustPlayerStateBJ(delta, whichPlayer, PLAYER_STATE_RESOURCE_GOLD)
end
local function _____8C03_6574_73A9_5BB6_7EC4_91D1_5E01(delta)
    local _____73A9_5BB6_7EC4 = YDUserDataGetSafe("string", "玩家", "玩家组", "force")
    if _____73A9_5BB6_7EC4 == nil or _____73A9_5BB6_7EC4 == 0 then
        return
    end
    _____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808[#_____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808 + 1] = delta
    safeForForce(_____73A9_5BB6_7EC4, ____on_8C03_6574_679A_4E3E_73A9_5BB6_91D1_5E01)
    table.remove(_____73A9_5BB6_7EC4_91D1_5E01_8C03_6574_6808)
end
--- 从当前剧情触发单位所属玩家扣除金币，供标准主线目标动作复用。
____exports["扣除触发单位金币"] = function(amount)
...
____exports["设置触发单位控制状态"] = function(_____6682_505C, _____65E0_654C)
    ...
    if _____6682_505C then
        if _____65E0_654C then
            _____6682_505C_5E76_8BBE_7F6E_65E0_654C_5B89_5168(unit, _____5267_60C5_89E6_53D1_5355_4F4D_63A7_5236_6682_505C_6765_6E90)
        else
            _____6DFB_52A0_5355_4F4D_6682_505C(unit, _____5267_60C5_89E6_53D1_5355_4F4D_63A7_5236_6682_505C_6765_6E90)
        end
    else
        if not _____89E3_9664_6682_505C_5E76_53D6_6D88_65E0_654C_5B89_5168(unit, _____5267_60C5_89E6_53D1_5355_4F4D_63A7_5236_6682_505C_6765_6E90) then
            _____79FB_9664_5355_4F4D_6682_505C(unit, _____5267_60C5_89E6_53D1_5355_4F4D_63A7_5236_6682_505C_6765_6E90)
        end
    end
end
...
local function ____on_7ED9_679A_4E3E_73A9_5BB6_6DFB_52A0_533A_57DF_89C6_91CE()
    local _____4E0A_4E0B_6587 = _____73A9_5BB6_7EC4_89C6_91CE_4E0A_4E0B_6587_6808[#_____73A9_5BB6_7EC4_89C6_91CE_4E0A_4E0B_6587_6808]
...
____exports["给玩家组添加多个区域视野"] = function(_____77E9_5F62_533A_57DF_540D_79F0_5217_8868)
    ...
    do
        ...
        while i < #_____5217_8868 do
            ____exports["给玩家组添加区域视野"](_____5217_8868[i + 1])
            i = i + 1
        end
    end
end
...
____exports["按原始ID给触发单位物品"] = function(rawId)
    local unit = ____exports["读取触发单位"]()
    if unit == nil or unit == 0 or rawId == "" then
        return
    end
    local itemTypeId = stringToFourCCSafe(rawId)
    if not (itemTypeId > 0) then
...
____exports["执行通用剧情动作"] = function(_____53C2_6570)
    ...
    if _____89C6_91CE_77E9_5F62 ~= "" then
        ____exports["给玩家组添加多个区域视野"](_____89C6_91CE_77E9_5F62)
    end
    ...
    if _____53EF_89C1_533A_57DF1 ~= "" then
        ____exports["给玩家组添加区域视野"](_____53EF_89C1_533A_57DF1)
    end
    ...
    if npcUnit ~= nil and npcUnit ~= 0 then
        if _____89E6_53D1_5355_4F4D ~= nil and _____89E6_53D1_5355_4F4D ~= 0 then
            if _____53D6_53C2_6570_6587_672C(_____53C2_6570, "NPC转向目标") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "NPC转向触发单位") ~= "" then
                SetUnitFacing(
                    npcUnit,
                    YDWEAngleBetweenUnitsSafe(npcUnit, _____89E6_53D1_5355_4F4D)
                )
            end
            if _____53D6_53C2_6570_6587_672C(_____53C2_6570, "触发单位转向目标") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "触发单位转向耗时") ~= "" then
                SetUnitFacing(
                    ...
                    YDWEAngleBetweenUnitsSafe(_____89E6_53D1_5355_4F4D, npcUnit)
                )
            end
        end
    ...
    local _____5F00_95E8_5EF6_8FDF_79D2_6570 = _____53D6_53C2_6570_6570_5B57(_____53C2_6570, "开门延时秒数") or _____53D6_53C2_6570_6570_5B57(_____53C2_6570, "延迟开门秒")
    if _____5F00_95E8_5BF9_8C61 ~= "" and _____5F00_95E8_5EF6_8FDF_79D2_6570 <= 0 then
    ...
    if _____9690_85CF_963B_6321 ~= "" and _____5F00_95E8_5EF6_8FDF_79D2_6570 <= 0 then
    ...
    local _____7269_54C1ID = _____53D6_53C2_6570_6587_672C(_____53C2_6570, "物品ID") or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "物品RawID")
    if _____7269_54C1ID ~= "" then
        ____exports["按原始ID给触发单位物品"](_____7269_54C1ID)
    else
    ...
    if _____53D1_653E_91D1_5E01 ~= 0 then
        _____8C03_6574_73A9_5BB6_7EC4_91D1_5E01(_____53D1_653E_91D1_5E01)
    end
    local _____9884_8B66_6587_672C = _____53D6_53C2_6570_6587_672C(_____53C2_6570, "预警文本")
    local _____5EF6_8FDF_79D2_6570 = _____53D6_53C2_6570_6570_5B57(_____53C2_6570, "延迟秒数") or _____5F00_95E8_5EF6_8FDF_79D2_6570 or (_____9884_8B66_6587_672C ~= "" and 4 or 0)
    ...
    local _____9700_8981_542F_52A8Boss = (____Boss_952E ~= "" or ____Boss_540D ~= "") and (_____53D6_53C2_6570_6587_672C(_____53C2_6570, "Boss战绑定单位字段") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "Boss战战斗音乐") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "Boss战胜利音乐") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "Boss战地点字段") ~= "" or _____53D6_53C2_6570_6587_672C(_____53C2_6570, "Boss战地点") ~= "")
