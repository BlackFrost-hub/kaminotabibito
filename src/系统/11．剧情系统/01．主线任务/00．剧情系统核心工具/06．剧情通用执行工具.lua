...
local ____require_result_7 = require("lib.扩展函数.BJ函数.04．矩形与区域")
SetStackedSoundBJ = ____require_result_7.SetStackedSoundBJ
...
local questManager = ____require_result_17.questManager
