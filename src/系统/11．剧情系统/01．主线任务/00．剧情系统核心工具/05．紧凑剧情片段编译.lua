...
____exports["编译紧凑动作"] = function(_____52A8_4F5C)
    if _____52A8_4F5C["动作ID"] == "wait" then
        ...
        return {
            ...
            ["跳过也执行"] = _____52A8_4F5C["跳过也执行"] ~= false,
...
____exports["编译紧凑剧情片段"] = function(_____914D_7F6E)
    ...
    do
        ...
        while i < #_____914D_7F6E["对白列表"] do
            ...
            local _____4F7F_7528_5E7F_64AD = _____5BF9_767D["广播"] == true or _____914D_7F6E["广播起始序号"] ~= nil and _____5BF9_767D["序号"] >= _____914D_7F6E["广播起始序号"]
            local _____5F53_524D_5BF9_767D_53EFEsc = _____5BF9_767D["可Esc跳过"] == true or _____4F7F_7528_5E7F_64AD
            if _____4F7F_7528_5E7F_64AD then
                _____6B65_9AA4_5217_8868[#_____6B65_9AA4_5217_8868 + 1] = {
                    type = "broadcast",
                    id = (_____914D_7F6E["片段ID"] .. "_broadcast_") .. tostring(_____5BF9_767D["序号"]),
                    ["名称"] = (tostring(_____5BF9_767D["序号"]) .. ". ") .. _____5BF9_767D["说话者"],
                    ["说话者"] = _____5BF9_767D["说话者"],
                    ["文本"] = _____5BF9_767D["文本"],
                    ["持续时间"] = _____5BF9_767D["持续时间"],
                    ["广播渠道"] = _____5BF9_767D["广播渠道"] or "ui",
                    ["来源单位引用"] = _____5BF9_767D["说话者引用"],
                    ["可跳过"] = _____5F53_524D_5BF9_767D_53EFEsc
                }
            else
                _____6B65_9AA4_5217_8868[#_____6B65_9AA4_5217_8868 + 1] = {
                    type = "dialog",
                    ...
                    ["原生对白自动开启电影模式"] = _____5BF9_767D["原生对白自动开启电影模式"],
                    ["原生电影阻塞"] = _____5BF9_767D["原生电影阻塞"],
                    ["可Esc跳过"] = _____5F53_524D_5BF9_767D_53EFEsc
                }
            end
            do
                local j = 0
