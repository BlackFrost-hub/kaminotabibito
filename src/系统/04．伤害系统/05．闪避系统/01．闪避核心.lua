...
local ____require_result_5 = require("系统.04．伤害系统.05．闪避系统.00．闪避配置")
local _____95EA_907F_7CFB_7EDF_914D_7F6E = ____require_result_5["闪避系统配置"]
...
local _____95EA_907F_6210_529F_8BB0_5F55_5217_8868 = {}
local _____95EA_907F_6700_7EC8_4F24_5BB3_76D1_542C_5217_8868 = {}
local _____5DF2_6CE8_518C_95EA_907F_6700_7EC8_4F24_5BB3_6865_63A5 = false
...
local function _____901A_77E5_95EA_907F_6700_7EC8_4F24_5BB3_76D1_542C(record, applied, snapshot)
    do
        local i = 0
        while i < #_____95EA_907F_6700_7EC8_4F24_5BB3_76D1_542C_5217_8868 do
            do
...
local function _____95EA_907F_6700_7EC8_4F24_5BB3_6865_63A5(target, attacker, applied, snapshot)
    do
        local i = 0
...
local function _____786E_4FDD_95EA_907F_6700_7EC8_4F24_5BB3_6865_63A5()
...
local function _____663E_793A_95EA_907F(target)
    CreateFloatTextOnUnit(target, _____95EA_907F_7CFB_7EDF_914D_7F6E["闪避文本"], _____95EA_907F_7CFB_7EDF_914D_7F6E["漂浮文字"])
end
____exports["执行闪避判定"] = function(context)
    ...
    _____663E_793A_95EA_907F(target)
