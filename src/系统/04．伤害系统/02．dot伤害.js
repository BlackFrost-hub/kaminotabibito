...
// ========== 虚拟分区：DOT 子模块导入 ==========
import { dotEffectModelFromBuffRow, } from "./01．DOT定义/01．DOT配置";
import { registerBuiltInDotTypes } from "./01．DOT定义/03．DOT类型定义";
import { getDotSourceDisplayName, getDotState, unitHid, } from "./01．DOT定义/04．DOT工具";
...
let __pcallNotifyTarget = null;
let __pcallNotifyState = null;
function __pcallNotifyBuffPoolBody() {
