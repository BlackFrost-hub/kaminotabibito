...
export function init() {
    ...
    const 模型伤害数字 = require("系统.09．表现系统.09．伤害数字模型.index");
    const Boss战伤害统计 = require("系统.04．伤害系统.00．伤害计算.07．Boss战伤害统计");
    ...
    const { init: initHealSystem } = require("系统.04．伤害系统.02．治疗系统.index");
    const { init: initWoundSystem } = require("系统.04．伤害系统.03．重伤系统.index");
