...
____exports.STAT_STACK_CONFIG = {
    ...
    ["主动技能伤害"] = ____exports.STACK_TYPE.ADDITIVE,
    ["独立技能伤害"] = ____exports.STACK_TYPE.ADDITIVE,
    ["装备伤害"] = ____exports.STACK_TYPE.ADDITIVE,
    ["攻击特效伤害"] = ____exports.STACK_TYPE.ADDITIVE,
    ["普攻强化伤害"] = ____exports.STACK_TYPE.ADDITIVE,
