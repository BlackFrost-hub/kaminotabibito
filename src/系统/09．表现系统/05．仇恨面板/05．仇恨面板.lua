...
local initLocalThreatPanelVisibilityState = ____04_FF0E_9A71_52A8.initLocalThreatPanelVisibilityState
local toggleLocalThreatPanelVisibility = ____04_FF0E_9A71_52A8.toggleLocalThreatPanelVisibility
local showLocalThreatPanel = ____04_FF0E_9A71_52A8.showLocalThreatPanel
...
local _____5DF2_6CE8_518CV_952E = false
...
local function _____6CE8_518C_73A9_5BB6V_952E(playerId)
    ...
    if _____5DF2_6CE8_518CV_952E then
        return
    end
    _____5DF2_6CE8_518CV_952E = true
