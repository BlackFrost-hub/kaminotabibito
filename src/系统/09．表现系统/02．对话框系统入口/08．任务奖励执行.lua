...
local ____exports = {}
local ____15_FF0E_6570_5B66_51FD_6570 = require("系统.00．核心系统.15．数学函数")
local IMaxBJ = ____15_FF0E_6570_5B66_51FD_6570.IMaxBJ
local ____06_FF0E_4EFB_52A1_5956_52B1_89E3_6790 = require("系统.09．表现系统.02．对话框系统入口.06．任务奖励解析")
