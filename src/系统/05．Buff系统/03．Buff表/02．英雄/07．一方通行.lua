...
local ____exports = {}
____exports["一方通行BuffID"] = {["矢量移动"] = "YFQ1", ["血液逆流虚弱"] = "YFR1"}
____exports["一方通行Buff表"] = {[____exports["一方通行BuffID"]["矢量移动"]] = {
    buffID = ____exports["一方通行BuffID"]["矢量移动"],
    buffName = "矢量移动",
...
}, [____exports["一方通行BuffID"]["血液逆流虚弱"]] = {
    buffID = ____exports["一方通行BuffID"]["血液逆流虚弱"],
    buffName = "血液逆流·虚弱",
...
____exports.default = ____exports["一方通行Buff表"]
return ____exports
