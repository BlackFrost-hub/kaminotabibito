...
local ____exports = {}
local uiSetFrameTexture, uiHideFrame, uiShowFrame, hideSlot, hideAllSlots, renderBuffBarLocal, rebuildAllBuffBarViewModels, syncBuffBar, onBuffUiRefreshTick, jass, japi, debugLog, MAX_SLOTS, slots, buffBarViewModelByPlayerId
