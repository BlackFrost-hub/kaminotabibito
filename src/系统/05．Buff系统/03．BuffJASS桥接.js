...
const { ydlStes_syncTriggerStep, ydlStes_finishChildCleanup, ydlStes_readString5, ydlStes_readUnit5, ydlStes_readReal5, } = require("lib.扩展函数.YDWE函数.05．STES子触发公共工具");
 ...
 */
export function buffBridgeApplyFromYdlocal(_self) {
    try {
