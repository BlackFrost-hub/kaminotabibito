...
local function onSwitchBagKey(self, player, _key)
    local _____8F93_5165_73A9_5BB6 = player or DzGetTriggerKeyPlayer()
    if _____8F93_5165_73A9_5BB6 == nil or _____8F93_5165_73A9_5BB6 == 0 then
        return
    end
    local hero = YDUserDataGetSafe("player", _____8F93_5165_73A9_5BB6, "英雄", "unit")
    if hero == nil or hero == 0 then
        return
    end
    ...
    local isHeroSelected = IsUnitSelected(hero, _____8F93_5165_73A9_5BB6)
...
function ____exports.initSwitchBag()
    ...
    switchBagTrigger = registerKeyUpSync(nil, KEY.Z, onSwitchBagKey)
end
return ____exports
