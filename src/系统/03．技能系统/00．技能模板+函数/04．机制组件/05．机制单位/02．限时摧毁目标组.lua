    ...
    if not _____662F_5426_6210_529F then
        do
            ...
            while i < #self["目标单位列表"] do
                ...
                if ____self_2["是否存活"](____self_2) then
                    local ____self_3 = self["目标单位列表"][i + 1]
    ...
    do
        ...
        while i < #self["参数"]["目标列表"] do
            ...
            if _____76EE_6807 ~= nil then
                local ____self__76EE_6807_5355_4F4D_5217_8868_4 = self["目标单位列表"]
                ____self__76EE_6807_5355_4F4D_5217_8868_4[#____self__76EE_6807_5355_4F4D_5217_8868_4 + 1] = _____76EE_6807
            end
            i = i + 1
        end
    end
