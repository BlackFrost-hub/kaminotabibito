...
_____5355_4F4D_505C_7559_89E6_53D1_63A7_5236_5668_5B9E_73B0.prototype["刷新"] = function(self)
    ...
    local _____8303_56F4_5185_72B6_6001_5217_8868 = {}
        ...
        while i < #_____5217_8868 do
            do
                ...
                if _____72B6_6001 == nil then
                    ...
                    self["状态表"][_____5355_4F4DID] = _____65B0_72B6_6001
                    if self["参数"]["on进入"] ~= nil then
                        self["参数"]["on进入"](_____5355_4F4D)
                    end
                    _____8303_56F4_5185_72B6_6001_5217_8868[#_____8303_56F4_5185_72B6_6001_5217_8868 + 1] = {["目标单位"] = _____5355_4F4D, ["已持续毫秒"] = _____65B0_72B6_6001["已持续毫秒"], ["是否已触发"] = false}
                    goto __continue12
                end
                ...
                _____8303_56F4_5185_72B6_6001_5217_8868[#_____8303_56F4_5185_72B6_6001_5217_8868 + 1] = {["目标单位"] = _____5355_4F4D, ["已持续毫秒"] = _____72B6_6001["已持续毫秒"], ["是否已触发"] = _____72B6_6001["是否已触发"]}
            end
            ::__continue12::
            i = i + 1
        end
    ...
    if self["参数"]["on刷新完成"] ~= nil then
        self["参数"]["on刷新完成"](_____8303_56F4_5185_72B6_6001_5217_8868)
    end
end
