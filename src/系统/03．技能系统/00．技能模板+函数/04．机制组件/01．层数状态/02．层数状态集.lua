...
local _____5C42_6570_72B6_6001_96C6_5B9E_73B0 = __TS__Class()
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.name = "层数状态集实现"
function _____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype.____constructor(self, _____5B9A_4E49_5217_8868)
    self["控制器表"] = {}
    self["ID列表"] = {}
    do
        local i = 0
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["取控制器"] = function(self, ID)
    return self["控制器表"][ID]
end
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["增加"] = function(self, ID, _____5355_4F4D, _____5C42_6570, _____539F_56E0)
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["设置"] = function(self, ID, _____5355_4F4D, _____5C42_6570, _____539F_56E0)
    if _____539F_56E0 == nil then
        _____539F_56E0 = "设置"
    end
    local _____63A7_5236_5668 = self["控制器表"][ID]
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["减少"] = function(self, ID, _____5355_4F4D, _____5C42_6570, _____539F_56E0)
    if _____5C42_6570 == nil then
        _____5C42_6570 = 1
    end
    if _____539F_56E0 == nil then
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["清空"] = function(self, ID, _____5355_4F4D, _____539F_56E0)
    if _____539F_56E0 == nil then
        _____539F_56E0 = "清空"
    end
    local _____63A7_5236_5668 = self["控制器表"][ID]
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["清空单位全部"] = function(self, _____5355_4F4D, _____539F_56E0)
    if _____539F_56E0 == nil then
        _____539F_56E0 = "清空全部"
    end
    do
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["取层数"] = function(self, ID, _____5355_4F4D)
    local _____63A7_5236_5668 = self["控制器表"][ID]
    return _____63A7_5236_5668 == nil and 0 or _____63A7_5236_5668["取层数"](_____63A7_5236_5668, _____5355_4F4D)
end
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["取最高层数"] = function(self, _____5355_4F4D)
...
_____5C42_6570_72B6_6001_96C6_5B9E_73B0.prototype["销毁"] = function(self)
    do
        local i = 0
        while i < #self["ID列表"] do
            local ID = self["ID列表"][i + 1]
...
____exports["创建层数状态集"] = function(_____5B9A_4E49_5217_8868)
    return __TS__New(_____5C42_6570_72B6_6001_96C6_5B9E_73B0, _____5B9A_4E49_5217_8868)
end
return ____exports
