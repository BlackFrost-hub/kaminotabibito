...
local ____exports = {}
local ____02_FF0E_5C42_6570_72B6_6001_96C6 = require("系统.03．技能系统.00．技能模板+函数.04．机制组件.01．层数状态.02．层数状态集")
local _____521B_5EFA_5C42_6570_72B6_6001_96C6 = ____02_FF0E_5C42_6570_72B6_6001_96C6["创建层数状态集"]
...
function _____5355_4F4D_72B6_6001_8868_5B9E_73B0.prototype.____constructor(self, _____53C2_6570)
    self["单位列表"] = {}
    self["层数状态"] = _____521B_5EFA_5C42_6570_72B6_6001_96C6(_____53C2_6570["层数状态列表"])
