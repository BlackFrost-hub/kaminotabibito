...
local function ____on_804A_5929145_6D4B_8BD5()
    local soundHandle = jassGlobals.gg_snd_SecretFound
    debugLogForce(_____6A21_5757_540D, "准备播放 jass.globals.gg_snd_SecretFound", "handle=", soundHandle)
    PlaySoundBJ(soundHandle)
end
_____6CE8_518C_804A_5929_547D_4EE4_76D1_542C(_____6D4B_8BD5_547D_4EE4, ____on_804A_5929145_6D4B_8BD5)
debugLogForce(_____6A21_5757_540D, "已注册测试：输入", _____6D4B_8BD5_547D_4EE4, "播放 jass.globals.gg_snd_SecretFound")
return ____exports
