...
local ____require_result_2 = require("系统.01．单位系统.06．仇恨系统.index")
local _____521D_59CB_5316_4EC7_6068_7CFB_7EDF = ____require_result_2["初始化仇恨系统"]
local _____9A71_52A8_5355_4E2A_654C_4EBA = ____require_result_2["驱动单个敌人"]
local ____require_result_3 = require("系统.01．单位系统.06．仇恨系统.00．仇恨存储")
local addThreat = ____require_result_3.addThreat
local clearAllThreat = ____require_result_3.clearAllThreat
