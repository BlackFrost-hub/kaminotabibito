...
____exports["施加潜行状态"] = function(_____53C2_6570)
    ...
    local ____65BD_52A0_9690_8EAB_9 = _____65BD_52A0_9690_8EAB
    local ____53C2_6570__5355_4F4D_8 = _____53C2_6570["单位"]
    ...
    local ____temp_7 = _____53C2_6570["破隐额外暗属性伤害倍率"] or 0
    ...
    ____65BD_52A0_9690_8EAB_9(____53C2_6570__5355_4F4D_8, {
        ["持续时间"] = ____53C2_6570__6301_7EED_79D2_6570_4,
        ["破隐固定额外伤害"] = ____temp_5,
        ["破隐伤害倍率"] = ____temp_6,
        ["破隐额外暗属性伤害倍率"] = ____temp_7,
        ["来源单位"] = ____53C2_6570__6765_6E90_5355_4F4D_3,
    ...
    if (_____53C2_6570["固定移速"] or 0) > 0 or (_____53C2_6570["基础移速百分比"] or 0) > 0 or (_____53C2_6570["当前移速百分比"] or 0) > 0 then
        local ____65BD_52A0_79FB_901F_63D0_5347Buff_11 = _____65BD_52A0_79FB_901F_63D0_5347Buff
        local ____53C2_6570__6765_6E90_5355_4F4D_10 = _____53C2_6570["来源单位"]
        if ____53C2_6570__6765_6E90_5355_4F4D_10 == nil then
            ____53C2_6570__6765_6E90_5355_4F4D_10 = _____53C2_6570["单位"]
        end
        ____65BD_52A0_79FB_901F_63D0_5347Buff_11(____53C2_6570__6765_6E90_5355_4F4D_10, _____53C2_6570["单位"], {
            ...
            ["效果来源名称"] = _____53C2_6570["效果来源名称"] or _____53C2_6570["名称"] or "潜行",
            ["效果来源类型"] = _____53C2_6570["效果来源类型"]
        })
    end
