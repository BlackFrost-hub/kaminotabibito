...
local function _____53D6_547D_4E2D_6D3E_751F_88C5_5907_6280_80FD_7C7B_578B(event)
    return _____662F_7EAF_666E_653B(event["伤害快照"]) and "普攻强化" or "装备被动"
end
        ...
        _____914D_7F6E,
        {
            ...
            ["on触发"] = function(event)
                ...
                _____9020_6210_88C5_5907_4F24_5BB3(
                    ...
                    {
                        ["装备技能类型"] = _____53D6_547D_4E2D_6D3E_751F_88C5_5907_6280_80FD_7C7B_578B(event),
                        ["标签"] = _____914D_7F6E["伤害标签"] or _____914D_7F6E["名称"] or _____914D_7F6E["装备名"],
                        ["伤害形态"] = "单体"
                    }
                )
            end
