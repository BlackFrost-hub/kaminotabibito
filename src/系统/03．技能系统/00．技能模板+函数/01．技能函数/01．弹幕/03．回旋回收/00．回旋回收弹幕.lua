...
____exports["创建回旋回收弹幕"] = function(_____53C2_6570)
    ...
    local endX = startX + CosBJ(face) * _____53C2_6570["距离"]
    local endY = startY + SinBJ(face) * _____53C2_6570["距离"]
    local _____504F_79FB = _____53C2_6570["曲线偏移"] or 180
    local ctrlX = startX + CosBJ(face + 90) * _____504F_79FB + CosBJ(face) * _____53C2_6570["距离"] * 0.5
    local ctrlY = startY + SinBJ(face + 90) * _____504F_79FB + SinBJ(face) * _____53C2_6570["距离"] * 0.5
    ...
    _____521B_5EFA_539F_751F_5F39_5E55({
        ...
        ["on结束"] = function()
            ...
            _____521B_5EFA_539F_751F_5F39_5E55({
                ...
                ["最大距离"] = _____56DE_7A0B_9501_5B9A_65BD_6CD5_8005 and _____53C2_6570["距离"] * 3 or _____56DE_7A0B_8DDD_79BB,
