...
local getHealRate = ____require_result_2.getHealRate
local setHealRate = ____require_result_2.setHealRate
local getReceivedHealRate = ____require_result_2.getReceivedHealRate
local setReceivedHealRate = ____require_result_2.setReceivedHealRate
