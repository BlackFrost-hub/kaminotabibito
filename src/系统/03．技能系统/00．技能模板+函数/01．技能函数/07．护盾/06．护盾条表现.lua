...
____exports["创建护盾条"] = function(_____5355_4F4D)
    ...
    local _____62A4_76FE_6761_5355_4F4D = _____521B_5EFA_5355_4F4D_5E76_767B_8BB0_6392_6CC4_5B89_5168(
        owner,
        SHIELD_BAR_UNIT_ID,
        x,
        y,
...
____exports["清除所有护盾条"] = function()
    ...
    do
        local i = 0
        while i < #_____5355_4F4DID_5217_8868 do
            _____79FB_9664_62A4_76FE_6761(_____5355_4F4DID_5217_8868[i + 1])
            i = i + 1
        end
    end
