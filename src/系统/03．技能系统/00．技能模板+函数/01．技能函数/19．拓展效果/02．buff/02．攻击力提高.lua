...
local _____9ED8_8BA4_653B_51FB_529B_63D0_9AD8BuffID = "C028"
local _____653B_51FB_529B_5C5E_6027ID = 1
local _____653B_51FB_529B_63D0_9AD8_72B6_6001_8868 = {}
...
local function _____53D6_6709_6548BuffID(BuffID)
    return BuffID ~= nil and BuffID ~= "" and BuffID or _____9ED8_8BA4_653B_51FB_529B_63D0_9AD8BuffID
end
...
local function ____on_653B_51FB_529B_63D0_9AD8_79FB_9664(_____5355_4F4D, BuffID, _row)
    local key = _____53D6_5355_4F4D_952E(_____5355_4F4D, BuffID)
    if key == "" then
        return
    end
    local _____72B6_6001 = _____653B_51FB_529B_63D0_9AD8_72B6_6001_8868[key]
    __TS__Delete(_____653B_51FB_529B_63D0_9AD8_72B6_6001_8868, key)
    if _____72B6_6001 == nil then
        return
    end
    _____8C03_6574_5355_4F4D_653B_51FB_529B(_____5355_4F4D, -_____72B6_6001["数值"])
end
____exports["施加单体攻击力提高Buff"] = function(_____6765_6E90_5355_4F4D, _____76EE_6807_5355_4F4D, _____53C2_6570)
    ...
    local _____65E7_72B6_6001 = _____653B_51FB_529B_63D0_9AD8_72B6_6001_8868[key]
    ...
    _____653B_51FB_529B_63D0_9AD8_72B6_6001_8868[key] = {["数值"] = _____751F_6548_653B_51FB_529B}
    registerManualBuff(
        ...
        _____751F_6548_653B_51FB_529B,
        {
            ...
            onRemove = ____on_653B_51FB_529B_63D0_9AD8_79FB_9664
        }
    )
    return true
end
____exports["施加范围攻击力提高Buff"] = function(_____6765_6E90_5355_4F4D, _____53C2_6570)
    if _____6765_6E90_5355_4F4D == nil or _____6765_6E90_5355_4F4D == 0 then
        return 0
    end
    ...
    local _____7B5B_9009 = _____53C2_6570["筛选"] or ({["仅友军"] = true, ["排除自身"] = false})
    ...
    do
        ...
        while i < #_____5355_4F4D_5217_8868 do
            do
                ...
                if ____exports["施加单体攻击力提高Buff"](_____6765_6E90_5355_4F4D, _____76EE_6807_5355_4F4D, _____53C2_6570) then
