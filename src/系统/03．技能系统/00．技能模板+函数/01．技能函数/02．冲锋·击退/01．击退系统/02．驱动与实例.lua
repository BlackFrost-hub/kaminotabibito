...
____exports["创建位移实例"] = function(_____5355_4F4D, _____89D2_5EA6, _____53C2_6570)
    ...
    local ____temp_21 = _____53C2_6570["命中半径"] or 0
    local ____temp_22 = _____53C2_6570["只命中敌人"] == true
    local ____temp_23 = _____53C2_6570["允许命中自己"] == true
    local ____temp_24 = _____53C2_6570["允许重复命中"] == true
    local ____temp_25 = _____53C2_6570["命中后结束"] == true
    local ____temp_26 = _____53C2_6570["命中伤害"] or 0
