...
local ____require_result_3 = require("系统.05．Buff系统.01．控制抗性.index")
local calcReducedControlDuration = ____require_result_3.calcReducedControlDuration
local isExcludedFromControlResist = ____require_result_3.isExcludedFromControlResist
...
local ____require_result_5 = require("系统.05．Buff系统.07．睡眠系统")
local _____65BD_52A0_7761_7720 = ____require_result_5["施加睡眠"]
...
____exports["施加扩展控制"] = function(_____6765_6E90_5355_4F4D_6216Self, _____76EE_6807_5355_4F4D_6216_6765_6E90_5355_4F4D, _____7C7B_578B_6216_76EE_6807_5355_4F4D, _____53C2_6570_6216_7C7B_578B, _____517C_5BB9_53C2_6570)
    ...
    if _____7C7B_578B == "sleep" then
        local _____7761_7720_53C2_6570 = _____89C4_8303_53C2_6570
        local ok = _____65BD_52A0_7761_7720({
            ["来源单位"] = _____6765_6E90_5355_4F4D,
            ["目标单位"] = _____76EE_6807_5355_4F4D,
            ["持续时间"] = _____5B9E_9645_6301_7EED_65F6_95F4,
            ["伤害阈值"] = _____7761_7720_53C2_6570["伤害阈值"],
            ["保底时间"] = _____7761_7720_53C2_6570["保底时间"]
        })
        if not ok then
            return 0
        end
