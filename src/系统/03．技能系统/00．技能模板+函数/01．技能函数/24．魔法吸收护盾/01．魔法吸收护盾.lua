...
function _____9690_85CF_5E76_9500_6BC1_9B54_6CD5_5438_6536_7279_6548(_____7279_6548, _____7ED1_5B9A_5355_4F4D)
    if _____7279_6548 == nil or _____7279_6548 == 0 then
        return
    end
    if _____7ED1_5B9A_5355_4F4D then
        DzUnbindEffect(_____7279_6548)
    end
...
function _____662F_5426_53EF_5438_6536(_____5B9E_4F8B, _____53D7_51FB_5355_4F4D, context)
    ...
    local _____6700_5927_9B54_6CD5 = GetUnitStateJapi(_____53D7_51FB_5355_4F4D, UNIT_STATE_MAX_MANA)
...
____exports["播放魔法吸收护盾特效"] = function(_____53C2_6570)
    local _____5355_4F4D = _____53C2_6570["单位"]
    if _____5355_4F4D == nil or _____5355_4F4D == 0 then
        return
    end
    if _____53C2_6570["是否有特效"] == false then
        return
    end
    local path = _____53C2_6570["特效路径"] and _____53C2_6570["特效路径"] ~= "" and _____53C2_6570["特效路径"] or _____9ED8_8BA4_9B54_6CD5_5438_6536_7279_6548_8DEF_5F84
    if path == nil or path == "" then
        return
    end
    local _____6301_7EED_65F6_95F4 = _____53C2_6570["特效持续时间"] ~= nil and _____53C2_6570["特效持续时间"] > 0 and _____53C2_6570["特效持续时间"] or 1
    local _____662F_5426_7ED1_5B9A_5355_4F4D = _____53C2_6570["特效绑定单位"] ~= false
    ...
    if _____662F_5426_7ED1_5B9A_5355_4F4D then
        local _____6302_70B9 = _____53C2_6570["特效挂点"] and _____53C2_6570["特效挂点"] ~= "" and _____53C2_6570["特效挂点"] or _____9ED8_8BA4_9B54_6CD5_5438_6536_7279_6548_6302_70B9
        DzBindEffect(_____5355_4F4D, _____6302_70B9, effect)
    else
        EXEffectMatRotateZ(
            effect,
...
function _____5438_6536_9B54_6CD5_62A4_76FE_4F24_5BB3(_____5B9E_4F8B, _____53D7_51FB_5355_4F4D, _____4F24_5BB3_503C)
    ...
    _____51CF_5C11_9B54_6CD5_503C(_____53D7_51FB_5355_4F4D, _____9700_8981_9B54_6CD5, _____5B9E_4F8B["显示文本"] == true, false)
    ____exports["播放魔法吸收护盾特效"]({
        ["单位"] = _____53D7_51FB_5355_4F4D,
        ["是否有特效"] = _____5B9E_4F8B["是否有特效"],
        ["特效路径"] = _____5B9E_4F8B["特效路径"],
        ["特效挂点"] = _____5B9E_4F8B["特效挂点"],
        ["特效绑定单位"] = _____5B9E_4F8B["特效绑定单位"],
        ["特效持续时间"] = _____5B9E_4F8B["特效持续时间"]
    })
...
DzBindEffect = japi.DzBindEffect
