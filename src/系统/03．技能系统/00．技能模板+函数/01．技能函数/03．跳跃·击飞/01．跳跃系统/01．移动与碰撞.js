 ...
 * 包含单步移动尝试和多步推进逻辑。
 */
import { X_IsTerrainWalkable, X_GetAbleX, X_GetAbleY, BJ_DEGTORAD, MAX_SUB_STEP, WALKABLE_TOLERANCE, 跳跃映射, 在可玩区域内, 计算坐标距离, 计算抛物线高度, 播放跳跃特效, GetUnitX, GetUnitY, GetUnitFlyHeight, SetUnitFlyHeight, SetUnitFacing, SetUnitX, SetUnitY, Cos, Sin, } from "./00．共享";
