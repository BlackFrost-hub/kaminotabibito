...
local _____9ED8_8BA4_8FDB_5EA6_6761_9AD8_5EA6_504F_79FB = _____8FDB_5EA6_6761_7279_6548["默认进度条高度偏移"]
...
function _____7ED3_675F_5145_80FD_5B9E_4F8B(_____5B9E_4F8B, _____539F_56E0)
    ...
    _____9500_6BC1_4E16_754C_5750_6807_8FDB_5EA6UI(_____5B9E_4F8B["世界坐标进度UI"])
...
function ____on_5145_80FD_7CFB_7EDFTick()
    ...
    while i < #_____6D3B_52A8_5145_80FD_5217_8868 do
        do
            ...
            if _____5B9E_4F8B["硬控中断"] and _____5355_4F4D_662F_5426_5904_4E8E_786C_63A7_5236_6548_679C_5408_96C6(_____5B9E_4F8B["单位"]) then
                _____7ED3_675F_5145_80FD_5B9E_4F8B(_____5B9E_4F8B, "中断")
                goto __continue80
            end
            ...
            _____66F4_65B0_4E16_754C_5750_6807_8FDB_5EA6UI(_____5B9E_4F8B["世界坐标进度UI"], _____5B9E_4F8B["剩余时间"])
...
____exports["开始充能"] = function(_____5355_4F4D, _____53C2_6570)
    ...
    local _____65B0_5B9E_4F8B = {
        ...
        ["硬控中断"] = _____53C2_6570["硬控中断"] ~= false,
    ...
    if _____663E_793A_8FDB_5EA6_6761_7279_6548 then
        _____521B_5EFA_8FDB_5EA6_6761_7279_6548(
            _____5355_4F4D,
            {
                ["高度偏移"] = _____53C2_6570["进度条特效高度偏移"] or _____9ED8_8BA4_8FDB_5EA6_6761_9AD8_5EA6_504F_79FB,
    ...
    if _____53C2_6570["世界坐标进度UI"] == true then
        local _____9AD8_5EA6_504F_79FB = _____53C2_6570["世界坐标进度UI高度偏移"] or 180
        _____65B0_5B9E_4F8B["世界坐标进度UI"] = _____521B_5EFA_4E16_754C_5750_6807_8FDB_5EA6UI({
            X = GetUnitX(_____5355_4F4D),
            Y = GetUnitY(_____5355_4F4D),
            Z = _____9AD8_5EA6_504F_79FB,
            ["最大值"] = _____6301_7EED_65F6_95F4,
            ["当前值"] = _____6301_7EED_65F6_95F4,
            ["标题"] = _____53C2_6570["世界坐标进度UI标题"] or "蓄力",
            ["数值后缀"] = _____53C2_6570["世界坐标进度UI数值后缀"] or "秒",
            ["类型"] = _____53C2_6570["世界坐标进度UI类型"] or "通用",
            ["跟随单位"] = _____5355_4F4D,
            ["跟随Z偏移"] = _____9AD8_5EA6_504F_79FB,
            ["屏幕Y偏移"] = _____53C2_6570["世界坐标进度UI屏幕Y偏移"] or 0,
            ["初始显示"] = true
        })
    end
