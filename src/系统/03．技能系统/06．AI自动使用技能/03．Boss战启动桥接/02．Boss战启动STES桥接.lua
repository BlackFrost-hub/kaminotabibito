...
function _____786E_4FDDBoss_6218_7BAD_5934_7279_6548(bossUnit)
    ...
    local existed = YDUserDataGetSafe("unit", bossUnit, ____Boss_6218_7BAD_5934_7279_6548_5B57_6BB5, "effect")
    if existed ~= nil and existed ~= 0 then
        return
    end
    local effect = AddSpecialEffectTarget(____Boss_6218_7BAD_5934_7279_6548_6A21_578B, bossUnit, ____Boss_6218_7BAD_5934_7279_6548_6302_70B9)
    ...
    YDUserDataSetSafe(
        "unit",
        bossUnit,
        ____Boss_6218_7BAD_5934_7279_6548_5B57_6BB5,
        "effect",
        effect
    )
end
function _____767B_8BB0Boss_81EA_52A8_6280_80FD_542F_52A8(bossUnit, source)
    ...
    _____786E_4FDDBoss_6218_7BAD_5934_7279_6548(bossUnit)
...
local ____require_result_5 = require("系统.03．技能系统.06．AI自动使用技能.03．Boss战启动桥接.00．常量定义")
...
local ____require_result_6 = require("系统.03．技能系统.06．AI自动使用技能.03．Boss战启动桥接.01．Boss自动技能注册表")
