...
local _____4FDD_7559_5267_60C5Boss_6B7B_4EA1_51FB_6740_8005_5B57_6BB5 = "保留剧情Boss死亡击杀者"
    ...
    if _____914D_7F6E["保留原剧情执行"] == true then
        if killingUnit ~= nil and killingUnit ~= 0 then
            YDUserDataSetSafe(
                "unit",
                dyingUnit,
                _____4FDD_7559_5267_60C5Boss_6B7B_4EA1_51FB_6740_8005_5B57_6BB5,
                "unit",
                killingUnit
            )
        end
...
____exports["消费保留剧情Boss死亡击杀者"] = function(bossUnit)
    if bossUnit == nil or bossUnit == 0 then
        return nil
    end
    local killingUnit = YDUserDataGetSafe("unit", bossUnit, _____4FDD_7559_5267_60C5Boss_6B7B_4EA1_51FB_6740_8005_5B57_6BB5, "unit")
    YDUserDataClearSafe("unit", bossUnit, _____4FDD_7559_5267_60C5Boss_6B7B_4EA1_51FB_6740_8005_5B57_6BB5, "unit")
    return killingUnit
end
