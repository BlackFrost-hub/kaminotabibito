...
local ____exports = {}
do
    local ____export = require("系统.03．技能系统.06．AI自动使用技能.00．AI配置.index")
...
do
    local ____export = require("系统.03．技能系统.06．AI自动使用技能.03．Boss战启动桥接.index")
    for ____exportKey, ____exportValue in pairs(____export) do
        if ____exportKey ~= "default" then
            ____exports[____exportKey] = ____exportValue
        end
...
function ____exports.init()
    ...
    local ____Boss_6218_542F_52A8_6865_63A5_6A21_5757 = require("系统.03．技能系统.06．AI自动使用技能.03．Boss战启动桥接.index")
