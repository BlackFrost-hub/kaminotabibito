...
local ____02_FF0E_6742_9C7CAI_914D_7F6E_8868 = require("系统.03．技能系统.06．AI自动使用技能.00．AI配置.02．杂鱼AI配置表.index")
local _____6742_9C7CAI_914D_7F6E_8868 = ____02_FF0E_6742_9C7CAI_914D_7F6E_8868["杂鱼AI配置表"]
local ____03_FF0E_7CBE_82F1AI_914D_7F6E_8868 = require("系统.03．技能系统.06．AI自动使用技能.00．AI配置.03．精英AI配置表.index")
local _____7CBE_82F1AI_914D_7F6E_8868 = ____03_FF0E_7CBE_82F1AI_914D_7F6E_8868["精英AI配置表"]
