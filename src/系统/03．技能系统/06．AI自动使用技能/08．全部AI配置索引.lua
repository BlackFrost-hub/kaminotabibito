...
local ____06_FF0E_82F1_96C4AI_914D_7F6E_8868 = require("系统.03．技能系统.06．AI自动使用技能.06．英雄AI配置表")
local _____82F1_96C4AI_914D_7F6E_8868 = ____06_FF0E_82F1_96C4AI_914D_7F6E_8868["英雄AI配置表"]
...
__TS__SparseArrayPush(
    ____array_0,
    table.unpack(_____82F1_96C4AI_914D_7F6E_8868)
)
__TS__SparseArrayPush(
    ____array_0,
