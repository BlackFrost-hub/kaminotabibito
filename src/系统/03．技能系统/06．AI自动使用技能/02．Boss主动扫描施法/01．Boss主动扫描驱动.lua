...
local _____6309_5355_4F4D_540D_83B7_53D6_5355_4F4DAI_914D_7F6E = ____02_FF0EAI_914D_7F6E_5DE5_5177["按单位名获取单位AI配置"]
...
local ____01_FF0EBoss_81EA_52A8_6280_80FD_6CE8_518C_8868 = require("系统.03．技能系统.06．AI自动使用技能.09．Boss战启动桥接.01．Boss自动技能注册表")
...
local function _____8BFB_53D6_6280_80FD_8868_6570_503C(skillId, field)
    ...
    local ____temp_8
    if field == "Rng" then
        ____temp_8 = _____6280_80FD_65BD_6CD5_8DDD_79BB_7F13_5B58[_____7F13_5B58_952E]
    else
        ____temp_8 = _____6280_80FD_65BD_6CD5_8303_56F4_7F13_5B58[_____7F13_5B58_952E]
    end
    local cached = ____temp_8
    if cached ~= nil then
        return cached
    end
...
local function _____5C1D_8BD5_9A71_52A8_5355_4E2ABoss(context)
    ...
    local _____5355_4F4D_540D = jass.GetUnitName(unit)
    local _____914D_7F6E = _____6309_5355_4F4D_540D_83B7_53D6_5355_4F4DAI_914D_7F6E(_____5F02_754CBossAI_914D_7F6E_8868, _____5355_4F4D_540D)
    ...
    local ____skill__6280_80FD_540D_11 = skill["技能名"]
    local ____skill__6280_80FDID_12 = skill["技能ID"]
    local ____temp_10
    if target ~= nil and target ~= 0 then
        ____temp_10 = jass.GetUnitName(target)
    else
        ____temp_10 = "无目标"
    end
    ____debugLogForce_13(
        ...
        _____5355_4F4D_540D,
        "skill=",
        ____skill__6280_80FD_540D_11,
        "id=",
        ____skill__6280_80FDID_12,
        "target=",
        ____temp_10,
        "cdMs=",
        coolMs,
