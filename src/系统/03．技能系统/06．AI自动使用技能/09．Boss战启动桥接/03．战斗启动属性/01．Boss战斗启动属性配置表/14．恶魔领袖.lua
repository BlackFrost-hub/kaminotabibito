...
____exports["单位N03O战斗启动护卫配置"] = {["Boss单位ID"] = "N03O", ["Boss单位名"] = "恶魔领袖", ["初始护卫批次"] = {["广播说话者"] = "护卫", ["广播文案池"] = {"大人，我们来助您一臂之力。", "大人，这里的麻烦交给我们处理。", "大人，察觉您这边有变，我们立刻赶回来了。"}, ["后续对白"] = {{["延迟毫秒"] = 3000, ["说话者"] = "Boss", ["文案池"] = {"很好，你们来得正是时候。此战若胜，少不了你们的奖赏。"}}, {["延迟毫秒"] = 5000, ["说话者"] = "护卫", ["文案池"] = {"愿为大人效死力。"}}}, ["单位列表"] = {{
    ["单位ID"] = "n03N",
    ["单位名"] = "恶魔队长",
    X = 26803,
    Y = 20921.8,
