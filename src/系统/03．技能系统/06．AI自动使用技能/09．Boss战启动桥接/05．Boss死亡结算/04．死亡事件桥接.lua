...
local ____require_result_1 = require("系统.03．技能系统.06．AI自动使用技能.09．Boss战启动桥接.05．Boss死亡结算.03．核心逻辑")
local _____83B7_53D6Boss_6B7B_4EA1_7ED3_7B97_914D_7F6E = ____require_result_1["获取Boss死亡结算配置"]
