...
local _____8BBE_7F6E_6280_80FD_63D0_793A_539F_59CB_6A21_5F0F = ____05_FF0E_6280_80FD_63D0_793AUI["设置技能提示原始模式"]
--- 动态技能文本系统 - 入口与导出
-- 
-- 改为和冷却/蓝耗一致的本地选中驱动：
-- - 只处理本地玩家当前唯一选中的已注册英雄
...
local function _____6784_5EFA_52A8_6001_6587_672C_5FEB_7167_7B7E_540D(hero)
    ...
    do
        ...
        while i < #_____6280_80FD_70ED_952E_5217_8868 do
            ...
            local ____temp_1
            if abilityId ~= 0 then
                ____temp_1 = jass.GetUnitAbilityLevel(hero, abilityId)
            else
                ____temp_1 = 0
            end
            local level = ____temp_1
...
local function _____5904_7406Alt_6309_4E0B()
...
local function _____5904_7406Alt_677E_5F00()
...
local function onTick()
    ...
    if _____5DF2_5F00_542F then
        _____5DF2_5F00_542F_2 = _____83B7_53D6_672C_5730_5F53_524D_9009_4E2D_82F1_96C4()
    else
        _____5DF2_5F00_542F_2 = nil
    end
    local localHero = _____5DF2_5F00_542F_2
