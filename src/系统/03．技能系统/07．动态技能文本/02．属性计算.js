...
const { YDUserDataGet2 } = require("lib.扩展函数.YDWE函数.index");
function 获取玩家属性(unit, 属性名) {
 ...
 * 计算公式结果：属性值 × 倍率
 */
export function 计算公式伤害(unit, 属性, 倍率字符串) {
