...
____exports["释放菲尼克斯尔熔岩吐息"] = function(context, target)
...
local function ____on_83F2_5C3C_514B_65AF_5C14_7194_5CA9_5410_606F_751F_6548(castingUnit, spellAbilityId)
    ...
    if context ~= nil then
        ____exports["释放菲尼克斯尔熔岩吐息"](context)
    end
end
