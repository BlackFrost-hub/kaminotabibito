...
function _____6E05_9664_9AB8_9AA8_7B26_5492_5C5E_6027_6548_679C(unit)
...
function ____on_9AB8_9AA8_7B26_5492Buff_79FB_9664(unit, _buffID, _row)
    _____6E05_9664_9AB8_9AA8_7B26_5492_5C5E_6027_6548_679C(unit)
end
function _____65BD_52A0_9AB8_9AA8_7B26_5492_5C5E_6027_6548_679C(unit)
...
function _____5C1D_8BD5_91CD_7EC4_9AB8_9AA8_6218_58EB(context, group)
    ...
    ____self_11["登记延迟回调"](____self_11, "影骨-骸骨重组", id)
end
function _____5F71_9AA8_53EC_5524_7269_6B7B_4EA1(unit, _killer, variable)
    ...
    if variable.group ~= nil and variable.canReform then
        local ____variable_group_12, _____6B7B_4EA1_6570_13 = variable.group, "死亡数"
        ____variable_group_12[_____6B7B_4EA1_6570_13] = ____variable_group_12[_____6B7B_4EA1_6570_13] + 1
...
____exports["创建影骨召唤物"] = function(context, unitType, x, y, group, canReform)
    ...
    if instance ~= nil and instance["单位"] ~= nil then
        ...
        if group ~= nil then
            local ____group__5355_4F4D_5217_8868_14 = group["单位列表"]
            ____group__5355_4F4D_5217_8868_14[#____group__5355_4F4D_5217_8868_14 + 1] = instance["单位"]
        end
...
local registerDamageBaseModifier = ____require_result_5.registerDamageBaseModifier
local ____require_result_6 = require("系统.04．伤害系统.00．伤害计算.07．伤害类型转换")
local registerDamageTypeConversion = ____require_result_6.registerDamageTypeConversion
...
local ____require_result_8 = require("系统.05．Buff系统.03．Buff表.01．Boss.02．挑战与隐藏Boss.04．影骨莫特斯")
_____5F71_9AA8_83AB_7279_65AFBuffID = ____require_result_8["影骨莫特斯BuffID"]
...
local function ____on_5F71_9AA8_9AB7_9AC5_5077_7A83_4FEE_6B63(damageContext)
    ...
    if damageContext.originalAttacker ~= nil and damageContext.originalAttacker ~= 0 then
        ____temp_9 = damageContext.originalAttacker
    else
        ____temp_9 = damageContext.attacker
    end
...
____exports["释放影骨骸骨召唤"] = function(context)
    ...
    local ____self_15 = context["骸骨召唤组合执行器"]
    if ____self_15["是否运行中"](____self_15) then
        return nil
    end
    local ____context_16, _____4E0B_4E00_4E2A_53EC_5524_7EC4ID_17 = context, "下一个召唤组ID"
    local ____context__4E0B_4E00_4E2A_53EC_5524_7EC4ID_18 = ____context_16[_____4E0B_4E00_4E2A_53EC_5524_7EC4ID_17] + 1
    ____context_16[_____4E0B_4E00_4E2A_53EC_5524_7EC4ID_17] = ____context__4E0B_4E00_4E2A_53EC_5524_7EC4ID_18
    local group = {
        ID = ____context__4E0B_4E00_4E2A_53EC_5524_7EC4ID_18,
        ["阶段"] = context["阶段"],
        ["总数"] = 4,
        ["死亡数"] = 0,
        ["已重组"] = false,
    ...
    local ____self_19 = context["骸骨召唤组合执行器"]
    local _____6267_884CID = ____self_19["开始"](
        ____self_19,
        {
            key = "骸骨召唤",
            ["单位"] = boss,
