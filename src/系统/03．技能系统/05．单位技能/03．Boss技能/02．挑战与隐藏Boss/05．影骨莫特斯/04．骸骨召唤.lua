...
local ____require_result_7 = require("系统.05．Buff系统.03．Buff表.01．Boss.02．挑战与隐藏Boss.04．影骨莫特斯")
...
____exports["释放影骨骸骨召唤"] = function(context)
    ...
    local ____self_11 = context["骸骨召唤组合执行器"]
    if ____self_11["是否运行中"](____self_11) then
        return
    end
