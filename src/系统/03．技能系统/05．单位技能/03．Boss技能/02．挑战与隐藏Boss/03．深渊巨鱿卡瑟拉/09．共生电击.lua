...
local function _____786E_4FDD_7EDD_7F18_73CA_745A(context)
    ...
    do
        ...
        while i < #_____5B89_5168_533A_5217_8868 do
            ...
            ____context__7EDD_7F18_73CA_745A_5217_8868_8[#____context__7EDD_7F18_73CA_745A_5217_8868_8 + 1] = {X = _____533A.X, Y = _____533A.Y, ["半径"] = _____533A["半径"], ["装饰单位"] = _____533A["装饰物"]}
            i = i + 1
        end
    end
end
local function _____73A9_5BB6_5728_7EDD_7F18_73CA_745A_5185(context, hero)
    if context["绝缘珊瑚安全区组"] ~= nil then
        ...
        return ____self_9["单位是否安全"](____self_9, hero)
    end
...
local function _____9884_8B66_7EDD_7F18_73CA_745A(context)
    local cfg = _____5361_745F_62C9_6570_503C_4E0E_8868_73B0_914D_7F6E["共生电击"]
    if context["绝缘珊瑚安全区组"] ~= nil then
        local ____self_10 = context["绝缘珊瑚安全区组"]
        ____self_10["显示提示"](____self_10, cfg["预警秒"])
    end
end
local function _____5B89_6392_7EDD_7F18_73CA_745A_5EF6_8FDF_5220_9664(context)
    ...
    ____self_11["登记延迟回调"](____self_11, "卡瑟拉-绝缘珊瑚延迟删除", id)
end
...
____exports["释放卡瑟拉共生电击"] = function(context)
    ...
    local cfg = _____5361_745F_62C9_6570_503C_4E0E_8868_73B0_914D_7F6E["共生电击"]
    _____663E_793A_5E38_89C4_6280_80FD_541F_5531_6761({["总时长"] = cfg["预警秒"], ["颜色ID"] = cfg["吟唱条颜色ID"], ["标题文本"] = cfg["吟唱条标题文本"], ["提示文本"] = cfg["吟唱条提示文本"]})
    ...
    ____self_12["登记周期回调"](____self_12, "卡瑟拉-共生电击预警特效", _____9884_8B66_7279_6548["周期ID"])
    ...
    ____self_13["登记延迟回调"](____self_13, "卡瑟拉-共生电击结算", id)
    return true
end
return ____exports
