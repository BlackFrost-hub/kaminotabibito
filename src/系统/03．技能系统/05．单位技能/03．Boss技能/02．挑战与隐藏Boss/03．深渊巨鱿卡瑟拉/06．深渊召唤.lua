...
local _____767B_8BB0_62A4_536B_5355_4F4D = ____require_result_6["登记护卫单位"]
...
local _____83B7_53D6Boss_6280_80FD_6700_8FD1_654C_5BF9_82F1_96C4 = ____require_result_7["获取Boss技能最近敌对英雄"]
...
local function _____521B_5EFA_6DF1_6E0A_5E7C_9C7F(context, angle)
    ...
    ____self_8["登记延迟回调"](____self_8, "卡瑟拉-深渊幼鱿吞噬", id)
end
