...
local ____exports = {}
local _____83AB_5C14_7279_65AF_8150_8D25_4E4B_6E90_6B7B_4EA1, _____83AB_5C14_7279_65AF_8150_8D25_4E4B_6E90_9500_6BC1, _____521B_5EFA_70B9_7279_6548, GetUnitX, GetUnitY
...
local _____663E_793A_83AB_5C14_7279_65AF_5927_62DB_541F_5531_6761 = ____16_FF0E_516C_5171_5DE5_5177["显示莫尔特斯大招吟唱条"]
local _____5173_95ED_83AB_5C14_7279_65AF_5927_62DB_541F_5531_6761 = ____16_FF0E_516C_5171_5DE5_5177["关闭莫尔特斯大招吟唱条"]
...
local ____require_result_3 = require("系统.03．技能系统.00．技能模板+函数.04．机制组件.05．机制单位.02．限时摧毁目标组")
local _____521B_5EFA_9650_65F6_6467_6BC1_76EE_6807_7EC4 = ____require_result_3["创建限时摧毁目标组"]
...
local function _____521B_5EFA_8150_8D25_4E4B_6E90_76EE_6807_5217_8868(context)
    ...
    do
        ...
        while i < #cells do
            ...
            ____self_8["登记特效"](____self_8, "莫尔特斯-腐败之源脚下圈", circle)
            i = i + 1
        end
    end
    return targets
...
local function _____83AB_5C14_7279_65AF_6839_7CFB_89C9_9192_7ED3_675F(______662F_5426_6210_529F, ______5269_4F59_6570_91CF, context)
    _____5173_95ED_83AB_5C14_7279_65AF_5927_62DB_541F_5531_6761()
...
____exports["触发莫尔特斯根系觉醒"] = function(context)
    if context["根系觉醒已触发"] or not _____5355_4F4D_6709_6548(context["Boss单位"]) then
        return
    end
    context["根系觉醒已触发"] = true
    local cfg = _____83AB_5C14_7279_65AF_6570_503C_4E0E_8868_73B0_914D_7F6E["根系觉醒"]
    _____663E_793A_83AB_5C14_7279_65AF_5927_62DB_541F_5531_6761(cfg["限时秒"], "根系觉醒", "在时间结束前摧毁全部腐败之源")
    ...
    ____self_9["登记延迟回调"](____self_9, "莫尔特斯-根系觉醒显形动作", hideId)
end
return ____exports
