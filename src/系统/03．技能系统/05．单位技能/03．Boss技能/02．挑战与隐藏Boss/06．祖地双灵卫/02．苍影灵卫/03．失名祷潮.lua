    ...
    do
        ...
        while i < #context["净化节点列表"] do
            do
                ...
                local distance2 = _____70B9_5230_7EBF_6BB5_8DDD_79BB_5E73_65B9(
                    node.X,
                    node.Y,
                    startX,
                    startY,
...
____exports["释放失名祷潮"] = function(context, target)
    ...
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____7956_5730_53CC_7075_536B_6570_503C_4E0E_8868_73B0_914D_7F6E["表现资源"]["失名祷潮"]["祷潮蓄势特效路径"],
        X = startX,
        Y = startY,
        ["缩放"] = _____7956_5730_53CC_7075_536B_6570_503C_4E0E_8868_73B0_914D_7F6E["表现资源"]["失名祷潮"]["祷潮蓄势特效缩放"],
        ["持续秒"] = cfg["预警秒"]
    })
    local pullIds = {}
    do
    ...
    local resolveId = addDelayedCallback(
        ...
        function()
            ...
            barrage = _____521B_5EFA_539F_751F_5F39_5E55({
                ["所有者"] = boss,
                ["载体模式"] = "单位",
                ["模型"] = _____7956_5730_53CC_7075_536B_6570_503C_4E0E_8868_73B0_914D_7F6E["表现资源"]["失名祷潮"]["定向灵魂潮特效路径"],
                X = startX,
                Y = startY,
                ["方向角"] = facing,
                ["速度"] = cfg["长度"] / 0.8,
