...
____exports["更新祖地双灵卫双钥净化"] = function(context, now)
    ...
    if node["阶段"] == "已净化" and node["表现阶段"] ~= "已净化" then
        ...
        _____64AD_653EBoss_5750_6807_97F3_6548(_____7956_5730_53CC_7075_536B_6570_503C_4E0E_8868_73B0_914D_7F6E["音效"]["双钥净化"], node.X, node.Y, _____7956_5730_53CC_7075_536B_6570_503C_4E0E_8868_73B0_914D_7F6E["音效默认裁断距离"])
