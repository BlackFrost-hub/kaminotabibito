...
local ____require_result_2 = require("系统.03．技能系统.00．技能模板+函数.02．通用函数.09．提示特效")
local _____521B_5EFA_8584_5706_5F62_63D0_793A_5708_7279_6548 = ____require_result_2["创建薄圆形提示圈特效"]
local _____7ACB_5373_9500_6BC1_63D0_793A_5708_7279_6548 = ____require_result_2["立即销毁提示圈特效"]
...
local function _____5904_7406_7075_529B_610F_8BC6_4F53_5EF6_8FDF_7206_70B9()
    ...
    if record["预警特效"] ~= nil and record["预警特效"] ~= 0 then
        _____7ACB_5373_9500_6BC1_63D0_793A_5708_7279_6548(record["预警特效"])
    end
...
local function _____7075_529B_610F_8BC6_4F53_95EA_907F_540E_5904_7406(record, _applied, _snapshot)
    ...
    local _____9884_8B66_7279_6548 = _____521B_5EFA_8584_5706_5F62_63D0_793A_5708_7279_6548(
        x,
        y,
        _____7075_529B_610F_8BC6_4F53_5355_4F4D_6280_80FD_914D_7F6E["伤害半径"],
        1,
