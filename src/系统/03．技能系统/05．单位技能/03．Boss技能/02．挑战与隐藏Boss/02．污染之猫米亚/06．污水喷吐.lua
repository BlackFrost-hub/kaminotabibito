...
function _____64AD_653E_7C73_4E9A_6C61_6C34_55B7_5410_8868_73B0Tick(variable)
    ...
    if ____temp_9 or not _____5355_4F4D_6709_6548(boss) then
        if data["周期ID"] > 0 then
            removePeriodicCallback(data["周期ID"])
            data["周期ID"] = 0
        end
...
function _____64AD_653E_55B7_5410_8868_73B0(context, boss, _____4E2D_5FC3X, _____4E2D_5FC3Y, facing)
    local ____temp_11 = context == nil or context["清理"] == nil
    if not ____temp_11 then
        local ____self_10 = context["清理"]
        ____temp_11 = ____self_10["已清理"](____self_10)
    end
    if ____temp_11 or boss == nil or boss == 0 or not _____5355_4F4D_6709_6548(boss) then
        return
    end
    local config = _____7C73_4E9A_6280_80FD_6570_503C_914D_7F6E["污水喷吐"]
...
function _____521B_5EFA_6C61_6C34_55B7_5410_6B8B_7559_533A(context, _____4E2D_5FC3X, _____4E2D_5FC3Y, facing)
    ...
    _____521B_5EFA_6301_7EED_5371_9669_533A_57DF({
        ...
        ["on周期"] = function(_____533A_57DF_5185_5355_4F4D)
            local ____temp_16 = context == nil or context["清理"] == nil
            if not ____temp_16 then
                local ____self_15 = context["清理"]
                ____temp_16 = ____self_15["已清理"](____self_15)
            end
            if ____temp_16 then
                return
            end
...
function _____7ED3_7B97_7C73_4E9A_6C61_6C34_55B7_5410(variable)
    ...
    local context = data.context
    local ____temp_18 = context == nil or context["清理"] == nil
    if not ____temp_18 then
        local ____self_17 = context["清理"]
        ____temp_18 = ____self_17["已清理"](____self_17)
    end
    if ____temp_18 then
        return
    end
...
____exports["释放米亚污水喷吐"] = function(context)
    local ____temp_20 = context == nil or context["清理"] == nil
    if not ____temp_20 then
        local ____self_19 = context["清理"]
        ____temp_20 = ____self_19["已清理"](____self_19)
    end
    if ____temp_20 then
        return
    end
    ...
    local config = _____7C73_4E9A_6280_80FD_6570_503C_914D_7F6E["污水喷吐"]
    local ____opt_21 = _____83B7_53D6Boss_6280_80FD_5E94_653B_51FB_76EE_6807(boss)
    local threatTarget = ____opt_21 and ____opt_21.targetRef
    ...
    local _____7ED3_7B97_6570_636E = {context = context, ["朝向"] = facing, ["中心X"] = ____boss_5750_6807.x, ["中心Y"] = ____boss_5750_6807.y}
    _____542F_52A8_57FA_7840_65BD_6CD5_65F6_95F4_7EBF({
        ...
        ["吟唱条"] = {
            ...
            ["颜色ID"] = 3,
            ["标题文本"] = "污水喷吐",
            ["提示文本"] = ((((("1秒后向正面喷吐" .. tostring(config["喷吐特效持续秒"])) .. "秒，范围") .. tostring(config["喷吐距离"])) .. "码、") .. tostring(config["喷吐半角"] * 2)) .. "°扇形（离开米亚正面）"
        },
        ["清理"] = context["清理"],
        ["播放台词"] = function()
        ...
        ["on生效"] = function()
            _____7ED3_7B97_7C73_4E9A_6C61_6C34_55B7_5410(_____7ED3_7B97_6570_636E)
        end
    })
end
...
_____542F_52A8_57FA_7840_65BD_6CD5_65F6_95F4_7EBF = ____require_result_4["启动基础施法时间线"]
...
local ____require_result_6 = require("lib.扩展函数.封装函数.01．通用工具.07．数学运算")
ceil = ____require_result_6.ceil
