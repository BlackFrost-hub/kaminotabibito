...
local _____521B_5EFA_5355_4F4D_811A_4E0B_70B9_7279_6548 = ____require_result_4["创建单位脚下点特效"]
...
____exports["添加米亚腐化感染"] = function(context, _____5355_4F4D, _____5C42_6570, _____6765_6E90)
    ...
    local oldStack = ____self_6["取层数"](____self_6, _____5355_4F4D)
    local ____self_7 = context["腐化层数控制器"]
    local newStack = ____self_7["增加"](____self_7, _____5355_4F4D, _____5C42_6570, _____6765_6E90)
...
____exports["取米亚腐化感染层数"] = function(context, _____5355_4F4D)
    ...
    return ____self_8["取层数"](____self_8, _____5355_4F4D)
end
____exports["清空米亚腐化感染"] = function(context, _____5355_4F4D, _____539F_56E0)
    local ____self_9 = context["腐化层数控制器"]
    ____self_9["清空"](____self_9, _____5355_4F4D, _____539F_56E0)
end
____exports["注册米亚腐化感染机制"] = function()
    ...
    registerDamageModifier(_____7C73_4E9A_8150_5316_611F_67D3_4F24_5BB3_4FEE_6B63, 30)
end
return ____exports
