...
____exports["树魔首领单位技能配置"] = {
    ...
    ["主动技能提示"] = {{["技能ID"] = "A0LL", ["提示"] = "扩散冲击波", ["扩展提示"] = "蓄力后向周围发射风属性冲击波，并降低命中目标攻击力。"}, {["技能ID"] = "A0LM", ["提示"] = "消耗反击", ["扩展提示"] = "进入正面防御姿态，受到正面伤害时反击并削减目标魔法值。"}, {["技能ID"] = "A0LN", ["提示"] = "远古诅咒", ["扩展提示"] = "点名玩家承受可分摊诅咒，并在分摊后触发中心区域爆发。"}, {["技能ID"] = "AN00", ["提示"] = "树魔图腾", ["扩展提示"] = "根据场上随从类型在场地中央放置静止、生命或爆炸陷阱。"}},
    ["召唤物ID"] = {
        ["猎头者"] = "ohun",
        ["巫医"] = "odoc",
        ["投掷者"] = "h00U",
