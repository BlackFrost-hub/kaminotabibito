...
function _____6267_884C_5251_9B42_8DEF_5F84(context, paths)
                        ...
                        while h < #heroes do
                            do
                                ...
                                UnitDamageTarget(
                                    boss,
                                    hero,
                                    _____8BFB_53D6_5355_4F4D_653B_51FB_529B(boss) * cfg["路径伤害Boss攻击力比例"],
                                    false,
                                    false,
                                    ATTACK_TYPE_NORMAL,
                                    DAMAGE_TYPE_NORMAL,
    ...
    ____self_12["登记周期回调"](____self_12, "菲利斯-剑魂杀飞行", callbackID)
end
...
local ____require_result_3 = require("系统.03．技能系统.00．技能模板+函数.04．机制组件.05．机制单位.03．固定受击次数机制单位")
_____521B_5EFA_56FA_5B9A_53D7_51FB_6B21_6570_673A_5236_5355_4F4D = ____require_result_3["创建固定受击次数机制单位"]
...
local ____require_result_8 = require("系统.05．Buff系统.03．Buff表.01．Boss.06．菲利斯")
...
local function ____on_5251_9B42_72FC_6700_7EC8_4F24_5BB3(target, attacker, _applied, snapshot)
    ...
    UnitDamageTarget(
        attacker,
        target,
        GetUnitState(target, UNIT_STATE_MAX_LIFE) * record["伤害比例"],
        false,
        false,
        ATTACK_TYPE_NORMAL,
        DAMAGE_TYPE_NORMAL,
