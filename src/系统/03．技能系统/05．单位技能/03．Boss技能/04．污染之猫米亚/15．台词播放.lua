...
____exports["播放米亚台词"] = function(boss, _____7C7B_578B, index)
    _____64AD_653EBoss_53F0_8BCD_5E7F_64AD(
        boss,
        _____7C73_4E9A_5355_4F4D_6280_80FD_914D_7F6E["台词"],
        _____7C7B_578B,
        _____7C73_4E9A_5355_4F4D_6280_80FD_914D_7F6E["广播持续时间Ms"],
        index
    )
end
return ____exports
