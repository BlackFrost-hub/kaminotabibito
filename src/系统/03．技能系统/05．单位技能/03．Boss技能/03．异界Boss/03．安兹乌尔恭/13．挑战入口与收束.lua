...
____exports["启动安兹挑战收束"] = function(context)
    ...
    local ____opt_7 = ____opt_9 and ____opt_9["独占状态"]
    if ____opt_7 ~= nil then
        ____opt_7["取消当前"](____opt_7, "清理", "安兹挑战收束")
    end
    local cfg = _____5B89_5179_4E4C_5C14_606D_6570_503C_4E0E_8868_73B0_914D_7F6E
    ...
    _____5E7F_64AD_5355_4F4D_63D0_793A(boss, "|cffffff99试炼到此为止。雅儿贝德，收起武器。|r", 3600)
    local delayedId = addDelayedCallback(
        cfg["守护者模式"]["挑战收束离场延迟秒"] * 1000,
        function()
            local ____opt_13 = context["雅儿贝德"]
            local ____opt_11 = ____opt_13 and ____opt_13["成员生命周期"]
            if ____opt_11 ~= nil then
                ____opt_11["设置状态"](____opt_11, "雅儿贝德", "离场", "服从至尊命令")
            end
            local ____opt_17 = context["雅儿贝德"]
            local ____opt_15 = ____opt_17 and ____opt_17["成员生命周期"]
            if ____opt_15 ~= nil then
                ____opt_15["设置状态"](____opt_15, "安兹", "离场", "试炼结束")
            end
            if _____5355_4F4D_6709_6548(albedo) then
    ...
    ____self_19["登记延迟回调"](____self_19, "安兹-挑战收束离场", delayedId)
    return true
end
