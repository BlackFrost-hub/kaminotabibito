...
local function _____5E7F_64AD_5FC3_810F_638C_63E1_70B9_540D_8B66_544A(target)
    ...
    QuestMessageBJ(
        ...
        ((((("|cffff2020『任务警告』：|r|cffffcc00" .. playerName) .. "|r 被安兹乌尔恭的|cffff2020『心脏掌握』|r点名！请在 ") .. tostring(config["心脏掌握倒计时秒"])) .. " 秒内让至少1名队友进入目标 ") .. tostring(config["心脏掌握救援半径"])) .. " 码范围协助破解，否则目标将被处决。（被点名者停留原地等待队友靠近。）"
    )
end
