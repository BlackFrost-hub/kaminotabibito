...
local function _____9500_6BC1_5929_7A7A_5760_843D_9884_8B66_8868_73B0(instance)
    ...
    instance["墓碑特效列表"] = {}
    local ____self_4 = instance["安全区组"]
...
local function _____7ED3_7B97_5929_7A7A_5760_843D_5355_6B21_4F24_5BB3(damageContext, attackRatio, maxLifeRatio, tag)
    ...
    local boss = context["安兹单位"]
    local ____temp_7 = not _____5355_4F4D_6709_6548(boss) or context["挑战已结束"]
...
local function _____542F_52A8_5929_7A7A_5760_843D_7ED3_7B97(context, instance)
    ...
    do
        ...
        while i < #heroes do
            ...
            local ____5355_4F4D_6709_6548_result_11 = _____5355_4F4D_6709_6548(target)
            if ____5355_4F4D_6709_6548_result_11 then
                local ____self_10 = instance["安全区组"]
                ____5355_4F4D_6709_6548_result_11 = not ____self_10["单位是否安全"](____self_10, target)
            end
            if ____5355_4F4D_6709_6548_result_11 then
    ...
    local landingId = addDelayedCallback(
        ...
        function()
            local ____temp_13 = not _____5355_4F4D_6709_6548(boss) or context["挑战已结束"]
    ...
    ____self_14["登记延迟回调"](____self_14, "安兹-天空坠落主冲击", landingId)
    do
        local waveIndex = 1
...
____exports["释放安兹天空坠落"] = function(context)
    ...
    _____542F_52A8_57FA_7840_65BD_6CD5_65F6_95F4_7EBF({
        ...
        ["on生效"] = function()
            ...
            ____self_16["登记延迟回调"](____self_16, "安兹-天空坠落输出窗口", recoveryId)
        end
    })
    return true
end
