...
function _____7ED3_7B97_51C0_5316_6295_67AA_843D_70B9(context, x, y, tag)
    ...
    if effect ~= nil and effect ~= 0 then
        _____8BBE_7F6E_7279_6548_7F29_653E(effect, cfg["特效缩放"])
...
local function _____53D1_5C04_590F_63D0_96C5P3_51C0_5316_6295_67AA(context, x, y, _____843D_4E0B_79D2, tag)
    local boss = context["Boss单位"]
    local cfg = _____590F_63D0_96C5_6570_503C_4E0E_8868_73B0_914D_7F6E["净化投枪"]
    local _____751F_6210_89D2_5EA6 = GetRandomReal(0, 360)
    local _____66F2_7EBF_504F_79FB = GetRandomReal(-cfg["P3投枪曲线偏移最大"], cfg["P3投枪曲线偏移最大"])
    local _____751F_6210_8DDD_79BB = cfg["P3投枪生成距离"]
    local startX = x + CosBJ(_____751F_6210_89D2_5EA6) * _____751F_6210_8DDD_79BB
    local startY = y + SinBJ(_____751F_6210_89D2_5EA6) * _____751F_6210_8DDD_79BB
    local _____63A7_5236_89D2_5EA6 = _____751F_6210_89D2_5EA6 + 90
    local controlX = (startX + x) * 0.5 + CosBJ(_____63A7_5236_89D2_5EA6) * _____66F2_7EBF_504F_79FB
    ...
    local _____521D_59CB_671D_5411 = Atan2(controlY - startY, controlX - startX) * RAD_TO_DEG
    local _____5F39_5E55 = _____521B_5EFA_539F_751F_5F39_5E55({
        ["所有者"] = boss,
        ["载体模式"] = "单位",
        X = startX,
        Y = startY,
        ["方向角"] = _____521D_59CB_671D_5411,
        ["速度"] = 1,
        ["生命周期"] = _____843D_4E0B_79D2,
        ["影响目标"] = "敌方",
        ["命中半径"] = 0,
        ["不可阻挡"] = true,
        ["禁用碰撞"] = true,
        ...
        ["飞行高度"] = startZ,
        ["附加特效1"] = {
            ["模型"] = _____590F_63D0_96C5_6570_503C_4E0E_8868_73B0_914D_7F6E["表现资源"]["净化投枪特效路径"],
            ["跟随主弹幕参数"] = true,
            ["跟随轨迹俯仰"] = true,
            ["动画索引"] = 0,
            ["缩放"] = cfg["特效缩放"]
...
____exports["释放夏提雅净化投枪"] = function(context, target)
    ...
    if not isP3 then
        ...
        _____53D1_5C04_590F_63D0_96C5P3_51C0_5316_6295_67AA(
            context,
            x,
            y,
            cfg["预警秒"],
