    ...
    do
        ...
        while i < #heroes do
            ...
            if color == 1 then
                ...
                _____9020_6210_4F24_5BB3(boss, target, config["红伤害"], jass.DAMAGE_TYPE_FIRE)
            elseif color == 3 then
                ...
                _____9020_6210_4F24_5BB3(boss, target, maxLife > 0 and life / maxLife > 0.75 and config["绿高血伤害"] or config["绿低血伤害"], jass.DAMAGE_TYPE_LIGHTNING)
            else
