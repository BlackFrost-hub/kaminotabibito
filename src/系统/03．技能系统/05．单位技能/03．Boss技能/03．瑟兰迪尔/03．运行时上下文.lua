...
local ____04_FF0E_6267_6CD5_5370_8BB0 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.04．执法印记")
local _____5C1D_8BD5_89E6_53D1_745F_5170_8FEA_5C14_6267_6CD5_5370_8BB0 = ____04_FF0E_6267_6CD5_5370_8BB0["尝试触发瑟兰迪尔执法印记"]
local ____07_FF0E_79E9_5E8F_9886_57DF = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.07．秩序领域")
...
local ____08_FF0E_5BA1_5224_4E4B_73AF = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.08．审判之环")
local _____5C1D_8BD5_89E6_53D1_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF = ____08_FF0E_5BA1_5224_4E4B_73AF["尝试触发瑟兰迪尔审判之环"]
local ____11_FF0E_6708_5149_704C_6CE8 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.11．月光灌注")
...
local ____12_FF0E_7EC8_672B_5BA1_5224 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.12．终末审判")
...
____exports["获取或创建瑟兰迪尔上下文"] = function(boss)
    ...
    _____8BBE_7F6E_5355_4F4D_6280_80FD_58F3_666E_901A_63D0_793A(boss, _____745F_5170_8FEA_5C14_5355_4F4D_6280_80FD_914D_7F6E["主动技能提示"])
    return context
end
____exports["清理瑟兰迪尔上下文"] = function(boss)
    ...
    _____6E05_7406_745F_5170_8FEA_5C14_79E9_5E8F_9886_57DF(boss)
...
local function _____63A8_8FDB_745F_5170_8FEA_5C14_8FD0_884C_65F6()
    for id in pairs(_____745F_5170_8FEA_5C14_4E0A_4E0B_6587_8868) do
        do
            local context = _____745F_5170_8FEA_5C14_4E0A_4E0B_6587_8868[id]
            if context == nil then
                goto __continue17
