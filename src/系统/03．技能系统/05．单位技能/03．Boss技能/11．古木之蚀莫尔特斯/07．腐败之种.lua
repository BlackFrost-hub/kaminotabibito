...
local ____exports = {}
local _____5E7C_6811_6CE2_52A8Tick, GetUnitX, GetUnitY, UnitDamageTarget, ATTACK_TYPE_NORMAL, DAMAGE_TYPE_PLANT, WEAPON_TYPE_WHOKNOWS, removePeriodicCallback, _____83B7_53D6Boss_6280_80FD_654C_5BF9_82F1_96C4_5217_8868, _____8BFB_53D6_5355_4F4D_653B_51FB_529B
...
local function _____8D1D_585E_5C14_4F4D_7F6E(a, b, c, t)
    local u = 1 - t
    return u * u * a + 2 * u * t * b + t * t * c
end
local function _____521B_5EFA_8150_8D25_5E7C_6811(context, x, y)
    ...
    ____self_5["登记周期回调"](____self_5, "莫尔特斯-腐败幼树波动", data["周期ID"])
end
local function _____521B_5EFA_843D_5730_79CD_5B50(context, x, y)
    ...
    local id = addDelayedCallback(
        cfg["生长延迟秒"] * 1000,
        function()
            if not seed["是否存活"](seed) then
                return
            end
            seed["销毁"](seed)
            _____521B_5EFA_8150_8D25_5E7C_6811(context, x, y)
        end
    )
    local ____self_6 = context["清理"]
    ____self_6["登记延迟回调"](____self_6, "莫尔特斯-腐败种子成长", id)
end
local function _____5F39_9053Tick(data)
...
local function _____53D1_5C04_8150_8D25_4E4B_79CD(context, target)
    ...
    ____self_7["登记周期回调"](____self_7, "莫尔特斯-腐败之种弹道", data["周期ID"])
end
local function _____91CA_653E_83AB_5C14_7279_65AF_8150_8D25_4E4B_79CD(context)
    ...
    if _____5355_4F4D_6709_6548(spellTarget) then
        ...
        _____5355_4F4D_6709_6548_result_8 = _____83B7_53D6Boss_6280_80FD_968F_673A_654C_5BF9_82F1_96C4(boss)
    end
