...
local function _____91CA_653E_91CC_79D1_7279_6E6E_706D_4E4B_98CE(context)
    ...
    ____self_7["登记周期回调"](____self_7, "里科特-湮灭之风周期", data["周期ID"])
    local id = addDelayedCallback(
        cfg["持续秒"] * 1000,
        function()
            ShowUnit(boss, true)
    ...
    ____self_8["登记延迟回调"](____self_8, "里科特-湮灭之风结束", id)
end
...
____exports["注册里科特湮灭之风"] = function()
    ...
    registerSpellEffectListener(____on_91CC_79D1_7279_6E6E_706D_4E4B_98CE_65BD_6CD5)
end
return ____exports
