...
____exports["播放影骨莫特斯台词"] = function(boss, _____7C7B_578B, index)
    _____64AD_653EBoss_53F0_8BCD_5E7F_64AD(
        boss,
        _____5F71_9AA8_83AB_7279_65AF_5355_4F4D_6280_80FD_914D_7F6E["台词"],
        _____7C7B_578B,
        _____5F71_9AA8_83AB_7279_65AF_5355_4F4D_6280_80FD_914D_7F6E["广播持续时间Ms"],
        index
    )
end
return ____exports
