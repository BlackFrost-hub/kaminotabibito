...
local ____exports = {}
local _____89E3_9664_7194_6838_5C01_5370, _____53CC_62A4_536B_90FD_5DF2_6B7B_4EA1, ____on_5DF4_5C14_624E_7F57_65AF_62A4_536B_6B7B_4EA1, _____9500_6BC1_5355_4F4D_5750_6807_8DDF_968F_7279_6548, _____79FB_9664_5355_4F4D_6307_5B9ABuff, X_RestoreUnitStandingSafe, addDelayedCallback, getServerTime, GetUnitX, GetUnitY
...
function _____89E3_9664_7194_6838_5C01_5370(context)
...
function _____53CC_62A4_536B_90FD_5DF2_6B7B_4EA1(context)
    return not _____5355_4F4D_6709_6548(context["格鲁姆"]) and not _____5355_4F4D_6709_6548(context["塞拉"])
end
function ____on_5DF4_5C14_624E_7F57_65AF_62A4_536B_6B7B_4EA1(dyingUnit, _killingUnit, record)
    local ____opt_result_9
    if record ~= nil then
        ____opt_result_9 = record["主Boss单位"]
    end
    local boss = ____opt_result_9
...
_____9500_6BC1_5355_4F4D_5750_6807_8DDF_968F_7279_6548 = ____require_result_0["销毁单位坐标跟随特效"]
...
X_RestoreUnitStandingSafe = ____require_result_4.X_RestoreUnitStandingSafe
    ...
    return _____521B_5EFA_81EA_5B9A_4E49_62A4_536B_5355_4F4D(
        {
            ...
            ["标记为召唤单位"] = true,
            ["Boss结束处理"] = "移除",
            ["on死亡"] = ____on_5DF4_5C14_624E_7F57_65AF_62A4_536B_6B7B_4EA1
        },
        function()
...
local function _____6EE1_8DB3_7194_6838_5C01_5370_4F24_5BB3_6761_4EF6(context)
    if context == nil or not _____5355_4F4D_6709_6548(context.target) then
        return false
    end
    return getBuffRuntime(context.target, _____5DF4_5C14_624E_7F57_65AF_5355_4F4D_6280_80FD_914D_7F6E.BuffID["熔核封印"]) ~= nil
end
local function _____786E_4FDD_5168_5C40_76D1_542C()
    if not _____7194_6838_5C01_5370_4F24_5BB3_4FEE_6B63_5DF2_6CE8_518C then
        ...
        _____521B_5EFA_6761_4EF6_4F24_5BB3_4FEE_6B63({["名称"] = "巴尔扎罗斯熔核封印承伤修正", ["优先级"] = 40, ["条件"] = _____6EE1_8DB3_7194_6838_5C01_5370_4F24_5BB3_6761_4EF6, ["修正"] = ____on_7194_6838_5C01_5370_4F24_5BB3_4FEE_6B63})
    end
end
