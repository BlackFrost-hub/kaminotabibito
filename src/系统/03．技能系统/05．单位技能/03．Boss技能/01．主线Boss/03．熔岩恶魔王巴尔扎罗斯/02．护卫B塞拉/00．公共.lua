...
local _____505C_6B62_5FAA_73AF_70B9_7279_6548 = ____require_result_7["停止循环点特效"]
...
local addPeriodicCallback = ____require_result_10.addPeriodicCallback
local removePeriodicCallback = ____require_result_10.removePeriodicCallback
local getServerTime = ____require_result_10.getServerTime
local ____require_result_11 = require("lib.扩展函数.BJ函数.12．数学函数")
local CosBJ = ____require_result_11.CosBJ
local SinBJ = ____require_result_11.SinBJ
...
____exports["塞拉公共"] = {
    ...
    ["播放塞拉台词"] = _____64AD_653E_585E_62C9_53F0_8BCD,
