...
local function ____on_65BD_52A0_6DF1_6E0A_9B54_5492(variable)
    ...
    _____64AD_653EBoss_5750_6807_97F3_6548(
        _____6740_622E_98DF_4EBA_9B54_97F3_6548_914D_7F6E["深渊魔咒"]["生效"],
        GetUnitX(data["目标单位"]),
        GetUnitY(data["目标单位"]),
...
local function _____53D6_968F_673A_8F6C_79FB_76EE_6807(boss, cursedHero)
    ...
    local ____receiver_20 = receiver
    if ____receiver_20 == nil then
        ____receiver_20 = cursedHero
    end
    return ____receiver_20
end
