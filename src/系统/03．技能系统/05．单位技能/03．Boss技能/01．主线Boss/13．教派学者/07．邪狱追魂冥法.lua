...
local ____require_result_4 = require("系统.09．表现系统.08．吟唱条.00．常量定义")
local _____541F_5531_6761_901A_9053__5927_62DB = ____require_result_4["吟唱条通道_大招"]
...
local function _____5F00_59CB_90AA_72F1_8FFD_9B42_65BD_6CD5_8868_73B0(_____4E0A_4E0B_6587)
    ...
    _____6267_884CBoss_65BD_6CD5_65F6_95F4_7EBF({
        ...
        ["吟唱条"] = {
            ["类型"] = "大招",
            ["通道"] = _____541F_5531_6761_901A_9053__5927_62DB,
            ["颜色ID"] = _____516C_5171["读条颜色ID"],
            ["标题文本"] = _____914D_7F6E["读条标题"],
            ["提示文本"] = _____914D_7F6E["读条提示"]
        },
        ["开始回调"] = function(unit)
            _____64AD_653E_6559_6D3E_5B66_8005_53F0_8BCD(unit, "邪狱追魂冥法")
        end,
        ["延迟登记名"] = "教派学者-邪狱追魂读条关闭"
    })
end
local function _____7ED3_675F_5355_6761_90AA_72F1_9501_94FE(_____9501_94FE, _____539F_56E0)
    ...
    if _____9501_94FE["连线实例"] ~= nil then
        local ____self_9 = _____9501_94FE["连线实例"]
        ____self_9["停止"](____self_9, _____539F_56E0)
    ...
    do
        ...
        while i < #_____72B6_6001["锁链列表"] do
            do
                ...
                local ____temp_11 = not _____6559_6D3E_5B66_8005_5355_4F4D_5B58_6D3B(_____9501_94FE["目标单位"]) or _____9501_94FE["机制实例"] == nil
                if not ____temp_11 then
                    local ____self_10 = _____9501_94FE["机制实例"]
                    ____temp_11 = not ____self_10["是否存活"](____self_10)
                end
                if ____temp_11 then
...
local function _____521B_5EFA_90AA_72F1_9501_94FE(_____72B6_6001, target)
    ...
    if _____9501_94FE["机制实例"] == nil then
        _____9501_94FE["已结束"] = true
        local ____72B6_6001__9501_94FE_5217_8868_12 = _____72B6_6001["锁链列表"]
        ____72B6_6001__9501_94FE_5217_8868_12[#____72B6_6001__9501_94FE_5217_8868_12 + 1] = _____9501_94FE
        return
    end
    ...
    local ____72B6_6001__9501_94FE_5217_8868_13 = _____72B6_6001["锁链列表"]
    ____72B6_6001__9501_94FE_5217_8868_13[#____72B6_6001__9501_94FE_5217_8868_13 + 1] = _____9501_94FE
end
local function _____542F_52A8_90AA_72F1_8FFD_9B42_673A_5236(_____4E0A_4E0B_6587)
    ...
    ____self_16["登记清理"](____self_16, "教派学者-邪狱追魂清理", ____on_90AA_72F1_8FFD_9B42_6E05_7406, _____72B6_6001)
    ...
    do
        ...
        while i < #_____76EE_6807_5217_8868 do
            if _____6559_6D3E_5B66_8005_5355_4F4D_5B58_6D3B(_____76EE_6807_5217_8868[i + 1]) then
                Sound3DII_CooPlayReuse(
                    _____6559_6D3E_5B66_8005_97F3_6548_914D_7F6E["邪狱追魂冥法"]["锁链捆绑"],
                    GetUnitX(_____76EE_6807_5217_8868[i + 1]),
                    GetUnitY(_____76EE_6807_5217_8868[i + 1]),
                    0,
                    _____6559_6D3E_5B66_8005_6280_80FD_914D_7F6E["公共施法"]["音效裁断距离"]
                )
    ...
    ____self_17["登记周期回调"](____self_17, "教派学者-邪狱追魂周期", _____72B6_6001["周期回调ID"])
    ...
    ____self_18["登记延迟回调"](____self_18, "教派学者-邪狱追魂弹幕发射", _____53D1_5C04_56DE_8C03ID)
    return true
end
...
____exports["释放教派学者邪狱追魂冥法"] = function(_____4E0A_4E0B_6587)
    ...
    ____self_21["登记延迟回调"](____self_21, "教派学者-邪狱追魂显式释放", _____56DE_8C03ID)
    return true
end
