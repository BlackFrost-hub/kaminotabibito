...
local function _____5F00_59CB_6DF1_6E0A_4E4B_7262_65BD_6CD5_8868_73B0(_____4E0A_4E0B_6587)
    ...
    _____6267_884CBoss_65BD_6CD5_65F6_95F4_7EBF({
        ...
        ["开始回调"] = function(unit)
            _____64AD_653E_6559_6D3E_5B66_8005_53F0_8BCD(unit, "深渊之牢")
        end,
        ["延迟登记名"] = "教派学者-深渊之牢读条关闭"
    })
end
...
local function _____65BD_52A0_6DF1_6E0A_7262_7B3C_6697_6297(_____72B6_6001)
    ...
    local ____self_7 = _____72B6_6001["上下文"]["清理"]
    ____self_7["登记清理"](____self_7, "教派学者-深渊牢笼暗抗恢复", _____6062_590D_6DF1_6E0A_7262_7B3C_6697_6297, _____6697_6297_72B6_6001)
    ...
    ____self_8["登记周期回调"](____self_8, "教派学者-深渊牢笼暗抗Buff检查", _____6697_6297_72B6_6001["周期回调ID"])
    ...
    ____self_9["登记延迟回调"](____self_9, "教派学者-深渊牢笼暗抗到期", _____56DE_8C03ID)
end
...
local function _____542F_52A8_6DF1_6E0A_4E4B_7262_673A_5236(_____4E0A_4E0B_6587, target)
    ...
    ____self_12["登记清理"](____self_12, "教派学者-深渊之牢清理", ____on_6DF1_6E0A_4E4B_7262_6E05_7406, _____72B6_6001)
    registerManualBuff(
        target,
    ...
    ____self_13["登记周期回调"](____self_13, "教派学者-深渊之牢周期", _____72B6_6001["周期回调ID"])
    return true
end
...
____exports["释放教派学者深渊之牢"] = function(_____4E0A_4E0B_6587, target)
    ...
    ____self_16["登记延迟回调"](____self_16, "教派学者-深渊之牢测试释放", _____56DE_8C03ID)
    return true
end
