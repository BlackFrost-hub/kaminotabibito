...
local ____05_FF0E_5251_6C14_7075_65A9 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.06．菲利斯.05．剑气灵斩")
...
function _____7ED3_675F_5F02_5F62_5316(context)
    ...
    if boss ~= nil and boss ~= 0 then
        _____8BBE_7F6EBoss_8840_6761_5934_50CF(boss, cfg["常态头像路径"])
    end
    context["异形化中"] = false
    context["异形化结束Ms"] = 0
end
...
function _____542F_52A8_5F02_5F62_5316_72B6_6001(context)
    ...
    if DzSetUnitModel ~= nil then
        DzSetUnitModel(boss, cfg["异形模型路径"])
    end
    _____8BBE_7F6EBoss_8840_6761_5934_50CF(boss, cfg["异形头像路径"])
...
____exports["释放菲利斯异形化"] = function(context)
    ...
    local cfg = _____83F2_5229_65AF_6570_503C_4E0E_8868_73B0_914D_7F6E["异形化"]
    if context["当前魔法充能"] < cfg["魔法阈值"] or context["异形化中"] or context["异形化准备中"] then
        return
    end
    context["异形化准备中"] = true
...
____exports["初始化菲利斯异形化充能"] = function(context)
    context["当前魔法充能"] = 0
    context["异形化准备中"] = false
    _____66F4_65B0_9B54_6CD5_663E_793A(context)
end
