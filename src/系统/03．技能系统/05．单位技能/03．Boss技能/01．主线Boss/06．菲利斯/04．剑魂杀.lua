...
function _____521B_5EFA_8DEF_5F84(boss, target)
    ...
    do
        local i = 0
        while i < cfg["剑气数量"] do
            local side = (i == 0 and 1 or -1) * cfg["路径交叉角度"] * 0.5
            local pathAngle = targetAngle + side
            local sx = _____6781_5750_6807X(centerX, pathAngle + 180, halfDistance)
            local sy = _____6781_5750_6807Y(centerY, pathAngle + 180, halfDistance)
            paths[#paths + 1] = {
                ["起点X"] = sx,
                ["起点Y"] = sy,
...
function _____751F_6210_5251_9B42_72FC(context, x, y, big)
    ...
    local cfg = _____83F2_5229_65AF_6570_503C_4E0E_8868_73B0_914D_7F6E["剑魂杀"]
    local hitPoints = big and cfg["大狼生命点"] or cfg["小狼生命点"]
    ...
    local wolf = _____521B_5EFA_56FA_5B9A_53D7_51FB_6B21_6570_673A_5236_5355_4F4D({
        ...
        ["单位类型"] = big and cfg["大狼单位类型"] or cfg["小狼单位类型"],
        X = x,
        Y = y,
        ["最大生命"] = 999999,
        ["受击次数"] = hitPoints,
        ...
        ["on死亡"] = function(unit)
            ...
            _____6CE8_9500_53EC_5524_7269_653B_51FB_6062_590D_4E3B_4EBA(unit)
        end,
        ["on销毁"] = function(unit)
            _____6CE8_9500_83F2_5229_65AF_5251_9B42_72FC(unit)
            _____6CE8_9500_53EC_5524_7269_653B_51FB_6062_590D_4E3B_4EBA(unit)
    ...
    _____64AD_653EBoss_5750_6807_97F3_6548(big and _____83F2_5229_65AF_97F3_6548_914D_7F6E["剑魂杀"]["大狼合并"] or _____83F2_5229_65AF_97F3_6548_914D_7F6E["剑魂杀"]["小狼成形"], x, y, _____83F2_5229_65AF_97F3_6548_914D_7F6E["默认裁断距离"])
    ...
    _____767B_8BB0_53EC_5524_7269_653B_51FB_6062_590D_4E3B_4EBA({
        ["召唤单位"] = wolf["单位"],
        ["主人单位"] = boss,
        ["要求实际造成伤害"] = false,
        ...
        ["on触发"] = function(result)
            _____589E_52A0Boss_9B54_6CD5_5145_80FD(context, result["请求魔法恢复"])
        end
    })
...
function _____6267_884C_5251_9B42_8DEF_5F84(context, paths)
    ...
    _____64AD_653EBoss_5750_6807_97F3_6548(
        _____83F2_5229_65AF_97F3_6548_914D_7F6E["剑魂杀"]["路径释放"],
        GetUnitX(boss),
        GetUnitY(boss),
...
local function ____on_5251_9B42_72FC_6700_7EC8_4F24_5BB3(target, _attacker, _applied, snapshot)
    if snapshot == nil or snapshot.isNormalAttack ~= true then
        return
    end
    local wolf = snapshot.originalAttacker
    local record = _____83B7_53D6_83F2_5229_65AF_5251_9B42_72FC_8BB0_5F55(wolf)
