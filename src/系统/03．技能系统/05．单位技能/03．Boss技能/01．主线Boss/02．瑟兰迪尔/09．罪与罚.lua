            ...
            ["阶段列表"] = _____521B_5EFA_56FA_5B9A_65F6_95F4_8F74_9636_6BB5_5217_8868({
                ...
                },
                {
                    ...
                    ["执行"] = function()
                        ...
                        _____8BA9_5355_4F4D_9762_5411_76EE_6807(boss, actualTarget)
                        local maxLife = GetUnitState(actualTarget, UNIT_STATE_MAX_LIFE)
                        if ____type == 1 then
                            _____6302Buff(
                                boss,
                                actualTarget,
                        ...
                        elseif ____type == 3 then
                            ...
                            local maxMana = GetUnitState(actualTarget, UNIT_STATE_MAX_MANA)
