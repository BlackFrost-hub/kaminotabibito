...
local ____exports = {}
local _____521B_5EFA_745F_5170_8FEA_5C14_9636_6BB5_4E0A_4E0B_6587, getServerTime
...
local _____91CA_653E_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF = ____08_FF0E_5BA1_5224_4E4B_73AF["释放瑟兰迪尔审判之环"]
local _____505C_6B62_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF = ____08_FF0E_5BA1_5224_4E4B_73AF["停止瑟兰迪尔审判之环"]
local ____11_FF0E_6708_5149_704C_6CE8 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.02．瑟兰迪尔.11．月光灌注")
local _____91CA_653E_745F_5170_8FEA_5C14_6708_5149_704C_6CE8 = ____11_FF0E_6708_5149_704C_6CE8["释放瑟兰迪尔月光灌注"]
...
function _____521B_5EFA_745F_5170_8FEA_5C14_9636_6BB5_4E0A_4E0B_6587(context)
    return _____521B_5EFA_9636_6BB5_4E0A_4E0B_6587({
        ["清理"] = context["清理"],
        ["名称"] = "瑟兰迪尔",
        ["单位"] = context["Boss单位"],
        ["初始阶段ID"] = "P1",
        ["Tick间隔毫秒"] = _____745F_5170_8FEA_5C14_8FD0_884C_65F6_914D_7F6E["推进间隔毫秒"],
        ["阶段列表"] = {
            {ID = "P1"},
            {
                ID = "P2",
                ["血量百分比"] = _____745F_5170_8FEA_5C14_6570_503C_4E0E_8868_73B0_914D_7F6E["阶段阈值"]["P2生命比例"],
                ["on进入"] = function()
                    context["阶段"] = 2
                    _____64AD_653E_745F_5170_8FEA_5C14_53F0_8BCD(context["Boss单位"], "转阶段70")
                    _____91CA_653E_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF(context)
                end
            },
            {
                ID = "P3",
                ["血量百分比"] = _____745F_5170_8FEA_5C14_6570_503C_4E0E_8868_73B0_914D_7F6E["阶段阈值"]["P3生命比例"],
                ["on进入"] = function()
                    context["阶段"] = 3
                    _____64AD_653E_745F_5170_8FEA_5C14_53F0_8BCD(context["Boss单位"], "转阶段40")
                    context["普通机制忙碌到Ms"] = getServerTime() + _____745F_5170_8FEA_5C14_6570_503C_4E0E_8868_73B0_914D_7F6E["月光灌注"]["施法硬直秒"] * 1000
...
local function _____521B_5EFA_745F_5170_8FEA_5C14_4E0A_4E0B_6587(boss, _____6E05_7406)
    ...
    context["阶段上下文"] = _____521B_5EFA_745F_5170_8FEA_5C14_9636_6BB5_4E0A_4E0B_6587(context)
    _____6CE8_518CBoss_9636_6BB5_72B6_6001(
        boss,
        _____745F_5170_8FEA_5C14_6570_503C_4E0E_8868_73B0_914D_7F6E["阶段阈值"],
...
local function _____6E05_7406_745F_5170_8FEA_5C14_4E0A_4E0B_6587_673A_5236(context)
    ...
    _____505C_6B62_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF(context)
...
____exports["获取全部瑟兰迪尔上下文"] = function()
    return _____745F_5170_8FEA_5C14_4E0A_4E0B_6587_5DE5_5382["获取全部"]()
end
____exports["清理瑟兰迪尔上下文"] = function(boss)
    _____745F_5170_8FEA_5C14_4E0A_4E0B_6587_5DE5_5382["清理上下文"](boss)
end
local function _____63A8_8FDB_745F_5170_8FEA_5C14_8FD0_884C_65F6(context)
...
____exports["注册瑟兰迪尔运行时"] = function()
    ...
    _____521B_5EFA_5468_671F_673A_5236_8C03_5EA6_5668({["名称"] = "瑟兰迪尔-运行时推进", ["间隔毫秒"] = _____745F_5170_8FEA_5C14_8FD0_884C_65F6_914D_7F6E["推进间隔毫秒"], ["取上下文列表"] = _____745F_5170_8FEA_5C14_4E0A_4E0B_6587_5DE5_5382["获取全部"], ["执行"] = _____63A8_8FDB_745F_5170_8FEA_5C14_8FD0_884C_65F6})
end
return ____exports
