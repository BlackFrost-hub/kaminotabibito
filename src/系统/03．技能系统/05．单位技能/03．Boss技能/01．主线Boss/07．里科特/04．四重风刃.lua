...
function _____53D6_56DB_91CD_98CE_5203_76EE_6807(boss)
    ...
    local _____5355_4F4D_6709_6548_result_7
    if _____5355_4F4D_6709_6548(target) then
        _____5355_4F4D_6709_6548_result_7 = target
    else
        _____5355_4F4D_6709_6548_result_7 = _____83B7_53D6Boss_6280_80FD_968F_673A_654C_5BF9_82F1_96C4(boss, boss, _____91CC_79D1_7279_6570_503C_4E0E_8868_73B0_914D_7F6E["四重风刃"]["施法距离"] + 300)
    end
    return _____5355_4F4D_6709_6548_result_7
end
...
function _____53D6_9F99_5377_98CE_9636_6BB5_6539_5411_89D2_5EA6(context, _____9636_6BB5, _____4E0A_4E0B_6587)
    local cfg = _____91CC_79D1_7279_6570_503C_4E0E_8868_73B0_914D_7F6E["四重风刃"]
...
function _____53D1_5C04_5355_4E2A_9F99_5377_98CE(context, _____9636_6BB5, angle)
    ...
    _____521B_5EFA_5EF6_8FDF_6539_5411_5F39_5E55({
        ...
        ["取改向角度"] = function(_____4E0A_4E0B_6587)
            return _____53D6_9F99_5377_98CE_9636_6BB5_6539_5411_89D2_5EA6(context, _____9636_6BB5, _____4E0A_4E0B_6587)
        end
    })
end
function _____53D1_5C04_56DB_91CD_9F99_5377_98CE(context, _____9636_6BB5)
    ...
    if _____5355_4F4D_6709_6548(boss) then
        _____64AD_653EBoss_5750_6807_97F3_6548(
            _____91CC_79D1_7279_97F3_6548_914D_7F6E["四重风刃"]["四龙卷发射"],
            GetUnitX(boss),
            GetUnitY(boss),
...
____exports["释放里科特四重风刃"] = function(context)
    ...
    _____542F_52A8_57FA_7840_65BD_6CD5_65F6_95F4_7EBF({
        ...
        ["on生效"] = function()
            _____64AD_653EBoss_5750_6807_97F3_6548(
                _____91CC_79D1_7279_97F3_6548_914D_7F6E["四重风刃"]["跳劈身法掠风"],
                GetUnitX(boss),
                GetUnitY(boss),
                _____91CC_79D1_7279_97F3_6548_914D_7F6E["默认裁断距离"]
            )
            ...
            ____self_8["登记延迟回调"](____self_8, "里科特-四重龙卷风", id)
        end
    })
end
...
_____65BD_52A0_5FEB_901F_51CF_901FBuff = ____require_result_4["施加快速减速Buff"]
...
addDelayedCallback = ____require_result_6.addDelayedCallback
