...
local function _____5F00_59CB_6E6E_706D_6295_5F71_70AE_51FB(data)
    ...
    local ____self_9 = data.context["清理"]
    ____self_9["登记周期回调"](____self_9, "里科特-湮灭之炮周期", data["周期ID"])
end
...
local function _____8C03_5EA6P3_7729_6655_70AE(context)
    ...
    ____self_12["登记延迟回调"](____self_12, "里科特-P3湮灭眩晕炮", id)
end
____exports["释放里科特湮灭之炮"] = function(context)
    ...
    local cfg = _____91CC_79D1_7279_6570_503C_4E0E_8868_73B0_914D_7F6E["湮灭之炮"]
    local castDuration = _____5237_65B0_91CC_79D1_7279_9636_6BB5(context) >= 2 and cfg["P2锁定前延迟秒"] or cfg["锁定前延迟秒"]
