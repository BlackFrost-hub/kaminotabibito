...
local _____64AD_653EBoss_5750_6807_97F3_6548_7F16_6392 = ____00_FF0EBoss_97F3_6548_64AD_653E["播放Boss坐标音效编排"]
...
____exports["释放树魔首领远古诅咒"] = function(context)
    ...
    _____64AD_653EBoss_5750_6807_97F3_6548_7F16_6392({
        ["默认裁断距离"] = _____6811_9B54_9996_9886_97F3_6548_914D_7F6E["默认裁断距离"],
        ["模式"] = "同步延迟",
        ["音效列表"] = {
            {
                ["音效路径"] = _____6811_9B54_9996_9886_97F3_6548_914D_7F6E["远古诅咒"]["点名Boss"],
                X = GetUnitX(boss),
                Y = GetUnitY(boss)
            },
            {
                ["音效路径"] = _____6811_9B54_9996_9886_97F3_6548_914D_7F6E["远古诅咒"]["点名分摊圈"],
                X = GetUnitX(target),
                Y = GetUnitY(target),
                ["延迟Ms"] = _____6811_9B54_9996_9886_97F3_6548_914D_7F6E["远古诅咒"]["点名分摊圈延迟Ms"]
            }
        }
    })
