...
local _____5361_745F_62C9_4E0A_4E0B_6587_8868 = {}
...
____exports["获取卡瑟拉上下文"] = function(boss)
    ...
    if id == 0 then
        ...
        ____temp_2 = _____5361_745F_62C9_4E0A_4E0B_6587_8868[id]
    end
    return ____temp_2
end
____exports["获取或创建卡瑟拉上下文"] = function(boss)
    ...
    local context = _____5361_745F_62C9_4E0A_4E0B_6587_8868[id]
    if context ~= nil then
        return context
    end
    context = {
        ...
        ["已初始化"] = false,
        ["清理"] = _____521B_5EFA_673A_5236_6E05_7406_7BEE_5B50("卡瑟拉"),
        ["触手残片数量"] = 0,
        ["玩家触手残片表"] = {},
        ["玩家触手残片单位表"] = {},
        ["场上触手残片列表"] = {},
    ...
    _____8BBE_7F6E_5355_4F4D_6280_80FD_58F3_666E_901A_63D0_793A(boss, _____5361_745F_62C9_5355_4F4D_6280_80FD_914D_7F6E["主动技能提示"])
    _____5361_745F_62C9_4E0A_4E0B_6587_8868[id] = context
    return context
end
____exports["获取全部卡瑟拉上下文"] = function()
    local result = {}
    for key in pairs(_____5361_745F_62C9_4E0A_4E0B_6587_8868) do
        local context = _____5361_745F_62C9_4E0A_4E0B_6587_8868[key]
        if context ~= nil then
...
____exports["清理卡瑟拉上下文"] = function(boss)
    ...
    __TS__Delete(_____5361_745F_62C9_4E0A_4E0B_6587_8868, id)
end
