...
____exports["巴尔扎罗斯单位技能配置"] = {
    ...
    ["单位名"] = "熔岩恶魔王·巴尔扎罗斯",
    ["Boss单位ID"] = "N03G",
    ["护卫"] = {["格鲁姆"] = {["名称"] = "熔岩破坏者·格鲁姆", ["模型路径"] = "Boss\\Balzaroth\\Grum\\Grum.mdx", ["图标路径"] = "Boss\\Balzaroth\\Grum\\Grum.blp"}, ["塞拉"] = {["名称"] = "冰焰巫师·塞拉", ["模型路径"] = "Boss\\Balzaroth\\Sera\\Sera.mdx", ["图标路径"] = "Boss\\Balzaroth\\Sera\\Sera.blp"}},
