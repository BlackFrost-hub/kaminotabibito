...
____exports["注册巴尔扎罗斯恶魔咆哮波"] = function()
    ...
    registerSpellEffectListener(____on_5DF4_5C14_624E_7F57_65AF_6076_9B54_5486_54EE_6CE2_751F_6548)
end
return ____exports
