...
local _____70B9_5230_7EBF_6BB5_8DDD_79BB_5E73_65B9 = ____require_result_6["点到线段距离平方"]
...
local ____E_6682_505C_6765_6E90 = "逆回十六夜E技能"
...
local function _____51C6_5907_9006_56DE_5341_516D_591CE_76EE_6807_4F24_5BB3(target, _index, variable)
    ...
    if _____70B9_5230_7EBF_6BB5_8DDD_79BB_5E73_65B9(
        ...
        _____53D8_91CF["终点X"],
        _____53D8_91CF["终点Y"]
    ) > _____53D8_91CF["路径命中半径平方"] then
        return nil
    end
    return {}
end
local function _____5904_7406_9006_56DE_5341_516D_591CE_76EE_6807_7ED3_7B97_540E(target, _index, ______6210_529F, variable)
    local _____53D8_91CF = variable
    if _____53D8_91CF == nil then
        return
    end
    ...
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____53D8_91CF["配置"]["命中特效"],
        X = GetUnitX(target),
        Y = GetUnitY(target),
        ["持续秒"] = 1
    })
    _____5F00_59CB_51FB_9000(target, {
        ["角度"] = _____53D8_91CF["角度"],
        ["距离"] = _____53D8_91CF["配置"]["击退距离"],
        ["持续时间"] = _____53D8_91CF["配置"]["击退持续秒"],
...
local function _____91CA_653E_8DF3_8DC3_4E00_8E22(_context, unit, _____6280_80FD_5B9E_4F8BID)
    ...
    _____6DFB_52A0_5355_4F4D_6682_505C(unit, ____E_6682_505C_6765_6E90)
    ...
    local function ____on_8DF3_8DC3_4E00_8E22_7ED3_675F(caster, reason)
        ...
        _____79FB_9664_5355_4F4D_6682_505C(caster, ____E_6682_505C_6765_6E90)
        ...
        _____9020_6210_6279_91CFAOE_6280_80FD_4F24_5BB3({
            ...
            ["参与技能伤害加成"] = true,
            ["标签"] = "逆回十六夜-跳跃一踢",
            ["每目标处理器"] = _____51C6_5907_9006_56DE_5341_516D_591CE_76EE_6807_4F24_5BB3,
            ["每目标结算后处理器"] = _____5904_7406_9006_56DE_5341_516D_591CE_76EE_6807_7ED3_7B97_540E,
            ["变量"] = {
                ["施法者"] = caster,
                ["起点X"] = startX,
                ["起点Y"] = startY,
