...
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.04．英雄技能.22．朱雀院椿.02．被动效果")
local _____662F_6731_96C0_9662_693F = ____require_result_9["是朱雀院椿"]
local _____6D88_8D39_53CD_51FB_51C6_5907 = ____require_result_9["消费反击准备"]
local _____6062_590DVF = ____require_result_9["恢复VF"]
local _____6263_9664VF = ____require_result_9["扣除VF"]
local _____83B7_53D6_59FF_6001 = ____require_result_9["获取姿态"]
local _____8BBE_7F6E_51B3_6597_8DDD_79BB = ____require_result_9["设置决斗距离"]
local _____767B_8BB0_693F_6E05_7406 = ____require_result_9["登记椿清理"]
local _____64AD_653E_693F_52A8_4F5C = ____require_result_9["播放椿动作"]
...
local function _____7ED3_7B97E_7EC8_70B9_6A2A_65A9(_____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID, _____6570_636E)
    ...
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["E终点主斩"],
        X = _____6570_636E["终点X"],
        Y = _____6570_636E["终点Y"],
        Z = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E终点主斩"]["高度"],
        ["面向角度"] = _____6570_636E["方向角"],
        ["动画索引"] = 0,
        ["缩放"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E终点主斩"]["缩放"],
        ["持续秒"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E终点主斩"]["持续秒"]
    })
    ...
    if _____83B7_53D6_59FF_6001(_____65BD_6CD5_8005) == "一刀" then
        ...
        _____6263_9664VF(_____65BD_6CD5_8005, ____E_914D_7F6E["二刀VF代价"])
        do
            local i = 0
            while i < #_____654C_4EBA do
                _____9020_6210_6280_80FD_4F24_5BB3({
...
local function _____91CA_653EE_95F4_5408(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    _____6570_636E["位移ID"] = _____5F00_59CB_51B2_950B(
        _____65BD_6CD5_8005,
        {
            ...
            ["朝向跟随位移"] = true,
            ["暂停单位"] = true,
            ["位移特效"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["E冲锋主层"][1],
            ["附加位移特效"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["E冲锋主层"][2],
            ["位移特效缩放"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["缩放"],
            ["位移特效高度"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["高度"],
            ["位移特效持续秒"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["持续秒"],
            ["附加位移特效缩放"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["缩放"],
            ["附加位移特效高度"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["高度"],
            ["附加位移特效持续秒"] = _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["参数"]["E冲锋主层"]["持续秒"],
