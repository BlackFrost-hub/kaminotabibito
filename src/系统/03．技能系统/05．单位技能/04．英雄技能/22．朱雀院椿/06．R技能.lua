...
local _____9501_5B9A_59FF_6001 = ____require_result_10["锁定姿态"]
local _____6062_590DVF = ____require_result_10["恢复VF"]
local _____6263_9664VF = ____require_result_10["扣除VF"]
    ...
    local _____5145_80FDID = _____5F00_59CB_5145_80FD(
        _____65BD_6CD5_8005,
        {
            ...
            ["开始回调"] = function(______5355_4F4D, ______5145_80FDID)
                ...
                if _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["R蓄力提示"]["模型路径"] ~= nil and _____6731_96C0_9662_693F_8868_73B0_914D_7F6E["R蓄力提示"]["模型路径"] ~= "" then
