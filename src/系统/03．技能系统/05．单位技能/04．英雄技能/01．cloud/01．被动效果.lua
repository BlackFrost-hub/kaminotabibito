...
local function ____cloud_66B4_51FB_540E_5904_7406(record, applied, _snapshot)
    ...
    _____64AD_653E_9650_65F6_5355_4F4D_52A8_753B({
        ["单位"] = record.attacker,
        ["动画编号"] = ____cloud_5355_4F4D_6280_80FD_914D_7F6E["动作序号"],
        ["持续秒"] = ____cloud_5355_4F4D_6280_80FD_914D_7F6E["硬直毫秒"] * 0.001,
        ["动画速度"] = ____cloud_5355_4F4D_6280_80FD_914D_7F6E["动作时间流速"],
        ["恢复动画"] = false
    })
