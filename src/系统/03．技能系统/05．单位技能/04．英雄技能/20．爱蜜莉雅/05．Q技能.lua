    ...
    do
        ...
        while i < _____6570_91CF do
            ...
            _____53D1_5C04_5F39_9053({
                ...
                ["缩放"] = _____7231_871C_8389_96C5Q_914D_7F6E["表现"]["分裂冰刃"]["缩放"]
            })
            i = i + 1
        end
    end
...
local function _____91CA_653EQ_51B0_4E4B_77E2(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    _____5F39_9053 = _____53D1_5C04_5F39_9053({
        ...
        ["参与技能伤害加成"] = true,
        ["模型"] = _____7231_871C_8389_96C5Q_914D_7F6E["弹道模型"],
        ["缩放"] = _____7231_871C_8389_96C5Q_914D_7F6E["表现"]["主冰矢"]["缩放"],
        ...
        onTick = function(_____5B9E_4F8B, _delta)
            ...
            _____521B_5EFA_70B9_7279_6548({
                ...
                X = _____5750_6807.X,
                Y = _____5750_6807.Y,
                Z = _____7231_871C_8389_96C5Q_914D_7F6E["表现"]["命中冰爆"]["高度"],
                ["缩放"] = _____7231_871C_8389_96C5Q_914D_7F6E["表现"]["命中冰爆"]["缩放"],
                ["持续秒"] = _____7231_871C_8389_96C5Q_914D_7F6E["表现"]["命中冰爆"]["持续秒"]
            })
            ...
            local ____53D1_5C04Q_5E15_514B_51B0_5F39_10 = _____53D1_5C04Q_5E15_514B_51B0_5F39
            local ____65BD_6CD5_8005_8 = _____65BD_6CD5_8005
            local ____6280_80FD_5B9E_4F8BID_9 = _____6280_80FD_5B9E_4F8BID
            local ____5B9E_4F8B__5F53_524D_65B9_5411_89D2_7 = _____5B9E_4F8B["当前方向角"]
            if ____5B9E_4F8B__5F53_524D_65B9_5411_89D2_7 == nil then
                ____5B9E_4F8B__5F53_524D_65B9_5411_89D2_7 = _____57FA_7840_65B9_5411
            end
            ____53D1_5C04Q_5E15_514B_51B0_5F39_10(____65BD_6CD5_8005_8, _____76EE_6807_5355_4F4D, ____6280_80FD_5B9E_4F8BID_9, ____5B9E_4F8B__5F53_524D_65B9_5411_89D2_7)
        end,
