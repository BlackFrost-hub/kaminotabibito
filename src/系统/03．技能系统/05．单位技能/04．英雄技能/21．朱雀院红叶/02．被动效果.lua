...
____exports["目标带有破绽"] = function(_____76EE_6807)
    if _____76EE_6807 == nil or _____76EE_6807 == 0 then
        return false
    end
    local _____72B6_6001 = _____7834_7EFD_76EE_6807_8868[GetHandleId(_____76EE_6807)]
    if _____72B6_6001 == nil then
        return false
    end
    return getGameTime() < _____72B6_6001["到期时间"]
end
...
local function _____5904_7406_7EA2_53F6_666E_653B_7834_7EFD_65A9(target, attacker, applied, snapshot)
    ...
    local _____7834_7EFD_65A9_6A21_578B_8DEF_5F84 = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["破绽斩"]["模型路径"]
    if _____7834_7EFD_65A9_6A21_578B_8DEF_5F84 ~= "" then
        _____521B_5EFA_70B9_7279_6548({
            ["模型路径"] = _____7834_7EFD_65A9_6A21_578B_8DEF_5F84,
...
____exports["播放红叶动作"] = function(_____82F1_96C4, _____69FD)
    ...
    local _____64AD_653E_901F_5EA6 = _____69FD["播放速度"] or 1
