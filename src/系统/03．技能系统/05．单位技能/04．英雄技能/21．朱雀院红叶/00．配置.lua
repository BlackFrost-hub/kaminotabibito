...
____exports["朱雀院红叶表现配置"] = {["破绽标记"] = "Common\\Effect\\Form\\Marker\\MomijiWeakPointBlade3D.mdx", ["刀势层数"] = {"Common\\Effect\\Form\\Rotate\\MomijiVigorOrbit1.mdx", "Common\\Effect\\Form\\Rotate\\MomijiVigorOrbit2.mdx", "Common\\Effect\\Form\\Rotate\\MomijiVigorOrbit3.mdx"}, ["水镜主体"] = "Common\\Effect\\Form\\Shield\\MomijiWaterMirrorV5.mdx"}
