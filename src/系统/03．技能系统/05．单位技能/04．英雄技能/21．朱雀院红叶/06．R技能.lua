...
local _____65BD_52A0_6731_96C0_9662_7834_7EFD = ____require_result_7["施加朱雀院破绽"]
local _____6D88_8D39_5168_90E8_5200_52BF = ____require_result_7["消费全部刀势"]
...
local ____require_result_8 = require("系统.03．技能系统.05．单位技能.04．英雄技能.21．朱雀院红叶.05．E技能")
local _____8BFB_53D6_6700_8FD1_5251_75D5_5E76_9501_5B9A = ____require_result_8["读取最近剑痕并锁定"]
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.04．英雄技能.21．朱雀院红叶.07．D技能")
local _____6D88_8D39_5168_90E8D_5F3A_5316 = ____require_result_9["消费全部D强化"]
local _____7ED3_675FD_79D8_4F20 = ____require_result_9["结束D秘传"]
...
local function ____R_521B_5EFA_7EC8_5F0F(_____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID, ______76EE_6807X, _____76EE_6807Y, _____65B9_5411_89D2)
    ...
    if ____R_914D_7F6E["主斩特效"] ~= nil and ____R_914D_7F6E["主斩特效"] ~= "" then
        _____521B_5EFA_70B9_7279_6548({
            ["模型路径"] = ____R_914D_7F6E["主斩特效"],
            X = GetUnitX(_____65BD_6CD5_8005),
            Y = GetUnitY(_____65BD_6CD5_8005),
            Z = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R主斩"]["高度"],
            ["缩放"] = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R主斩"]["缩放"],
            ["持续秒"] = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R主斩"]["持续秒"]
        })
    end
    do
        local _____5C42 = 0
            ...
            ["开始回调"] = function(______5355_4F4D, ______5145_80FDID)
                if ____R_914D_7F6E["蓄力提示特效"] ~= nil and ____R_914D_7F6E["蓄力提示特效"] ~= "" then
                    _____9884_8B66_7279_6548 = _____521B_5EFA_70B9_7279_6548({
                        ...
                        X = _____4E2D_5FC3X,
                        Y = _____4E2D_5FC3Y,
                        Z = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R蓄力提示"]["高度"],
                        ["缩放"] = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R蓄力提示"]["缩放"],
                        ["持续秒"] = _____6731_96C0_9662_7EA2_53F6_8868_73B0_914D_7F6E["参数"]["R蓄力提示"]["持续秒"]
                    })
                end
            end,
