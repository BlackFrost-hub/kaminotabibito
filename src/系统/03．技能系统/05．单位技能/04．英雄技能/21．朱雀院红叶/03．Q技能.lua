...
local ____require_result_11 = require("系统.03．技能系统.05．单位技能.04．英雄技能.21．朱雀院红叶.02．被动效果")
local _____65BD_52A0_6731_96C0_9662_7834_7EFD = ____require_result_11["施加朱雀院破绽"]
local _____5C1D_8BD5_6D88_8D39_4E00_5C42_5200_52BF = ____require_result_11["尝试消费一层刀势"]
local _____662F_6731_96C0_9662_7EA2_53F6 = ____require_result_11["是朱雀院红叶"]
local _____767B_8BB0_6731_96C0_9662_6E05_7406 = ____require_result_11["登记朱雀院清理"]
local _____64AD_653E_7EA2_53F6_52A8_4F5C = ____require_result_11["播放红叶动作"]
...
local function _____6267_884CQ2_56DE_8EAB_65A9(_____65BD_6CD5_8005, _____63A7_5236_5668, _____6280_80FD_5B9E_4F8BID, _____6570_636E)
    ...
    if not _____6570_636E["剑痕已读取"] then
        ...
        if _____8054_52A8E["读取最近剑痕并锁定"] ~= nil then
            ____temp_12 = _____8054_52A8E["读取最近剑痕并锁定"](_____65BD_6CD5_8005)
        else
            ____temp_12 = nil
        end
        local _____5251_75D5 = ____temp_12
