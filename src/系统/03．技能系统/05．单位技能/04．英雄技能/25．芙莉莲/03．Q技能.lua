...
local _____5FEB_7167_9690_533F = ____require_result_9["快照隐匿"]
local _____65BD_52A0_89E3_6790 = ____require_result_9["施加解析"]
local _____6709_89E3_6790 = ____require_result_9["有解析"]
local _____76EE_6807_89E3_6790_5B8C_6210 = ____require_result_9["目标解析完成"]
local _____5C1D_8BD5_6D88_8D39_89E3_6790_5B8C_6210 = ____require_result_9["尝试消费解析完成"]
local _____63D0_4F9B_6F14_7B97_666E_653B = ____require_result_9["提供演算普攻"]
...
local function _____7ED3_7B97Q_547D_4E2D(_____65BD_6CD5_8005, _____76EE_6807, _____6280_80FD_5B9E_4F8BID, _____9690_533F_5F3A_5316)
    ...
    if _____76EE_6807_89E3_6790_5B8C_6210(_____65BD_6CD5_8005, _____76EE_6807) then
        if _____5C1D_8BD5_6D88_8D39_89E3_6790_5B8C_6210(_____65BD_6CD5_8005, _____76EE_6807) then
            ...
            _____521B_5EFA_70B9_7279_6548({
                ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["解析完成"],
                X = GetUnitX(_____76EE_6807),
                Y = GetUnitY(_____76EE_6807),
                Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["解析完成"]["高度"],
                ["面向角度"] = 0,
                ["动画索引"] = 0,
                ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["解析完成"]["缩放"],
                ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["解析完成"]["持续秒"]
            })
        end
    ...
    _____521B_5EFA_70B9_7279_6548({
        ...
        X = GetUnitX(_____76EE_6807),
        Y = GetUnitY(_____76EE_6807),
        Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["Q命中反馈"]["高度"],
        ["面向角度"] = 0,
        ["动画索引"] = 0,
        ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["Q命中反馈"]["缩放"],
        ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["Q命中反馈"]["持续秒"]
    })
    ...
    local _____53D1_5C04ID = addDelayedCallback(
        ...
        function()
            ...
            _____53D1_5C04_5F39_9053({
                ...
                ["技能实例ID"] = _____6280_80FD_5B9E_4F8BID,
                ["技能标签"] = "芙莉莲-QZoltraak",
                ["模型"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["Q弹道"],
                ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["Q弹道"]["缩放"],
                ["飞行高度"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["Q弹道"]["高度"],
...
local ____require_result_10 = require("系统.03．技能系统.05．单位技能.04．英雄技能.25．芙莉莲.00．配置")
_____8299_8389_83B2D_6570_503C_5F15_7528 = ____require_result_10["芙莉莲D配置"]
