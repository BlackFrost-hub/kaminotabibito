...
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.04．英雄技能.25．芙莉莲.01A．动作表现")
local _____64AD_653E_9650_65F6_52A8_4F5C = ____require_result_9["播放限时动作"]
local _____5F00_59CB_5FAA_73AF_5B88_62A4 = ____require_result_9["开始循环守护"]
local _____505C_6B62_5FAA_73AF_5B88_62A4 = ____require_result_9["停止循环守护"]
local _____8299_8389_83B2_52A8_4F5C_69FD = ____require_result_9["芙莉莲动作槽"]
...
local _____65BD_52A0_89E3_6790 = ____require_result_10["施加解析"]
local _____63D0_4F9B_6F14_7B97_666E_653B = ____require_result_10["提供演算普攻"]
local _____767B_8BB0_8299_8389_83B2_6E05_7406 = ____require_result_10["登记芙莉莲清理"]
local _____82B1_7530_8054_52A8 = require("系统.03．技能系统.05．单位技能.04．英雄技能.25．芙莉莲.07．D技能")
local ____require_result_11 = require("系统.03．技能系统.05．单位技能.04．英雄技能.25．芙莉莲.00．配置")
local _____8299_8389_83B2D_914D_7F6E = ____require_result_11["芙莉莲D配置"]
...
local function _____7ED3_7B97E_843D_70B9(_____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID, _____6570_636E)
    ...
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["E观察落点"],
        X = _____6570_636E["终点X"],
        Y = _____6570_636E["终点Y"],
        Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E观察落点"]["高度"],
        ["面向角度"] = 0,
        ["动画索引"] = 0,
        ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E观察落点"]["缩放"],
        ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E观察落点"]["持续秒"]
    })
...
local function _____91CA_653EE(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    local _____82B1_7530_4FEE_6B63 = ____temp_12
    ...
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["E起落风压"],
        X = _____8D77_70B9X,
        Y = _____8D77_70B9Y,
        Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["高度"],
        ["面向角度"] = _____6570_636E["方向角"],
        ["动画索引"] = 0,
        ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["缩放"],
        ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["持续秒"]
    })
    ...
    local _____8D77_70B9_504F_79FB = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E闪电"]["起点高度偏移"]
    local _____7EC8_70B9_9AD8_5EA6 = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E闪电"]["终点高度"]
            ...
            if #_____6570_636E["观察闪电列表"] < 5 then
                ...
                while true do
                    do
                        ...
                        local ____6570_636E__89C2_5BDF_95EA_7535_5217_8868_13 = _____6570_636E["观察闪电列表"]
                        ____6570_636E__89C2_5BDF_95EA_7535_5217_8868_13[#____6570_636E__89C2_5BDF_95EA_7535_5217_8868_13 + 1] = {["目标"] = u, ["句柄"] = _____53E5_67C4}
                        _____65BD_52A0_89E3_6790(_____65BD_6CD5_8005, u, "位置")
                        if #_____6570_636E["观察闪电列表"] >= 5 then
                            break
                        end
    ...
    _____6570_636E["位移ID"] = _____5F00_59CB_51B2_950B(
        _____65BD_6CD5_8005,
        {
            ...
            ["朝向跟随位移"] = true,
            ["暂停单位"] = false,
            ["位移特效"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["E起落风压"],
            ["位移特效缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["缩放"],
            ["位移特效高度"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["高度"],
            ["位移特效持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["特效参数"]["E起落风压"]["持续秒"],
