...
local ____require_result_6 = require("系统.03．技能系统.00．技能模板+函数.01．技能函数.06．施法·蓄力·充能.充能系统")
local _____5F00_59CB_5145_80FD = ____require_result_6["开始充能"]
...
local _____8DDD_79BB_5E73_65B9XY = ____require_result_8["距离平方XY"]
...
local ____require_result_10 = require("系统.03．技能系统.05．单位技能.04．英雄技能.25．芙莉莲.02．被动效果")
local _____662F_8299_8389_83B2 = ____require_result_10["是芙莉莲"]
local _____8BB0_5F55_8299_8389_83B2_6D3B_52A8 = ____require_result_10["记录芙莉莲活动"]
local _____5FEB_7167_9690_533F = ____require_result_10["快照隐匿"]
local _____6709_89E3_6790 = ____require_result_10["有解析"]
...
local function ____R_7ED3_7B97_4E3B_70AE(_____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID, _____5FEB_7167)
    ...
    __TS__ArraySort(
        ...
        function(____, a, b) return a["投影"] - b["投影"] end
    )
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"]["模型路径"],
        X = _____65BD_6CD5_8005X,
        Y = _____65BD_6CD5_8005Y,
        Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"]["高度"],
        ["面向角度"] = _____5FEB_7167["方向角"],
        ["动画索引"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"]["动画索引"],
        ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"]["缩放"],
        ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"]["持续秒"],
        RGB = _____8299_8389_83B2_8868_73B0_914D_7F6E["R主炮"].RGB
    })
    do
        local i = 0
        while i < #_____547D_4E2D_5217_8868 do
            ...
            if _____5FEB_7167["解析完成"] and _____5FEB_7167["解析目标"] == _____76EE_6807 then
                if _____5C1D_8BD5_6D88_8D39_89E3_6790_5B8C_6210(_____65BD_6CD5_8005, _____76EE_6807) then
                    ...
                    _____521B_5EFA_70B9_7279_6548({
                        ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["模型路径"],
                        X = GetUnitX(_____76EE_6807),
                        Y = GetUnitY(_____76EE_6807),
                        Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["高度"],
                        ["面向角度"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["面向角度"],
                        ["动画索引"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["动画索引"],
                        ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["缩放"],
                        ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"]["持续秒"],
                        RGB = _____8299_8389_83B2_8868_73B0_914D_7F6E["R破防爆发"].RGB
                    })
            ...
            _____521B_5EFA_70B9_7279_6548({
                ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["模型路径"],
                X = GetUnitX(_____76EE_6807),
                Y = GetUnitY(_____76EE_6807),
                Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["高度"],
                ["面向角度"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["面向角度"],
                ["动画索引"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["动画索引"],
                ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["缩放"],
                ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"]["持续秒"],
                RGB = _____8299_8389_83B2_8868_73B0_914D_7F6E["R命中反馈"].RGB
            })
            i = i + 1
        end
    end
...
local function _____91CA_653ER(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    _____5145_80FDID = _____5F00_59CB_5145_80FD(
        _____65BD_6CD5_8005,
        {
            ...
            ["开始回调"] = function(______5355_4F4D, ______5145_80FDID)
                Sound3DII_UnitPlayReuse(_____8299_8389_83B2_97F3_6548_914D_7F6E["R蓄力"]["路径"], _____65BD_6CD5_8005, _____8299_8389_83B2_97F3_6548_914D_7F6E["R蓄力"]["裁断距离"])
                _____9884_8B66_53E5_67C4 = _____521B_5EFA_70B9_7279_6548({
                    ["模型路径"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"]["模型路径"],
                    X = GetUnitX(_____65BD_6CD5_8005),
                    Y = GetUnitY(_____65BD_6CD5_8005),
                    Z = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"]["高度"],
                    ["面向角度"] = _____5FEB_7167["方向角"],
                    ["动画索引"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"]["动画索引"],
                    ["缩放"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"]["缩放"],
                    ["持续秒"] = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"]["持续秒"],
                    RGB = _____8299_8389_83B2_8868_73B0_914D_7F6E["R蓄力预警"].RGB
                })
            end,
            ["充能完成回调"] = function(______5355_4F4D, ______5145_80FDID)
                ...
                Sound3DII_CooPlayReuse(
                    _____8299_8389_83B2_97F3_6548_914D_7F6E["R主炮"]["路径"],
                    GetUnitX(_____65BD_6CD5_8005),
                    GetUnitY(_____65BD_6CD5_8005),
                    _____8299_8389_83B2_97F3_6548_914D_7F6E["R主炮"]["高度"],
                    _____8299_8389_83B2_97F3_6548_914D_7F6E["R主炮"]["裁断距离"]
                )
    ...
    if _____5145_80FDID > 0 then
        _____64AD_653E_82F1_96C4_6280_80FD_558A_8BDD(_____65BD_6CD5_8005, "芙莉莲", _____8299_8389_83B2_6280_80FD_914D_7F6E.R["技能ID"])
    end
end
