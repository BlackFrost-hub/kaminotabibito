...
local ____exports = {}
local _____53D6_5355_4F4D_53E5_67C4ID, _____6E05_7406R2_4E0A_4E0B_6587, _____6E05_7406R2_5230_671F, removeDelayedCallback, removePeriodicCallback, GetHandleId, _____4E0A_4E0B_6587_8868
...
local function _____91CA_653ER2_6280_80FD(context, caster, _____6280_80FD_5B9E_4F8BID)
    ...
    local _____6D88_8017 = GetUnitState(caster, UNIT_STATE_MAX_MANA) * _____914D_7F6E["魔耗检查"]["最大魔法比例"] + _____914D_7F6E["魔耗检查"]["固定加值"]
    if _____5F53_524D_9B54_6CD5 < _____6D88_8017 then
        return
    end
    context["已启动"] = true
    ...
    Sound3DII_UnitPlayReuse(_____914D_7F6E["音效"]["路径"], caster, _____914D_7F6E["音效"]["裁断距离"])
