...
local ____exports = {}
local _____7ED3_7B97_6697_62BD_53D6_6062_590D, _____63A8_8FDB_6697_62BD_53D6_5F39_9053, removePeriodicCallback, doHeal, _____5355_4F4D_5B58_6D3B, _____9500_6BC1_70B9_7279_6548, GetUnitX, GetUnitY, Cos, Sin, EXSetEffectXY, _____89D2_5EA6_8F6C_5F27_5EA6
...
function _____7ED3_7B97_6697_62BD_53D6_6062_590D(_____65BD_6CD5_8005, _____62BD_53D6_503CHP, _____62BD_53D6_503CMP)
...
function _____63A8_8FDB_6697_62BD_53D6_5F39_9053(variable)
    local ctx = variable
    if ctx == nil or ctx["回调ID"] == 0 then
        return
    end
    local cfg = _____963F_4F26_52B3_7279_5355_4F4D_6280_80FD_914D_7F6E.Q
    ...
    ctx["当前X"] = ctx["当前X"] + Cos(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗抽取弹道每tick距离"]
    ctx["当前Y"] = ctx["当前Y"] + Sin(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗抽取弹道每tick距离"]
...
_____89D2_5EA6_8F6C_5F27_5EA6 = 0.0174532925199433
local function _____79D2_8F6C_6BEB_79D2(_____79D2)
    return R2I(_____79D2 * 1000 + 0.5)
end
...
local function _____5F00_59CB_6697_62BD_53D6(_____65BD_6CD5_8005, _____76EE_6807_5355_4F4D, _____76EE_6807X, _____76EE_6807Y)
    ...
    _____4E0A_4E0B_6587["回调ID"] = addPeriodicCallback(20, _____63A8_8FDB_6697_62BD_53D6_5F39_9053, _____4E0A_4E0B_6587)
end
local function _____6697_53CB_519B_52A0_653B_5230_671F(variable)
    local ctx = variable
    if ctx == nil or ctx["目标"] == nil or ctx["目标"] == 0 then
        return
    end
    _____4E34_65F6_8C03_6574_653B_51FB(ctx["目标"], -ctx["加攻值"])
    _____79FB_9664_5355_4F4D_6307_5B9ABuff(ctx["目标"], _____963F_4F26_52B3_7279BuffID["裁决制裁"])
end
            ...
            do
                ...
                if IsUnitEnemy(_____76EE_6807, _____65BD_6CD5_8005_73A9_5BB6) == true then
                    ...
                    if _____52A0_653B_503C > 0 then
                        ...
                        addDelayedCallback(
                            _____79D2_8F6C_6BEB_79D2(cfg["暗友军加攻持续秒"]),
                            _____6697_53CB_519B_52A0_653B_5230_671F,
                            {["目标"] = _____76EE_6807, ["加攻值"] = _____52A0_653B_503C}
                        )
                    end
