...
local createTimedUnitEffect = ____require_result_13.createTimedUnitEffect
...
local SetUnitManaPercentBJ = jass.SetUnitManaPercentBJ
...
local function _____83B7_53D6R_6280_80FD_4E0A_4E0B_6587(unit)
    ...
    if unitId == 0 then
        ...
        ____temp_14 = ____R_6280_80FD_4E0A_4E0B_6587_8868[unitId]
    end
    return ____temp_14
end
...
local function _____7ED3_675F_5149_5F62_6001_6548_679C(_____65BD_6CD5_8005, ctx)
    local cfg = _____963F_4F26_52B3_7279_5355_4F4D_6280_80FD_914D_7F6E.R
    SetUnitManaPercentBJ(_____65BD_6CD5_8005, 0)
...
local function _____5149_7948_7977_5B8C_6210(_____65BD_6CD5_8005, rctx)
    ...
    createTimedUnitEffect(_____65BD_6CD5_8005, "chest", cfg["光强化特效"], cfg["光强化持续秒"])
    _____6062_590D_65BD_6CD5_8005_52A8_4F5C(_____65BD_6CD5_8005)
    rctx["类型"] = "光强化"
    rctx["强化回调ID"] = addDelayedCallback(
        math.floor(cfg["光强化持续秒"] * 1000 + 0.5),
        function()
            rctx["强化回调ID"] = 0
    ...
    rctx["周期回调ID"] = addPeriodicCallback(
        ...
        function()
            ...
            if not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) or not _____62E5_6709_5929_5802_547C_5524(_____65BD_6CD5_8005) then
                _____5149_5F3A_5316_5230_671F(_____65BD_6CD5_8005, rctx)
            end
        end
    )
...
local function _____5149_5F62_6001R(_____65BD_6CD5_8005)
    ...
    _____7948_7977_4E0A_4E0B_6587["回调ID"] = addPeriodicCallback(
        math.floor(cfg["光祈祷周期秒"] * 1000 + 0.5),
        function()
...
local function _____7ED3_7B97_6697_6C72_53D6_6062_590D(_____65BD_6CD5_8005, _____6C72_53D6_503C)
    if _____65BD_6CD5_8005 == nil or _____65BD_6CD5_8005 == 0 or not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) or not (_____6C72_53D6_503C > 0) then
        return
    end
    local _____5F53_524D_751F_547D = GetUnitState(_____65BD_6CD5_8005, UNIT_STATE_LIFE)
    local _____6700_5927_751F_547D = GetUnitState(_____65BD_6CD5_8005, UNIT_STATE_MAX_LIFE)
    SetUnitState(
        _____65BD_6CD5_8005,
        UNIT_STATE_LIFE,
        math.min(_____5F53_524D_751F_547D + _____6C72_53D6_503C, _____6700_5927_751F_547D)
    )
end
local function _____5F00_59CB_6697_6C72_53D6_5F39_9053(_____65BD_6CD5_8005, _____76EE_6807_5355_4F4D, _____6C72_53D6_503C)
    local cfg = _____963F_4F26_52B3_7279_5355_4F4D_6280_80FD_914D_7F6E.R
    ...
    local _____9C9C_8840X = _____76EE_6807X - math.cos(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道后方偏移"]
    local _____9C9C_8840Y = _____76EE_6807Y - math.sin(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道后方偏移"]
    ...
    if _____5F39_90531 == nil or _____5F39_90531 == 0 or _____5F39_90532 == nil or _____5F39_90532 == 0 then
        if _____5F39_90531 ~= nil and _____5F39_90531 ~= 0 then
            jass.DestroyEffect(_____5F39_90531)
        end
        if _____5F39_90532 ~= nil and _____5F39_90532 ~= 0 then
            jass.DestroyEffect(_____5F39_90532)
        end
        return
    end
    ...
    _____5F39_9053_4E0A_4E0B_6587["回调ID"] = addPeriodicCallback(
        20,
        function()
            local ctx = _____5F39_9053_4E0A_4E0B_6587
            ...
            local _____65BD_6CD5_8005X2 = GetUnitX(ctx["施法者"])
            local _____65BD_6CD5_8005Y2 = GetUnitY(ctx["施法者"])
            if _____4E24_70B9_8DDD_79BB(ctx["当前X"], ctx["当前Y"], _____65BD_6CD5_8005X2, _____65BD_6CD5_8005Y2) <= 100 then
                removePeriodicCallback(ctx["回调ID"])
                jass.DestroyEffect(ctx["弹道1"])
                jass.DestroyEffect(ctx["弹道2"])
                _____7ED3_7B97_6697_6C72_53D6_6062_590D(ctx["施法者"], ctx["汲取值"])
                return
            end
            local _____65B0_89D2_5EA6 = _____4E24_70B9_89D2_5EA6(ctx["当前X"], ctx["当前Y"], _____65BD_6CD5_8005X2, _____65BD_6CD5_8005Y2)
            ctx["当前X"] = ctx["当前X"] + math.cos(_____65B0_89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道每tick距离"]
            ctx["当前Y"] = ctx["当前Y"] + math.sin(_____65B0_89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道每tick距离"]
            if EXSetEffectXY ~= nil then
                EXSetEffectXY(ctx["弹道1"], ctx["当前X"], ctx["当前Y"])
                EXSetEffectXY(
                    ctx["弹道2"],
                    ctx["当前X"] - math.cos(_____65B0_89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道后方偏移"],
                    ctx["当前Y"] - math.sin(_____65B0_89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["暗汲取弹道后方偏移"]
                )
            end
        end
    )
...
local function _____6697_5F62_6001R(_____65BD_6CD5_8005)
    ...
    do
        ...
        while i < #_____5355_4F4D_5217_8868 do
            do
                ...
                _____5F00_59CB_6697_6C72_53D6_5F39_9053(_____65BD_6CD5_8005, _____76EE_6807, _____6C72_53D6_503C)
            end
            ::__continue61::
            i = i + 1
        end
    ...
    rctx["类型"] = "暗强化"
    rctx["强化回调ID"] = addDelayedCallback(
        math.floor(cfg["暗强化持续秒"] * 1000 + 0.5),
        function()
            rctx["强化回调ID"] = 0
            _____6697_5F3A_5316_5230_671F(_____65BD_6CD5_8005, rctx)
        end
    )
    rctx["周期回调ID"] = addPeriodicCallback(
        200,
        function()
            ...
            if not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) or not _____62E5_6709_88C1_51B3_5BA1_5224(_____65BD_6CD5_8005) then
                _____6697_5F3A_5316_5230_671F(_____65BD_6CD5_8005, rctx)
            end
        end
    )
...
local function _____65BD_653E_88C1_51B3_51B2_51FB(_____65BD_6CD5_8005)
    ...
    local _____8840_5899X = _____65BD_6CD5_8005X + math.cos(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["血墙点距离"]
    local _____8840_5899Y = _____65BD_6CD5_8005Y + math.sin(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["血墙点距离"]
    _____521B_5EFA_70B9_7279_6548({
        ["模型路径"] = cfg["血墙特效"],
        X = _____8840_5899X,
        Y = _____8840_5899Y,
    ...
    _____63A8_8FDB_4E0A_4E0B_6587["回调ID"] = addPeriodicCallback(
        ...
        function()
            ...
            do
                ...
                while i < #_____654C_4EBA_5217_8868 do
                    do
                        ...
                        local _____76EE_6807_5DF2_635F_5931_751F_547D = math.max(
                            0,
                            GetUnitState(_____76EE_6807, UNIT_STATE_MAX_LIFE) - GetUnitState(_____76EE_6807, UNIT_STATE_LIFE)
                        )
            ...
            _____63A8_8FDB["当前X"] = _____63A8_8FDB["当前X"] + math.cos(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["弹幕每tick距离"]
            _____63A8_8FDB["当前Y"] = _____63A8_8FDB["当前Y"] + math.sin(_____89D2_5EA6 * _____89D2_5EA6_8F6C_5F27_5EA6) * cfg["弹幕每tick距离"]
        end
    )
