...
local function _____5904_7406Q_547D_4E2D(_____65BD_6CD5_8005, _____76EE_6807, _____6570_636E)
    ...
    if _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["模型路径"] ~= "" then
        _____521B_5EFA_70B9_7279_6548({
            ["模型路径"] = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["模型路径"],
            RGB = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"].RGB,
            X = GetUnitX(_____76EE_6807),
            Y = GetUnitY(_____76EE_6807),
            Z = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["高度"],
            ["面向角度"] = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["面向角度"],
            ["动画索引"] = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["动画索引"],
            ["缩放"] = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["缩放"],
            ["持续秒"] = _____4F0A_857E_5A1C_8868_73B0_914D_7F6E["Q命中星柱"]["持续秒"]
        })
    end
    ...
    if _____6570_636E["灰烬爆发"] and _____4F0A_857E_5A1C_53D8_5F0F_6548_679C_914D_7F6E["灰烬_爆发半径"] > 0 then
        local _____7206_53D1X = GetUnitX(_____76EE_6807)
        local _____7206_53D1Y = GetUnitY(_____76EE_6807)
        local _____7206_53D1_7279_6548 = _____521B_5EFA_70B9_7279_6548({
        ...
        local ____ = _____7206_53D1_7279_6548
        local _____654C_4EBA_5217_8868 = _____83B7_53D6_5750_6807_8303_56F4_654C_4EBA(_____65BD_6CD5_8005, _____7206_53D1X, _____7206_53D1Y, _____4F0A_857E_5A1C_53D8_5F0F_6548_679C_914D_7F6E["灰烬_爆发半径"])
...
local function _____91CA_653EQ_65C5_98CE_8FFD_8FF9(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    local ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_16 = _____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B
    local ____65BD_6CD5_8005_15 = _____65BD_6CD5_8005
    local _____6709_76EE_6807_14
    if _____6709_76EE_6807 then
        _____6709_76EE_6807_14 = _____76EE_6807_5355_4F4D
    else
        _____6709_76EE_6807_14 = nil
    end
    local _____5B9E_4F8B = ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_16({
        ["技能键"] = "Q旅风追迹",
        ["施法者"] = ____65BD_6CD5_8005_15,
        ["目标"] = _____6709_76EE_6807_14,
        ["技能实例ID"] = _____6280_80FD_5B9E_4F8BID,
        ["数据"] = _____6570_636E,
    ...
    _____5B9E_4F8B["登记延迟回调"](addDelayedCallback(
        ...
        function()
            ...
            local _____5F39_9053 = _____53D1_5C04_5F39_9053({
                ...
                ["碰撞消失"] = false,
                ["每单位最大命中次数"] = 1,
                ["最大总命中次数"] = _____4F0A_857E_5A1CQ_914D_7F6E["主弹最大命中数"],
                ["伤害类型"] = DAMAGE_TYPE_MAGIC,
                ["来源类型"] = "单位技能",
                ["技能ID"] = ____Q_6280_80FD_7C7B_578BID,
                ["技能实例ID"] = _____6280_80FD_5B9E_4F8BID,
                ...
                onTick = function(_____5F39_5E55_5B9E_4F8B, _delta)
                    if not _____5B9E_4F8B["仍有效"]() or _____5F39_5E55_5B9E_4F8B == nil then
                        return
                    end
