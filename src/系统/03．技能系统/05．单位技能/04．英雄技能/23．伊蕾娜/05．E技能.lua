...
local function _____7ED3_7B97E_5230_8FBE(_____65BD_6CD5_8005, _____5B9E_4F8BID, _____6570_636E)
    ...
    if _____6570_636E["灰烬爆发"] then
        local _____7070_70EC_7279_6548 = _____521B_5EFA_70B9_7279_6548({
        ...
        local ____ = _____7070_70EC_7279_6548
        ...
        function()
            ...
            local _____4F4D_79FBID = _____5F00_59CB_51B2_950B(
                _____65BD_6CD5_8005,
                {
                    ...
                    ["结束回调"] = function(_____79FB_52A8_5355_4F4D, _____539F_56E0, ______4F4D_79FBID, ______547D_4E2D_76EE_6807)
                        ...
                        local _____5DF2_6536_675F = _____5B9E_4F8B["已结束"]()
                        ...
                        elseif not _____5DF2_6536_675F then
                            _____5B9E_4F8B["结束"]((_____539F_56E0 == "死亡" or _____539F_56E0 == "主单位死亡") and "施法者死亡" or "中断")
                        end
                    end
                }
            )
            ...
            if _____4F4D_79FBID > 0 then
                ...
                _____5B9E_4F8B["登记周期回调"](addPeriodicCallback(
                    ...
                    function()
                        if _____5B9E_4F8B["已结束"]() or not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) then
                            return
                        end
