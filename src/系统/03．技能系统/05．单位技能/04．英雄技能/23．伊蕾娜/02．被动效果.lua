...
local function _____540C_6B65_53D8_5F0FBuff(_____82F1_96C4, _____72B6_6001)
    local _____53D8_5F0FBuff_5217_8868 = {_____4F0A_857E_5A1CBuffID["迅行变式"], _____4F0A_857E_5A1CBuffID["镜界变式"], _____4F0A_857E_5A1CBuffID["灰烬变式"]}
    do
        local i = 0
        while i < #_____53D8_5F0FBuff_5217_8868 do
            _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____53D8_5F0FBuff_5217_8868[i + 1])
            i = i + 1
        end
    end
    ...
    local _____5F53_524DBuffID = nil
    if _____72B6_6001["当前变式"] == "迅行" then
        _____5F53_524DBuffID = _____4F0A_857E_5A1CBuffID["迅行变式"]
    elseif _____72B6_6001["当前变式"] == "镜界" then
        _____5F53_524DBuffID = _____4F0A_857E_5A1CBuffID["镜界变式"]
    elseif _____72B6_6001["当前变式"] == "灰烬" then
        _____5F53_524DBuffID = _____4F0A_857E_5A1CBuffID["灰烬变式"]
    end
    if _____5F53_524DBuffID == nil then
        return
    end
    local _____5269_4F59_79D2 = (_____72B6_6001["变式到期时间"] - getGameTime()) / 1000
    registerManualBuff(_____82F1_96C4, _____5F53_524DBuffID, _____5269_4F59_79D2 > 0 and _____5269_4F59_79D2 or 0.1, 0)
end
...
____exports["清理伊蕾娜状态"] = function(_____82F1_96C4, _____539F_56E0)
    ...
    if _____5355_4F4D_5B58_6D3B(_____82F1_96C4) then
        _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____4F0A_857E_5A1CBuffID["旅途见闻"])
        _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____4F0A_857E_5A1CBuffID["魔法弹强化"])
        _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____4F0A_857E_5A1CBuffID["迅行变式"])
        _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____4F0A_857E_5A1CBuffID["镜界变式"])
        _____79FB_9664_5355_4F4D_6307_5B9ABuff(_____82F1_96C4, _____4F0A_857E_5A1CBuffID["灰烬变式"])
    end
...
local function _____65BD_52A0_955C_754C_56DE_5E94(_____82F1_96C4, _____76EE_6807)
    ...
    _____5145_80FD_5355_4F4D_6807_7B7E_62A4_76FE(
        ...
        _____62A4_76FE_6570_503C,
        {["类型"] = 0, ["持续时间"] = _____4F0A_857E_5A1C_666E_653B_8054_52A8_914D_7F6E["回响护盾秒"], ["来源单位"] = _____82F1_96C4, ["显示护盾条"] = true}
    )
end
