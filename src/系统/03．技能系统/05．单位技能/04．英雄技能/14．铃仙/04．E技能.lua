...
local ____exports = {}
local _____6E05_7406E_4E0A_4E0B_6587, _____5F00_59CB_8DF3_8DC3_4E0B_964D, addPeriodicCallback, removePeriodicCallback, _____5355_4F4D_5B58_6D3B, SU_SetUnitFlyHeight, cfg, GetUnitFlyHeight, GetUnitDefaultFlyHeight, RemoveUnit
...
function _____5F00_59CB_8DF3_8DC3_4E0B_964D(ctx)
    ...
    ctx["下降回调ID"] = addPeriodicCallback(
        20,
        function()
            if ctx["已结束"] or _____65BD_6CD5_8005 == nil or _____65BD_6CD5_8005 == 0 or not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) then
...
local _____8BFB_53D6_5355_4F4D_654F_6377 = ____require_result_8["读取单位敏捷"]
_____5355_4F4D_5B58_6D3B = ____require_result_8["单位存活"]
local ____require_result_9 = require("lib.扩展函数.Star扩展函数.Star扩展库.09．单位基础与生命周期函数")
SU_SetUnitFlyHeight = ____require_result_9.SU_SetUnitFlyHeight
local ____require_result_10 = require("lib.扩展函数.Star扩展函数.Star扩展库.04B．快速Buff接口")
local ____SFB__65BD_52A0_901A_7528Buff = ____require_result_10["SFB_施加通用Buff"]
...
local unregisterDamageModifier = ____require_result_11.unregisterDamageModifier
...
local function _____5F00_59CB_8DF3_8DC3_4E0A_5347(ctx)
    ...
    ctx["上升回调ID"] = addPeriodicCallback(
        20,
        function()
            if ctx["已结束"] or _____65BD_6CD5_8005 == nil or _____65BD_6CD5_8005 == 0 or not _____5355_4F4D_5B58_6D3B(_____65BD_6CD5_8005) then
                _____6E05_7406E_4E0A_4E0B_6587(ctx)
    ...
    do
        ...
        while i <= cfg.E["每波弹幕数"] do
            do
                ...
                local _____5F39_5E55_5355_4F4D = CreateUnit(
                    _____73A9_5BB6,
                ...
                local ____ctx__5B50_5F39_5217_8868_12 = ctx["子弹列表"]
                ____ctx__5B50_5F39_5217_8868_12[#____ctx__5B50_5F39_5217_8868_12 + 1] = _____8BB0_5F55
            end
            ::__continue29::
            i = i + 1
        end
    ...
    do
        ...
        while i >= 0 do
            do
                ...
                _____5B50_5F39.X = _____5B50_5F39.X + math.cos(_____5B50_5F39["角度"] * _____89D2_5EA6_8F6C_5F27_5EA6) * _____6BCFtick_8DDD_79BB
                _____5B50_5F39.Y = _____5B50_5F39.Y + math.sin(_____5B50_5F39["角度"] * _____89D2_5EA6_8F6C_5F27_5EA6) * _____6BCFtick_8DDD_79BB
                ...
                if _____5B50_5F39["已飞行距离"] >= _____5B50_5F39["最远距离"] then
                    __TS__ArraySplice(ctx["子弹列表"], i, 1)
                    local ____ctx__7206_70B8_5217_8868_13 = ctx["爆炸列表"]
                    ____ctx__7206_70B8_5217_8868_13[#____ctx__7206_70B8_5217_8868_13 + 1] = _____5B50_5F39
                end
            end
            ::__continue35::
            i = i - 1
...
local function _____6267_884C_7206_70B8(ctx)
    ...
    do
        local i = 0
        while i < #ctx["子弹列表"] do
            local ____ctx__7206_70B8_5217_8868_14 = ctx["爆炸列表"]
            ____ctx__7206_70B8_5217_8868_14[#____ctx__7206_70B8_5217_8868_14 + 1] = ctx["子弹列表"][i + 1]
            i = i + 1
        end
    end
    ctx["子弹列表"] = {}
        ...
        while i < #ctx["爆炸列表"] do
            do
                ...
                if _____5F39_5E55_5355_4F4D ~= nil and _____5F39_5E55_5355_4F4D ~= 0 then
                    RemoveUnit(_____5F39_5E55_5355_4F4D)
                end
            end
            ::__continue45::
            i = i + 1
...
local function ____on_94C3_4ED9E_751F_6548(_____65BD_6CD5_5355_4F4D, _____6280_80FDID_6570_503C)
    ...
    local _____65E0_654C_4FEE_6B63ID = registerDamageModifier(
        function(_____4F24_5BB3_4E0A_4E0B_6587)
            ...
            if _____4F24_5BB3_4E0A_4E0B_6587 ~= nil and type(_____4F24_5BB3_4E0A_4E0B_6587.currentDamage) == "number" then
                ____temp_15 = _____4F24_5BB3_4E0A_4E0B_6587.currentDamage
            else
                ____temp_15 = 0
            end
            return ____temp_15
    ...
    addDelayedCallback(
        math.floor(cfg.E["无敌秒"] * 1000 + 0.5),
        function()
            if _____65E0_654C_4FEE_6B63ID ~= 0 then
                unregisterDamageModifier(_____65E0_654C_4FEE_6B63ID)
            end
        end
    )
    _____5F00_59CB_8DF3_8DC3_4E0A_5347(ctx)
    ctx["发射回调ID"] = addPeriodicCallback(
        50,
        function()
            if ctx["已结束"] then
                return
            ...
            if ctx["波次"] >= cfg.E["波数"] then
                ...
                ctx.over = true
                addDelayedCallback(
                    math.floor(cfg.E["爆炸延迟秒"] * 1000 + 0.5),
                    function() return _____6267_884C_7206_70B8(ctx) end
                )
                return
            end
    ...
    ctx["推进回调ID"] = addPeriodicCallback(
        math.floor(cfg.E["弹幕tick秒"] * 1000 + 0.5),
        function() return _____63A8_8FDB_6240_6709_5F39_5E55(ctx) end
    )
end
