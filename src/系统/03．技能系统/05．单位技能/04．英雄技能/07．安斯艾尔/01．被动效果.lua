...
local _____5EF6_540E_4E00_5E27_6267_884C_4F24_5BB3_6D3E_751F_6548_679C = ____require_result_5["延后一帧执行伤害派生效果"]
...
local function ____on_5B89_65AF_827E_5C14_666E_901A_653B_51FB_7ED3_7B97(target, attacker, applied, snapshot)
    if not _____662F_5B89_65AF_827E_5C14(attacker) or not (applied > 0) then
        return
    end
    ...
    local ____temp_13 = ____opt_result_9 ~= true
    if not ____temp_13 then
        local ____opt_result_12
        if snapshot ~= nil then
            ____opt_result_12 = snapshot.isWrappedSkillDamage
        end
        ____temp_13 = ____opt_result_12 == true
    end
    local ____temp_13_17 = ____temp_13
    if not ____temp_13_17 then
        local ____opt_result_16
        if snapshot ~= nil then
            ____opt_result_16 = snapshot.originalAttacker
        end
        ____temp_13_17 = ____opt_result_16 ~= attacker
    end
    if ____temp_13_17 then
        return
    end
