...
local _____6280_80FD__83B7_53D6_6280_80FD_6700_5927_51B7_5374_65F6_95F4 = ____require_result_5["技能_获取技能最大冷却时间"]
...
local function _____7EEF_8272_547D_8FD0Buff_79FB_9664(unit, _buffID, row)
    ...
    if row ~= nil then
        ____opt_result_11 = row.effect
    end
    if type(____opt_result_11) == "number" then
        ____temp_12 = row.effect
    else
        ____temp_12 = 0
    end
    local delta = ____temp_12
...
local function _____857E_7C73_8389_4E9AD_7ED3_7B97_9636_6BB5(variable)
    ...
    addDelayedCallback(____D_914D_7F6E["随机延迟秒"] * 1000, _____7ED3_7B97_857E_7C73_8389_4E9AD_7ED3_679C, context)
end
local function _____857E_7C73_8389_4E9AD_4E2D_6BB5(variable)
    ...
    addDelayedCallback(____D_914D_7F6E["结算延迟秒"] * 1000, _____857E_7C73_8389_4E9AD_7ED3_7B97_9636_6BB5, context)
end
local function _____5904_7406_857E_7C73_8389_4E9AD(caster, abilityId)
    ...
    addDelayedCallback(____D_914D_7F6E["中段延迟秒"] * 1000, _____857E_7C73_8389_4E9AD_4E2D_6BB5, {["施法者"] = caster})
end
