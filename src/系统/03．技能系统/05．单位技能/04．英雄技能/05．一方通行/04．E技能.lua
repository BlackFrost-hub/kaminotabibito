...
local ____require_result_7 = require("系统.03．技能系统.00．技能模板+函数.01．技能函数.01．弹幕.01．TS原生弹幕.index")
local _____521B_5EFA_539F_751F_5F39_5E55 = ____require_result_7["创建原生弹幕"]
local _____83B7_53D6_5355_4F4D_539F_751F_5F39_5E55ID = ____require_result_7["获取单位原生弹幕ID"]
local _____83B7_53D6_539F_751F_5F39_5E55 = ____require_result_7["获取原生弹幕"]
local _____91CD_7F6E_539F_751F_5F39_5E55_547D_4E2D_8BB0_5F55 = ____require_result_7["重置原生弹幕命中记录"]
local _____8BBE_7F6E_539F_751F_5F39_5E55_6307_5B9A_89D2_5EA6_98DE_884C = ____require_result_7["设置原生弹幕指定角度飞行"]
...
local function _____83B7_53D6_4E00_65B9_901A_884C_77E2_91CF_53CD_5C04_4E0A_4E0B_6587(unit)
    ...
    if unitId == 0 then
        ...
        ____temp_10 = _____77E2_91CF_53CD_5C04_4E0A_4E0B_6587_8868[unitId]
    end
    return ____temp_10
end
...
local function _____64AD_653E_77E2_91CF_53CD_5C04_97F3_6548(unit)
    ...
    Sound3DII_UnitPlayReuse(_____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E.W["施法音效路径"], unit, _____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E.W["施法音效裁断距离"])
end
...
local function _____7ED3_7B97_5355_4F53_666E_653B_53CD_5C04_4F24_5BB3(record, damage)
    local ____9020_6210_5355_4F53_6280_80FD_4F24_5BB3_18 = _____9020_6210_5355_4F53_6280_80FD_4F24_5BB3
    local ____record__4E00_65B9_901A_884C_14 = record["一方通行"]
    local ____record__53CD_51FB_76EE_6807_15 = record["反击目标"]
    local ____damage_16 = damage
    local ____record__4F24_5BB3_7C7B_578B_11 = record["伤害类型"]
    if ____record__4F24_5BB3_7C7B_578B_11 == nil then
        ____record__4F24_5BB3_7C7B_578B_11 = DAMAGE_TYPE_NORMAL
    end
    local ____record__662F_5426_8FDC_7A0B_17 = record["是否远程"]
    local ____record__653B_51FB_7C7B_578B_12 = record["攻击类型"]
    if ____record__653B_51FB_7C7B_578B_12 == nil then
        ____record__653B_51FB_7C7B_578B_12 = ATTACK_TYPE_NORMAL
    end
    local ____record__6B66_5668_7C7B_578B_13 = record["武器类型"]
    if ____record__6B66_5668_7C7B_578B_13 == nil then
        ____record__6B66_5668_7C7B_578B_13 = WEAPON_TYPE_WHOKNOWS
    end
    ____9020_6210_5355_4F53_6280_80FD_4F24_5BB3_18({
        ["来源"] = ____record__4E00_65B9_901A_884C_14,
        ["目标"] = ____record__53CD_51FB_76EE_6807_15,
        ["伤害"] = ____damage_16,
        ["伤害类型"] = ____record__4F24_5BB3_7C7B_578B_11,
        attack = false,
        ranged = ____record__662F_5426_8FDC_7A0B_17,
        attackType = ____record__653B_51FB_7C7B_578B_12,
        weaponType = ____record__6B66_5668_7C7B_578B_13,
        ["来源类型"] = "单位技能",
...
local function _____5C1D_8BD5_521B_5EFA_666E_653B_53CD_5C04_5F39_5E55(record, damage)
    ...
    local ____521B_5EFA_539F_751F_5F39_5E55_29 = _____521B_5EFA_539F_751F_5F39_5E55
    local ____GetUnitX_result_22 = GetUnitX(source)
    local ____GetUnitY_result_23 = GetUnitY(source)
    local ____4E24_70B9_89D2_5EA6_result_24 = _____4E24_70B9_89D2_5EA6(
        GetUnitX(source),
        GetUnitY(source),
        GetUnitX(target),
        GetUnitY(target)
    )
    local ____speed_25 = speed
    local ____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E__666E_653B_53CD_5C04_5F39_5E55_6700_5927_8DDD_79BB_26 = _____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E["普攻反射弹幕最大距离"]
    local ____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E__666E_653B_53CD_5C04_5F39_5E55_547D_4E2D_534A_5F84_27 = _____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E["普攻反射弹幕命中半径"]
    local ____damage_28 = damage
    local ____record__4F24_5BB3_7C7B_578B_19 = record["伤害类型"]
    if ____record__4F24_5BB3_7C7B_578B_19 == nil then
        ____record__4F24_5BB3_7C7B_578B_19 = DAMAGE_TYPE_NORMAL
    end
    local ____record__653B_51FB_7C7B_578B_20 = record["攻击类型"]
    if ____record__653B_51FB_7C7B_578B_20 == nil then
        ____record__653B_51FB_7C7B_578B_20 = ATTACK_TYPE_NORMAL
    end
    local ____record__6B66_5668_7C7B_578B_21 = record["武器类型"]
    if ____record__6B66_5668_7C7B_578B_21 == nil then
        ____record__6B66_5668_7C7B_578B_21 = WEAPON_TYPE_WHOKNOWS
    end
    ____521B_5EFA_539F_751F_5F39_5E55_29({
        ["所有者"] = source,
        X = ____GetUnitX_result_22,
        Y = ____GetUnitY_result_23,
        ["方向角"] = ____4E24_70B9_89D2_5EA6_result_24,
        ["速度"] = ____speed_25,
        ["最大距离"] = ____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E__666E_653B_53CD_5C04_5F39_5E55_6700_5927_8DDD_79BB_26,
        ["命中半径"] = ____4E00_65B9_901A_884C_5355_4F4D_6280_80FD_914D_7F6E__666E_653B_53CD_5C04_5F39_5E55_547D_4E2D_534A_5F84_27,
        ["碰撞消失"] = true,
        ["每单位最大命中次数"] = 1,
        ["最大总命中次数"] = 1,
        ["影响目标"] = "敌方",
        ["伤害值"] = ____damage_28,
        ["伤害类型"] = ____record__4F24_5BB3_7C7B_578B_19,
        ["攻击类型"] = ____record__653B_51FB_7C7B_578B_20,
        ["武器类型"] = ____record__6B66_5668_7C7B_578B_21,
        ["来源类型"] = "单位技能",
        ["技能ID"] = _____77E2_91CF_53CD_5C04_5F00_542F_6280_80FDID,
...
local function _____77E2_91CF_53CD_5C04_666E_653B_4F24_5BB3_4FEE_6B63(damageContext)
    ...
    local ____damageContext_originalAttacker_30 = damageContext.originalAttacker
    if ____damageContext_originalAttacker_30 == nil then
        ____damageContext_originalAttacker_30 = damageContext.attacker
    end
    local attacker = ____damageContext_originalAttacker_30
    ...
    local ____temp_37 = damageContext.isRangedAttack == true
    local ____damageContext_effectiveAttackType_31 = damageContext.effectiveAttackType
    if ____damageContext_effectiveAttackType_31 == nil then
        ____damageContext_effectiveAttackType_31 = damageContext.rawAttackType
    end
    local ____damageContext_effectiveAttackType_31_32 = ____damageContext_effectiveAttackType_31
    if ____damageContext_effectiveAttackType_31_32 == nil then
        ____damageContext_effectiveAttackType_31_32 = ATTACK_TYPE_NORMAL
    end
    local ____damageContext_effectiveDamageType_33 = damageContext.effectiveDamageType
    if ____damageContext_effectiveDamageType_33 == nil then
        ____damageContext_effectiveDamageType_33 = damageContext.rawDamageType
    end
    local ____damageContext_effectiveDamageType_33_34 = ____damageContext_effectiveDamageType_33
    if ____damageContext_effectiveDamageType_33_34 == nil then
        ____damageContext_effectiveDamageType_33_34 = DAMAGE_TYPE_NORMAL
    end
    local ____damageContext_effectiveWeaponType_35 = damageContext.effectiveWeaponType
    if ____damageContext_effectiveWeaponType_35 == nil then
        ____damageContext_effectiveWeaponType_35 = damageContext.rawWeaponType
    end
    local ____damageContext_effectiveWeaponType_35_36 = ____damageContext_effectiveWeaponType_35
    if ____damageContext_effectiveWeaponType_35_36 == nil then
        ____damageContext_effectiveWeaponType_35_36 = WEAPON_TYPE_WHOKNOWS
    end
    local record = {
        ["一方通行"] = target,
        ["反击目标"] = attacker,
        ["受到伤害"] = currentDamage,
        ["是否远程"] = ____temp_37,
        ["攻击类型"] = ____damageContext_effectiveAttackType_31_32,
        ["伤害类型"] = ____damageContext_effectiveDamageType_33_34,
        ["武器类型"] = ____damageContext_effectiveWeaponType_35_36
    }
...
local function _____53CD_5C04TS_539F_751F_5F39_5E55(context, projectile, projectileId)
    ...
    local ____temp_40 = instance == nil or instance["已结束"]
    if not ____temp_40 then
        local ____opt_38 = instance["参数"]
        if ____opt_38 ~= nil then
            ____opt_38 = ____opt_38["不可阻挡"]
        end
        ____temp_40 = ____opt_38 == true
    end
    if ____temp_40 then
        return false
    end
    ...
    if instance["当前速度"] > 0 then
        ____temp_41 = instance["当前速度"]
    else
        ____temp_41 = instance["参数"]["速度"]
    end
    local currentSpeed = ____temp_41
...
local function _____5C1D_8BD5_53CD_5C04_8303_56F4_5185_5F39_5E55(context, projectile)
    ...
    local ____isNativeProjectile_42
    if isNativeProjectile then
        ____isNativeProjectile_42 = _____53CD_5C04TS_539F_751F_5F39_5E55(context, projectile, projectileId)
    else
        ____isNativeProjectile_42 = _____53CD_5C04_65E7JASS_5F39_5E55(context, projectile)
    end
    local reflected = ____isNativeProjectile_42
    if reflected then
