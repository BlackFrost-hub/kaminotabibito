...
local _____5355_4F4D_662F_5426_6B63_5728_65BD_6CD5 = ____require_result_3["单位是否正在施法"]
...
local addThreat = ____require_result_8.addThreat
local getThreat = ____require_result_8.getThreat
local ____require_result_9 = require("lib.扩展函数.YDWE函数.09．YDUserData安全版")
local YDWESetUnitAbilityStateSafe = ____require_result_9.YDWESetUnitAbilityStateSafe
    ...
    do
        ...
        while i < #targets do
            do
                ...
                if jass.IsUnitType(enemy, jass.UNIT_TYPE_ANCIENT) then
                    goto __continue14
                end
                if jass.IsUnitType(enemy, jass.UNIT_TYPE_MECHANICAL) then
                    goto __continue14
                end
                if jass.IsUnitType(enemy, jass.UNIT_TYPE_STRUCTURE) then
                    goto __continue14
                end
                ...
                if _____5F53_524D_5632_8BBD > 0 then
                    addThreat(enemy, _____65BD_6CD5_5355_4F4D, _____5F53_524D_5632_8BBD * 0.3)
                end
            end
            ::__continue14::
            i = i + 1
        ...
        function()
            ...
            _____8F6E_8BE2ID = addPeriodicCallback(
                ...
                function()
                    ...
                    if not _____5355_4F4D_662F_5426_6B63_5728_65BD_6CD5(_____65BD_6CD5_5355_4F4D) then
                        removePeriodicCallback(_____8F6E_8BE2ID)
