...
local function _____5904_7406Q_547D_4E2D(_____65BD_6CD5_8005, _____76EE_6807, _____6570_636E)
    ...
    ____debugLogForce_15(
        ...
        _____4F24_5BB3,
        "全程最近棱晶距",
        _____6570_636E["接近最小距平方"] ~= nil and math.floor(SquareRoot(_____6570_636E["接近最小距平方"])) or -1
    )
...
local function _____5C1D_8BD5_68F1_6676_6298_5C04(_____65BD_6CD5_8005, _____6570_636E, _____5F53_524DX, _____5F53_524DY)
    ...
    if not _____6570_636E["已记录折射采样"] then
        _____6570_636E["已记录折射采样"] = true
        local _____68F1_6676_6570 = 0
        do
            local i = 0
            while i < #_____8282_70B9_5217_8868 do
                if _____8282_70B9_5217_8868[i + 1]["类型"] == "棱晶" then
                    _____68F1_6676_6570 = _____68F1_6676_6570 + 1
                end
                i = i + 1
            end
        end
        debugLogForce(
            ...
            GetPlayerId(GetOwningPlayer(_____65BD_6CD5_8005)) + 1,
            "节点数",
            #_____8282_70B9_5217_8868,
            "棱晶数",
            _____68F1_6676_6570,
            "有方向",
            _____6570_636E["有方向向量"],
            "当前X",
            math.floor(_____5F53_524DX),
            "当前Y",
            math.floor(_____5F53_524DY)
        )
    end
    do
        local i = 0
        while i < #_____8282_70B9_5217_8868 do
            do
                ...
                local _____8282_70B9_8DDD_79BB_5E73_65B9 = _____8DDD_79BB_5E73_65B9XY(_____5F53_524DX, _____5F53_524DY, _____8282_70B9.X, _____8282_70B9.Y)
                local ____6570_636E__63A5_8FD1_6700_5C0F_8DDD_5E73_65B9_16 = _____6570_636E["接近最小距平方"]
                if ____6570_636E__63A5_8FD1_6700_5C0F_8DDD_5E73_65B9_16 == nil then
                    ____6570_636E__63A5_8FD1_6700_5C0F_8DDD_5E73_65B9_16 = 1000000000000000000
                end
                if _____8282_70B9_8DDD_79BB_5E73_65B9 < ____6570_636E__63A5_8FD1_6700_5C0F_8DDD_5E73_65B9_16 then
                    _____6570_636E["接近最小距平方"] = _____8282_70B9_8DDD_79BB_5E73_65B9
                    if _____8282_70B9_8DDD_79BB_5E73_65B9 < 400 * 400 then
                        debugLogForce(
                            "塞莉亚-Q",
                            "接近棱晶",
                            "距离",
                            math.floor(SquareRoot(_____8282_70B9_8DDD_79BB_5E73_65B9)),
                            "节点",
                            _____8282_70B9["序号"],
                            "当前X",
                            math.floor(_____5F53_524DX),
                ...
                if _____8282_70B9_8DDD_79BB_5E73_65B9 > _____585E_8389_4E9A_514B_83B1_5C14Q_914D_7F6E["折射触发半径"] * _____585E_8389_4E9A_514B_83B1_5C14Q_914D_7F6E["折射触发半径"] then
                    goto __continue14
                end
...
local function _____91CA_653EQ_68F1_6676_9B54_5F39(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    debugLogForce(
        ...
        "节点数",
        #_____67E5_8BE2_585E_8389_4E9A_8282_70B9(_____65BD_6CD5_8005)
    )
    ...
    local ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_19 = _____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B
    local ____65BD_6CD5_8005_18 = _____65BD_6CD5_8005
    local _____6709_76EE_6807_17
    if _____6709_76EE_6807 then
        _____6709_76EE_6807_17 = _____76EE_6807_5355_4F4D
    else
        _____6709_76EE_6807_17 = nil
    end
    local _____5B9E_4F8B = ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_19({
        ["技能键"] = "Q棱晶魔弹",
        ["施法者"] = ____65BD_6CD5_8005_18,
        ["目标"] = _____6709_76EE_6807_17,
        ["技能实例ID"] = _____6280_80FD_5B9E_4F8BID,
        ["数据"] = _____6570_636E,
