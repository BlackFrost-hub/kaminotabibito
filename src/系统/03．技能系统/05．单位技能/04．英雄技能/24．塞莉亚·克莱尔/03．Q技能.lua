...
local _____83B7_53D6_5F39_9053_5F53_524D_4F4D_7F6E = ____require_result_3["获取弹道当前位置"]
...
local ____Q_6280_80FD_7C7B_578BID = jass.FourCC(_____585E_8389_4E9A_514B_83B1_5C14_6280_80FD_914D_7F6E.Q["技能ID"])
        ...
        while i < #_____8282_70B9_5217_8868 do
            do
                ...
                _____53D1_5C04_5F39_9053({
                    ...
                    ["飞行高度"] = _____585E_8389_4E9A_514B_83B1_5C14_8868_73B0_5B50_914D_7F6E["Q弹道"]["高度"],
                    ["影响目标"] = "敌方",
                    ["碰撞消失"] = true,
                    ["每单位最大命中次数"] = 1,
...
local function _____91CA_653EQ_68F1_6676_9B54_5F39(_context, _____65BD_6CD5_8005, _____6280_80FD_5B9E_4F8BID)
    ...
    local ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_9 = _____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B
    local ____65BD_6CD5_8005_8 = _____65BD_6CD5_8005
    local _____6709_76EE_6807_7
    if _____6709_76EE_6807 then
        _____6709_76EE_6807_7 = _____76EE_6807_5355_4F4D
    else
        _____6709_76EE_6807_7 = nil
    end
    local _____5B9E_4F8B = ____521B_5EFA_6218_6597_6280_80FD_5B9E_4F8B_9({
        ["技能键"] = "Q棱晶魔弹",
        ["施法者"] = ____65BD_6CD5_8005_8,
        ["目标"] = _____6709_76EE_6807_7,
        ["技能实例ID"] = _____6280_80FD_5B9E_4F8BID,
        ["数据"] = _____6570_636E,
