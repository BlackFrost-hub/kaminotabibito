...
const heroRevive = require("系统.00．核心系统.00．玩家系统.00．英雄注册联动.04．英雄复活系统");
...
export function initPlayerUnitManager() {
    if (_inited)
        return;
    _inited = true;
