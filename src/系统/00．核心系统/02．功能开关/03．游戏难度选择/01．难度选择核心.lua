...
local setGameDifficulty = ____require_result_8.setGameDifficulty
...
local function _____89E3_6790_6280_80FD_7C7B_578BID(_____6280_80FD_540D)
    ...
    if _____6280_80FD_540D == nil then
        ...
        ____temp_11 = _____6309_540D_5B57_53CD_67E5_6280_80FDID(_____6280_80FD_540D)
    end
    local rawId = ____temp_11
    if rawId == nil or rawId == "" then
...
local function _____53D1_9001_96BE_5EA6_9009_62E9_516C_544A(_____9009_62E9_73A9_5BB6, _____914D_7F6E)
    ...
    local ____QuestMessageBJ_13 = QuestMessageBJ
    ...
    ____QuestMessageBJ_13(
        _____73A9_5BB6_7EC4,
        ____jglobals_bj_QUESTMESSAGE_WARNING_12,
