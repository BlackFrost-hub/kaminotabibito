...
export const TEXT_OPENING = (name) => `正在开启${name}...`;
export const TEXT_SUCCESS = (name) => `${name}已开启！`;
export const TEXT_INTERRUPTED = (name) => `${name}开启中断`;
