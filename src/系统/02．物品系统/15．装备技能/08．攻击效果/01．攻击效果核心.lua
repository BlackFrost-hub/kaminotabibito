...
local ____require_result_3 = require("系统.03．技能系统.00．技能模板+函数.04．机制组件.09．装备通用机制.27．伤害派生批处理队列")
local _____521B_5EFA_4F24_5BB3_6D3E_751F_6279_5904_7406_961F_5217 = ____require_result_3["创建伤害派生批处理队列"]
...
local function _____51B7_5374_901A_8FC7(_____914D_7F6E, unit)
    ...
    _____653B_51FB_6548_679C_8FDB_5165_51B7_5374(_____914D_7F6E["装备名"], unit, _____914D_7F6E["冷却毫秒"])
    return true
end
    ...
    do
        ...
        while i < #list do
            do
                ...
                if amount > 0 then
                    _____653B_51FB_6548_679C_5EF6_8FDF_4F24_5BB3_961F_5217["加入"]({source = context.attacker, target = context.target, amount = amount, damageType = cfg["伤害类型"]})
                end
                result = 0
            end
            ::__continue34::
