...
local function _____7ED3_7B97_7194_5CA9_5730_72F1_4E4B_6572_949F()
    local item = table.remove(_____7ED3_7B97_961F_5217, 1)
    if item == nil then
        return
    end
    local damage = GetHeroInt(item["来源"], true) * _____7269_54C1_4F7F_7528_6570_503C_914D_7F6E["地狱敲钟"]["智力伤害倍率"]
    for ____, target in ipairs(item["目标列表"]) do
        _____9020_6210_706B_7130_4F24_5BB3(item["来源"], target, damage)
        _____65BD_52A0_7729_6655(item["来源"], target, _____7269_54C1_4F7F_7528_6570_503C_914D_7F6E["地狱敲钟"]["熔岩眩晕"])
    end
end
____exports["处理熔岩地狱之敲钟使用"] = function(ctx)
    ...
    addDelayedCallback(cfg["熔岩延迟毫秒"], _____7ED3_7B97_7194_5CA9_5730_72F1_4E4B_6572_949F)
end
return ____exports
