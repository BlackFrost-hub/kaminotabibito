...
local function ____on_7535_9CD7_5171_751F_6307_73AF_4F24_5BB3(target, attacker, applied, snapshot)
    if not (applied > 0) or not _____662F_6280_80FD_4F24_5BB3(snapshot) then
        return
    end
    if not _____5355_4F4D_6301_6709_7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1(attacker, _____7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1_88C5_5907_540D["电鳗共生指环"]) then
        return
    end
    local key = _____53D6_51B7_5374_952E(attacker, "电鳗共生指环")
    ...
    do
        ...
        while i < #enemies and count < 3 do
            ...
            _____9020_6210_88C5_5907_4F24_5BB3(attacker, enemies[i + 1], 260, _____88C5_5907_4F24_5BB3_7C7B_578B["闪电"])
            count = count + 1
            i = i + 1
        end
    end
end
registerAppliedFinalDamageListener(____on_7535_9CD7_5171_751F_6307_73AF_4F24_5BB3)
return ____exports
