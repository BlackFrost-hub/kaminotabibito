...
local ____require_result_1 = require("系统.03．技能系统.00．技能模板+函数.01．技能函数.19．拓展效果.02．buff.01．持续恢复生命魔法")
local _____65BD_52A0_6301_7EED_6062_590D_751F_547D_9B54_6CD5 = ____require_result_1["施加持续恢复生命魔法"]
...
____exports["处理地狱火卡牌施法"] = function(_____65BD_6CD5_5355_4F4D)
    debugLogForce("地狱火卡牌", "处理施法入口", "施法单位:", _____65BD_6CD5_5355_4F4D)
