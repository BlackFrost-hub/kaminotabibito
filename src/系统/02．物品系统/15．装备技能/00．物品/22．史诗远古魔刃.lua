...
local _____5355_4F4D_662F_5426_6709_6548_4E14_654C_5BF9 = ____require_result_3["单位是否有效且敌对"]
local ____require_result_4 = require("系统.03．技能系统.00．技能模板+函数.01．技能函数.16．扩展控制.扩展控制系统")
local _____65BD_52A0_6269_5C55_63A7_5236 = ____require_result_4["施加扩展控制"]
...
local function ____on_53F2_8BD7_8FDC_53E4_9B54_5203_626B_63A0(_____4E0A_4E0B_6587)
...
____exports["处理史诗远古魔刃使用"] = function(_____4E0A_4E0B_6587)
    ...
    local _____626B_63A0_4E0A_4E0B_6587 = {
    ...
    _____626B_63A0_4E0A_4E0B_6587.timerID = addPeriodicCallback(
        _____53F2_8BD7_8FDC_53E4_9B54_5203_914D_7F6E["周期"] * 1000,
        function() return ____on_53F2_8BD7_8FDC_53E4_9B54_5203_626B_63A0(_____626B_63A0_4E0A_4E0B_6587) end
    )
end
return ____exports
