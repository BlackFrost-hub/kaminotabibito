...
local _____4E34_65F6_8C03_6574_62A4_7532 = ____02_FF0E_7269_54C1_4F7F_7528_5DE5_5177["临时调整护甲"]
local ____require_result_0 = require("系统.00．核心系统.05．中心计时器")
local addDelayedCallback = ____require_result_0.addDelayedCallback
local _____56DE_9000_961F_5217 = {}
local function _____56DE_9000_9996_9886_53F7_89D2_52A0_6210()
    ...
    if item["护甲"] ~= 0 then
        _____4E34_65F6_8C03_6574_62A4_7532(item["单位"], -item["护甲"])
    end
end
____exports["处理首领号角使用"] = function(ctx)
    ...
    _____4E34_65F6_8C03_6574_62A4_7532(unit, armor)
    _____56DE_9000_961F_5217[#_____56DE_9000_961F_5217 + 1] = {["单位"] = unit, ["攻击"] = attack, ["护甲"] = armor}
    addDelayedCallback(cfg["持续毫秒"], _____56DE_9000_9996_9886_53F7_89D2_52A0_6210)
end
return ____exports
