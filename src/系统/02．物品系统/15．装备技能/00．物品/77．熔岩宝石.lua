...
local _____9020_6210_706B_7130_4F24_5BB3 = ____require_result_1["造成火焰伤害"]
local _____53D6_6700_5927_751F_547D = ____require_result_1["取最大生命"]
local _____64AD_653E_70B9_7279_6548 = ____require_result_1["播放点特效"]
...
local function ____on_7194_5CA9_5B9D_77F3_6218_6597_5468_671F(event)
    local unit = event["单位"]
...
local function _____521D_59CB_5316_7194_5CA9_5B9D_77F3()
    ...
    _____6CE8_518C_6301_6709_6218_6597_5468_671F_6A21_677F({
        ["名称"] = "熔岩宝石",
        ["物品类型ID"] = _____83B7_5F97_7269_54C1_88C5_5907ID["熔岩宝石"],
        ["周期秒"] = _____7194_5CA9_5B9D_77F3_914D_7F6E["间隔毫秒"] / 1000,
        ["主体类型"] = "玩家英雄",
        ["on获取"] = function(event)
            ____on_7194_5CA9_5B9D_77F3_83B7_5F97(event["单位"], event["物品"], event["持有数量"], event["前次数量"])
        end,
        ["on周期"] = ____on_7194_5CA9_5B9D_77F3_6218_6597_5468_671F
    })
end
