...
local ____require_result_0 = require("系统.03．技能系统.00．技能模板+函数.01．技能函数.19．拓展效果.02．buff.01．地狱火卡牌")
local _____65BD_52A0_5730_72F1_706B_5361_724C_6301_7EED_6062_590D = ____require_result_0["施加地狱火卡牌持续恢复"]
