...
local _____51B7_5374_6BEB_79D2 = 2000
...
local _____653B_901F_6062_590D_5217_8868 = {}
...
local function ____on_72C2_66B4_7194_5203_653B_901F_6062_590D()
    local record = table.remove(_____653B_901F_6062_590D_5217_8868, 1)
    if record == nil then
        return
    end
    if not _____5355_4F4D_6709_6548_5B58_6D3B(record.unit) then
        return
    end
...
local function _____65BD_52A0_72C2_66B4_7194_5203_653B_901F(attacker)
    _____4E34_65F6_4FEE_6539_653B_901F(attacker, _____653B_901F_589E_52A0)
    _____653B_901F_6062_590D_5217_8868[#_____653B_901F_6062_590D_5217_8868 + 1] = {unit = attacker, value = _____653B_901F_589E_52A0}
    addDelayedCallback(_____6301_7EED_6BEB_79D2, ____on_72C2_66B4_7194_5203_653B_901F_6062_590D)
end
...
local function ____on_72C2_66B4_7194_5203_6700_7EC8_4F24_5BB3(target, attacker, applied, snapshot)
    ...
    _____65BD_52A0_72C2_66B4_7194_5203_653B_901F(attacker)
    local damage = _____8BA1_7B97_66B4_51FB_4F24_5BB3(attacker)
    local enemies = _____83B7_53D6_654C_65B9_8303_56F4_5355_4F4D(attacker, target, _____8303_56F4, true)
    do
        local i = 0
        while i < #enemies do
            _____653B_51FB_6548_679C_9020_6210_4F24_5BB3(attacker, enemies[i + 1], damage, "物理")
            i = i + 1
        end
    end
end
registerAppliedFinalDamageListener(____on_72C2_66B4_7194_5203_6700_7EC8_4F24_5BB3)
return ____exports
