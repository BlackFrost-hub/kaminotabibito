...
local function _____56DE_9000_5973_5996_9B54_7532_9B54_6CD5_4F24_5BB3()
    local unit = table.remove(_____56DE_9000_961F_5217, 1)
    if unit == nil or unit == 0 then
        return
    end
    _____8C03_6574_73A9_5BB6_5C5E_6027(unit, "魔法伤害", -_____7269_54C1_4F7F_7528_6570_503C_914D_7F6E["女妖魔甲"]["魔法伤害提升"])
end
____exports["处理女妖魔甲使用"] = function(ctx)
    ...
    addDelayedCallback(_____7269_54C1_4F7F_7528_6570_503C_914D_7F6E["女妖魔甲"]["持续毫秒"], _____56DE_9000_5973_5996_9B54_7532_9B54_6CD5_4F24_5BB3)
end
return ____exports
