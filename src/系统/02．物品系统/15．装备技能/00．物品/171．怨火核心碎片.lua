...
local function ____on_6028_706B_6838_5FC3_788E_7247_6700_7EC8_4F24_5BB3(target, attacker, applied, snapshot)
    ...
    if not _____5355_4F4D_6301_6709_88C5_5907(attacker, "怨火核心碎片") then
        return
    end
    local key = _____53D6_88C5_5907_51B7_5374_952E(attacker, "怨火核心碎片:怨火灼痕", "第三章主线Boss战利品")
    if _____88C5_5907_51B7_5374_4E2D(key) then
        return
    end
    _____8FDB_5165_88C5_5907_51B7_5374(key, _____6028_706B_6838_5FC3_788E_7247_51B7_5374_79D2_6570)
