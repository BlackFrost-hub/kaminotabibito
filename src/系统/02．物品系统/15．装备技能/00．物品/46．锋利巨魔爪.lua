...
____exports["处理锋利巨魔爪物理触发"] = function(ctx)
    if ctx.snapshot == nil or ctx.snapshot.isPhysicalDamage ~= true then
        return
    end
    if not _____5355_4F4D_6301_6709_4F24_5BB3_4E8B_4EF6_88C5_5907(ctx.attacker, _____4F24_5BB3_4E8B_4EF6_88C5_5907ID["锋利巨魔爪"]) then
        return
    end
    _____9020_6210_4F24_5BB3_4E8B_4EF6_4F24_5BB3(
        ctx.attacker,
        ctx.target,
        _____53D6_5355_4F4D_62A4_7532(ctx.target) * 3,
