...
____exports["处理毒囊道具造成伤害"] = function(ctx)
    if not _____5355_4F4D_6301_6709_4F24_5BB3_4E8B_4EF6_88C5_5907(ctx.attacker, _____4F24_5BB3_4E8B_4EF6_88C5_5907ID["毒囊道具"]) then
        return
    end
    if ctx.snapshot == nil or ctx.snapshot.isNormalAttack == true or ctx.snapshot.isEnhancedDamage == true then
        return
    end
    if ctx.applied < _____53D6_6700_5927_751F_547D(ctx.target) * 0.01 + 100 then
        return
    end
    _____9020_6210_4F24_5BB3_4E8B_4EF6_4F24_5BB3(ctx.attacker, ctx.target, ctx.applied * 0.2, _____4F24_5BB3_4E8B_4EF6_4F24_5BB3_7C7B_578B["毒素"])
end
return ____exports
