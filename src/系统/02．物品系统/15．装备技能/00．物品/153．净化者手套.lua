...
local function ____on_51C0_5316_8005_624B_5957_89E6_53D1(event)
    ...
    registerManualBuff(
        ...
        duration,
        value,
        {sourceUnit = attacker, effectSourceName = "净化者手套", effectSourceType = "装备", iconOverride = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Gloves\\BTNpurifier_gloves.blp"}
    )
