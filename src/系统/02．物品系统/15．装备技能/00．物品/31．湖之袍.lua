...
____exports["处理湖之袍受伤"] = function(ctx)
    if not _____5355_4F4D_6301_6709_4F24_5BB3_4E8B_4EF6_88C5_5907(ctx.target, _____4F24_5BB3_4E8B_4EF6_88C5_5907ID["湖之袍"]) then
        return
    end
    local _____500D_7387 = _____662F_6307_5B9A_4F24_5BB3_7C7B_578B(ctx.snapshot, _____4F24_5BB3_4E8B_4EF6_4F24_5BB3_7C7B_578B["冰冷"]) and 0.25 or 0.1
