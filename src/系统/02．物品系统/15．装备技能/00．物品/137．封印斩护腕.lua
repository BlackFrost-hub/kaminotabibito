...
local function ____on_5C01_5370_65A9_62A4_8155_4F24_5BB3_4FEE_6B63(context)
    local result = context.currentDamage
    local target = context.target
    if not (result > 0) or not _____5355_4F4D_6301_6709_7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1(target, _____7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1_88C5_5907_540D["封印斩护腕"]) then
        return result
    end
    if result < _____53D6_6700_5927_751F_547D(target) * 0.12 then
        return result
    end
    local key = _____53D6_51B7_5374_952E(target, "封印斩护腕")
    if not _____51B7_5374_5C31_7EEA(key) then
        return result
    end
    _____8FDB_5165_51B7_5374(key, 18)
    _____4E34_65F6_73A9_5BB6_5C5E_6027(target, "眩晕抗性", 0.25, 4)
    _____64AD_653E_5355_4F4D_7279_6548(_____88C5_5907_5C0F_7279_6548["护盾闪光"], target, "origin", 0.8)
    result = result * 0.75
    return result
end
registerDamageModifier(____on_5C01_5370_65A9_62A4_8155_4F24_5BB3_4FEE_6B63, 28)
return ____exports
