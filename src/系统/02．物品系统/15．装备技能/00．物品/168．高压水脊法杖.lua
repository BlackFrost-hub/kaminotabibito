...
local function ____on_9AD8_538B_6C34_810A_6CD5_6756_4F24_5BB3(target, attacker, applied, snapshot)
    if not (applied > 0) or not _____662F_6280_80FD_4F24_5BB3(snapshot) then
        return
    end
    if not _____662F_5143_7D20_4F24_5BB3(snapshot, _____88C5_5907_4F24_5BB3_7C7B_578B["水"]) then
        return
    end
    if not _____5355_4F4D_6301_6709_7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1(attacker, _____7B2C_4E8C_7AE0_540E_6BB5Boss_6218_5229_54C1_88C5_5907_540D["高压水脊法杖"]) then
        return
    end
    local key = _____53D6_51B7_5374_952E(attacker, "高压水脊法杖")
    ...
    _____9020_6210_88C5_5907_4F24_5BB3(attacker, target, 450, _____88C5_5907_4F24_5BB3_7C7B_578B["水"])
end
registerAppliedFinalDamageListener(____on_9AD8_538B_6C34_810A_6CD5_6756_4F24_5BB3)
return ____exports
