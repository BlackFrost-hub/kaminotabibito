...
____exports["处理灵石受伤"] = function(ctx)
    if not _____5355_4F4D_6301_6709_4F24_5BB3_4E8B_4EF6_88C5_5907(ctx.target, _____4F24_5BB3_4E8B_4EF6_88C5_5907ID["灵石"]) then
        return
    end
    ...
    local _____5F53_524D = (_____7075_77F3_7D2F_8BA1[id] or 0) + ctx.applied
    if _____5F53_524D < 300 then
        _____7075_77F3_7D2F_8BA1[id] = _____5F53_524D
        return
    end
    _____7075_77F3_7D2F_8BA1[id] = 0
    _____8BBE_7F6E_5355_4F4D_51B7_5374(_____51B7_5374_952E, 3)
    _____6267_884C_7269_54C1_6CBB_7597(ctx.target, ctx.target, 300, "Abilities\\Spells\\Items\\AIhe\\AIheTarget.mdl")
end
return ____exports
