...
_____6CE8_518C_4E0D_540C_6280_80FD_4F24_5BB3_5E8F_5217_89E6_53D1_6A21_677F({
    ["名称"] = "旧誓残响徽记",
    ["装备名"] = _____56DBBoss_6218_5229_54C1_88C5_5907_540D["旧誓残响徽记"],
    ["需要不同技能数"] = 3,
    ["时间窗毫秒"] = 10000,
    ["作用域"] = "主体",
    ["重复策略"] = "忽略",
    ...
    ["on触发"] = function(e)
        _____64AD_653E_5355_4F4D_7279_6548(
            _____56DBBoss_88C5_5907_7279_6548["英魂出现"],
            e["目标"],
            "origin",
            0.8,
            0.7
        ...
        _____9020_6210_88C5_5907_4F24_5BB3(
            e["攻击者"],
            e["目标"],
            _____53D6_653B_51FB_529B(e["攻击者"]) * 0.9,
            _____88C5_5907_4F24_5BB3_7C7B_578B["魔法"],
            false,
            nil,
            {["装备技能类型"] = "装备被动", ["标签"] = "旧誓残响", ["伤害形态"] = "单体"}
        )
        _____64AD_653E_5355_4F4D_7279_6548(
            _____56DBBoss_88C5_5907_7279_6548["英魂消散"],
            e["目标"],
            "origin",
            1,
            0.35
