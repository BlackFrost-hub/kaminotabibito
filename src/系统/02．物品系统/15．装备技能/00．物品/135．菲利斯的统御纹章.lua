    ...
    do
        ...
        while i < #allies do
            ...
            registerManualBuff(
                ...
                6,
                10,
                {sourceUnit = attacker, effectSourceName = "菲利斯的统御纹章", effectSourceType = "装备", iconOverride = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Item\\BTNphyllis_command_emblem.blp"}
            )
