...
local _____7CBE_81F4_6728_76FE_7269_54C1ID = stringToFourCCSafe(resolveItemIdByName("精致木盾"))
local _____8DDD_79BB_9608_503C = 400
local _____8DDD_79BB_9608_503C_5E73_65B9 = _____8DDD_79BB_9608_503C * _____8DDD_79BB_9608_503C
local _____51CF_4F24_540E_7CFB_6570 = 0.65
...
____exports["处理精致木盾伤害修正"] = function(context, _____5F53_524D_4F24_5BB3)
    if _____7CBE_81F4_6728_76FE_7269_54C1ID == 0 then
    ...
    if not _____5355_4F4D_6301_6709_4F24_5BB3_4E8B_4EF6_88C5_5907(context.target, _____7CBE_81F4_6728_76FE_7269_54C1ID) then
        return _____5F53_524D_4F24_5BB3
    end
