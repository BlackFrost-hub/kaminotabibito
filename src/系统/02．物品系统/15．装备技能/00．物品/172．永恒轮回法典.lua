...
local function ____on_6C38_6052_8F6E_56DE_6CD5_5178_6700_7EC8_4F24_5BB3(target, attacker, applied, snapshot)
    ...
    if not _____5355_4F4D_6301_6709_88C5_5907(attacker, "永恒轮回法典") then
        return
    end
    local key = _____53D6_88C5_5907_51B7_5374_952E(attacker, "永恒轮回法典:轮回火印", "第三章主线Boss战利品")
    if _____88C5_5907_51B7_5374_4E2D(key) then
        return
    end
    _____8FDB_5165_88C5_5907_51B7_5374(key, _____6C38_6052_8F6E_56DE_6CD5_5178_51B7_5374_79D2_6570)
