...
local ____require_result_0 = require("系统.03．技能系统.00．技能模板+函数.02．通用函数.01．便捷短函数集合.03．快速Buff")
local _____5FEB_901F_51CF_901FBuff = ____require_result_0["快速减速Buff"]
...
____exports["处理史莱姆粘液瓶使用"] = function(_____4E0A_4E0B_6587)
    _____4E3B_52A8_7269_54C1_8C03_8BD5_65E5_5FD7("12．史莱姆粘液瓶", "进入", "处理史莱姆粘液瓶使用")
