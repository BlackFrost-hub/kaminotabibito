    ...
    do
        ...
        while i < #allies do
            ...
            registerManualBuff(
                ...
                6,
                16,
                {sourceUnit = attacker, effectSourceName = "攻城号令圣印", effectSourceType = "装备", iconOverride = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Item\\BTNsiege_command_signet.blp"}
            )
