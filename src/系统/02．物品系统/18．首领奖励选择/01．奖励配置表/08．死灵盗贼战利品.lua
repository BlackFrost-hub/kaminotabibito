...
____exports["死灵盗贼首领奖励池配置"] = {["奖励池ID"] = ____exports["死灵盗贼奖励池ID"], ["标题"] = "死灵盗贼战利品选择", ["可选数量"] = 2, ["选项"] = {
    {
        ["装备名"] = "影骨披风",
        ["排序"] = 1,
        ["图标"] = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Clothes\\BTNshadowbone_cloak.blp",
    ...
    },
    {
        ["装备名"] = "幽影匕首",
        ["排序"] = 2,
        ["图标"] = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\MainWeapon\\Dagger\\BTNumbral_dagger.blp",
    ...
    },
    {
        ["装备名"] = "盗贼首领徽记",
        ["排序"] = 3,
        ["图标"] = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Item\\BTNrogue_leader_emblem.blp",
    ...
    },
    {
        ["装备名"] = "阴影陷阱装置",
        ["排序"] = 4,
        ["图标"] = "ReplaceableTextures\\CommandButtons\\Equipment\\Icon\\Item\\BTNshadow_trap_device.blp",
