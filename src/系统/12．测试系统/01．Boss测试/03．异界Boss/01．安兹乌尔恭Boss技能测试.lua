...
local ____require_result_6 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.15．被动效果")
local _____6CE8_518C_5B89_5179_88AB_52A8_6548_679C = ____require_result_6["注册安兹被动效果"]
local ____require_result_7 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．运行时上下文")
local _____83B7_53D6_6216_521B_5EFA_5B89_5179_8FD0_884C_65F6_4E0A_4E0B_6587 = ____require_result_7["获取或创建安兹运行时上下文"]
local _____6E05_7406_5B89_5179_8FD0_884C_65F6_4E0A_4E0B_6587 = ____require_result_7["清理安兹运行时上下文"]
local ____require_result_8 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.12．守护者模式")
local _____542F_52A8_5B89_5179_5B88_62A4_8005_6A21_5F0F = ____require_result_8["启动安兹守护者模式"]
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.03．现实断裂")
local _____91CA_653E_5B89_5179_73B0_5B9E_65AD_88C2 = ____require_result_9["释放安兹现实断裂"]
local ____require_result_10 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.04．心脏掌握")
local _____91CA_653E_5B89_5179_5FC3_810F_638C_63E1 = ____require_result_10["释放安兹心脏掌握"]
local ____require_result_11 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.05．高阶魔法箭")
local _____91CA_653E_5B89_5179_9AD8_9636_9B54_6CD5_7BAD = ____require_result_11["释放安兹高阶魔法箭"]
local ____require_result_12 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.06．光辉翠绿体")
local _____91CA_653E_5B89_5179_5149_8F89_7FE0_7EFF_4F53 = ____require_result_12["释放安兹光辉翠绿体"]
local ____require_result_13 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.07．时间停止")
local _____91CA_653E_5B89_5179_65F6_95F4_505C_6B62 = ____require_result_13["释放安兹时间停止"]
local ____require_result_14 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.08．高阶亡灵召唤")
local _____91CA_653E_5B89_5179_9AD8_9636_4EA1_7075_53EC_5524 = ____require_result_14["释放安兹高阶亡灵召唤"]
local ____require_result_15 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.09．天空坠落")
local _____91CA_653E_5B89_5179_5929_7A7A_5760_843D = ____require_result_15["释放安兹天空坠落"]
local ____require_result_16 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.10．一切生命的终点")
local _____91CA_653E_5B89_5179_4E00_5207_751F_547D_7684_7EC8_70B9 = ____require_result_16["释放安兹一切生命的终点"]
local ____require_result_17 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．护卫雅儿贝德.01．至尊拦截")
local _____91CA_653E_96C5_513F_8D1D_5FB7_81F3_5C0A_62E6_622A = ____require_result_17["释放雅儿贝德至尊拦截"]
local ____require_result_18 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．护卫雅儿贝德.02．黑翼横扫")
local _____91CA_653E_96C5_513F_8D1D_5FB7_9ED1_7FFC_6A2A_626B = ____require_result_18["释放雅儿贝德黑翼横扫"]
local ____require_result_19 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．护卫雅儿贝德.03．守护者之职责")
local _____91CA_653E_96C5_513F_8D1D_5FB7_5B88_62A4_8005_4E4B_804C_8D23 = ____require_result_19["释放雅儿贝德守护者之职责"]
local ____require_result_20 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．护卫雅儿贝德.08．守护回归")
local _____91CA_653E_96C5_513F_8D1D_5FB7_5B88_62A4_56DE_5F52 = ____require_result_20["释放雅儿贝德守护回归"]
local ____require_result_21 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．异界Boss.03．安兹乌尔恭.01．护卫雅儿贝德.09．护卫反击")
local _____91CA_653E_96C5_513F_8D1D_5FB7_62A4_536B_53CD_51FB = ____require_result_21["释放雅儿贝德护卫反击"]
...
local function _____521B_5EFA_6216_83B7_53D6_5B89_5179_6D4B_8BD5_4E0A_4E0B_6587(player)
    ...
    SetUnitPosition(hero, _____73A9_5BB6_6D4B_8BD5X, _____73A9_5BB6_6D4B_8BD5Y)
    SetUnitFacing(hero, 90)
    _____8BBE_7F6EBoss_6D4B_8BD5_5355_4F4D_6EE1_8840(hero)
    local target = _____83B7_53D6_6216_521B_5EFA_5B89_5179_6D4B_8BD5_6B65_5175(_____6700_8FD1_6D4B_8BD5_6B65_51751, player, _____73A9_5BB6_6D4B_8BD5X - 220, _____73A9_5BB6_6D4B_8BD5Y + 180)
    _____83B7_53D6_6216_521B_5EFA_5B89_5179_6D4B_8BD5_6B65_5175(_____6700_8FD1_6D4B_8BD5_6B65_51752, player, _____73A9_5BB6_6D4B_8BD5X + 220, _____73A9_5BB6_6D4B_8BD5Y + 180)
    ...
    local ____opt_22 = runtime["雅儿贝德"]
    if ____opt_22 ~= nil then
        ____opt_22 = ____opt_22["单位"]
    end
    local albedo = ____opt_22
...
local function _____6D4B_8BD5_96C5_513F_8D1D_5FB7_5B88_62A4_56DE_5F52(_player, context)
    ...
    if state ~= nil then
        ____opt_result_28 = state["单位"]
    end
    local albedo = ____opt_result_28
