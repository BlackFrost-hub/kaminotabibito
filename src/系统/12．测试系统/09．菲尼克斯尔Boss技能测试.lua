...
local ____require_result_6 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.03．运行时上下文")
...
local ____require_result_7 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.18．技能入口")
local _____6CE8_518C_83F2_5C3C_514B_65AF_5C14_6280_80FD_7ED3_6784 = ____require_result_7["注册菲尼克斯尔技能结构"]
local ____require_result_8 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.05．永恒冰核与导管")
...
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.06．炽羽散射")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_70BD_7FBD_6563_5C04 = ____require_result_9["释放菲尼克斯尔炽羽散射"]
local ____require_result_10 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.07．熔岩吐息")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_7194_5CA9_5410_606F = ____require_result_10["释放菲尼克斯尔熔岩吐息"]
local ____require_result_11 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.08．凤凰漩涡")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_51E4_51F0_6F29_6DA1 = ____require_result_11["释放菲尼克斯尔凤凰漩涡"]
local ____require_result_12 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.09．浴火重生准备")
local _____89E6_53D1_83F2_5C3C_514B_65AF_5C14P1_8F6C_573A = ____require_result_12["触发菲尼克斯尔P1转场"]
local ____require_result_13 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.04．双形态转换")
local _____5207_6362_83F2_5C3C_514B_65AF_5C14_7B2C_4E8C_5F62_6001 = ____require_result_13["切换菲尼克斯尔第二形态"]
local ____require_result_14 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.11．骸骨弹幕")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_9AB8_9AA8_5F39_5E55 = ____require_result_14["释放菲尼克斯尔骸骨弹幕"]
local ____require_result_15 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.12．怨火链接")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_6028_706B_94FE_63A5 = ____require_result_15["释放菲尼克斯尔怨火链接"]
local ____require_result_16 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.13．凤凰挽歌")
local _____91CA_653E_83F2_5C3C_514B_65AF_5C14_51E4_51F0_633D_6B4C = ____require_result_16["释放菲尼克斯尔凤凰挽歌"]
local ____require_result_17 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.14．元素爆发")
local _____7ED3_7B97_83F2_5C3C_514B_65AF_5C14_5143_7D20_7206_53D1 = ____require_result_17["结算菲尼克斯尔元素爆发"]
local ____require_result_18 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.15．怨火核心暴露")
local _____89E6_53D1_83F2_5C3C_514B_65AF_5C14_6028_706B_6838_5FC3_66B4_9732 = ____require_result_18["触发菲尼克斯尔怨火核心暴露"]
local ____require_result_19 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.16．永恒轮回")
local _____89E6_53D1_83F2_5C3C_514B_65AF_5C14_6C38_6052_8F6E_56DE = ____require_result_19["触发菲尼克斯尔永恒轮回"]
local ____require_result_20 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.19．公共工具")
local _____6DFB_52A0_5143_7D20_5C42_6570 = ____require_result_20["添加元素层数"]
local ____require_result_21 = require("系统.03．技能系统.05．单位技能.03．Boss技能.01．主线Boss.04．双重凤凰菲尼克斯尔.01．场地配置")
