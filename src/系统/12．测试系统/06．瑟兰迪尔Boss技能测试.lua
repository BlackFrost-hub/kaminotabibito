...
local ____require_result_4 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.03．运行时上下文")
...
local ____require_result_5 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.07．秩序领域")
local _____5237_65B0_745F_5170_8FEA_5C14_79E9_5E8F_9886_57DF = ____require_result_5["刷新瑟兰迪尔秩序领域"]
local ____require_result_6 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.05．月光枷锁")
...
local ____require_result_7 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.06．精灵箭阵")
local _____91CA_653E_745F_5170_8FEA_5C14_7CBE_7075_7BAD_9635 = ____require_result_7["释放瑟兰迪尔精灵箭阵"]
local ____require_result_8 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.08．审判之环")
local _____91CA_653E_745F_5170_8FEA_5C14_5BA1_5224_4E4B_73AF = ____require_result_8["释放瑟兰迪尔审判之环"]
local ____require_result_9 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.09．罪与罚")
local _____91CA_653E_745F_5170_8FEA_5C14_7F6A_4E0E_7F5A = ____require_result_9["释放瑟兰迪尔罪与罚"]
local ____require_result_10 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.10．律法召唤")
local _____91CA_653E_745F_5170_8FEA_5C14_5F8B_6CD5_53EC_5524 = ____require_result_10["释放瑟兰迪尔律法召唤"]
local ____require_result_11 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.11．月光灌注")
local _____91CA_653E_745F_5170_8FEA_5C14_6708_5149_704C_6CE8 = ____require_result_11["释放瑟兰迪尔月光灌注"]
local ____require_result_12 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.12．终末审判")
local _____91CA_653E_745F_5170_8FEA_5C14_7EC8_672B_5BA1_5224 = ____require_result_12["释放瑟兰迪尔终末审判"]
local ____require_result_13 = require("系统.03．技能系统.05．单位技能.03．Boss技能.03．瑟兰迪尔.02．数值与表现配置")
