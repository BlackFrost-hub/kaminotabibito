...
function tryCreateFromFdfOnlyNullFallback() {
    return null;
}
let __dzCreateName = "";
...
function __dzCreateFramePcallBody() {
    __dzCreateResultFrame = japi.DzCreateFrame(__dzCreateName, __dzCreateParent, __dzCreateContextId);
}
export function tryCreateFromFdfWithSource(name, parent, fallback, contextId = 0) {
...
export function tryCreateFromFdfOnly(name, parent, contextId = 0) {
...
function questIdTailIsAllDigits(s) {
    if (s.length === 0)
        return false;
...
function lastUnderscoreIndex(s) {
...
function compareQuestIdForListOrder(aId, bId) {
