...
local function init(self)
    registerSimpleSTESBridgeEvent(nil, "LuaEvent_QuestAccepted", handleQuestAccepted, "任务接受")
    registerSimpleSTESBridgeEvent(nil, "LuaEvent_QuestCompleted", handleQuestCompleted, "任务完成")
end
init(nil)
return ____exports
