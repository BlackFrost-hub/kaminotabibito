...
| `Common\Effect\Projectile\FrierenZoltraakSpiritArrowOverlay.mdx` | 细长灵箭状能量叠加层，强化 Zoltraak 的前向轮廓和尾迹，不替代主弹体。 | `Stand 0-1000 / Birth 1100-1133 / Death 2000-3500`；作为附加特效跟随 Q 主弹道坐标、高度、朝向和俯仰。 | 芙莉莲 Q Zoltraak 附加弹道层。 | 只负责视觉叠加，不参与碰撞、命中或伤害；独立缩放 `1.5`，生命周期随主弹道销毁。4 张贴图均规范为原生 `Textures\RibbonNE1_blue.blp`、`Textures\Flare.blp`、`Textures\lensflare1Ax.blp`、`Textures\Tornado2b.blp`，不复制或删除原生贴图；源代号 `file_001249.mdx`。 | 6035 | `5397DFE2D527FF7C` |
