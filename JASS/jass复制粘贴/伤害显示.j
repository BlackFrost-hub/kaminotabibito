...
function Trig_SHXS_001Func009Func007Func003Func009T takes nothing returns nothing
	#ifdef YDLOC_New
...
function Trig_SHXS_001Actions takes nothing returns nothing
	...
	loop
		...
		if ((bj_forLoopBIndex < (YDLocal1Get(integer, "n") + 1))) then
			...
			call SetImageType( YDLocal1Get(image, "tag"), 5)
...
#endif
			call TimerStart(ydl_timer, 0.04, true, function Trig_SHXS_001Func009Func007Func003Func009T)
#ifdef StarDebuggerIncluded 
			call  SDR_DebugTimer(ydl_timer, 0.04, true," function Trig_SHXS_001Func009Func007Func003Func009T","SHXS_001")
#endif 
		else
		endif
