...
#  define YDTRIGGER_HC_hashtable(HC)                        YDTRIGGER_##HC##(HandleDummy)
#  define YDTRIGGER_HC_effectGroup(HC)                      YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_lightningGroup(HC)                   YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_StarStrPool(HC)                      YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_starCircle(HC)                       YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_Srrounder(HC)                        YDTRIGGER_##HC##(Integer)
#  define YDTRIGGER_HC_StarIntPool(HC)                      YDTRIGGER_##HC##(Integer)
