...
#  define YDTRIGGER_effectGroup(SG)                     YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_lightningGroup(SG)                  YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_StarStrPool(SG)                     YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_starCircle(SG)                      YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_Srrounder(SG)                       YDTRIGGER_HT##SG##(Integer)
#  define YDTRIGGER_hashtable(SG)                       YDTRIGGER_HT##SG##(HashtableHandle)
#  define YDTRIGGER_StarIntPool(SG)                     YDTRIGGER_HT##SG##(Integer) 
#  define YDTRIGGER_terraintype(SG)                     YDTRIGGER_HT##SG##(Integer) 
