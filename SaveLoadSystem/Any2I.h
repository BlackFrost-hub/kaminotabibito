...
#  define YDTRIGGER_ANY2I_hashtable(any)                    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_effectGroup(any)                  YDHashI2I(any)
#  define YDTRIGGER_ANY2I_lightningGroup(any)               YDHashI2I(any)
#  define YDTRIGGER_ANY2I_StarStrPool(any)                  YDHashI2I(any)
#  define YDTRIGGER_ANY2I_starCircle(any)                   YDHashI2I(any)
#  define YDTRIGGER_ANY2I_Srrounder(any)                    YDHashI2I(any)
#  define YDTRIGGER_ANY2I_StarIntPool(any)                  YDHashI2I(any)
#  define YDTRIGGER_ANY2I_terraintype(any)                  YDHashI2I(any)
#  define YDTRIGGER_ANY2I_doodad(any)                       YDHashI2I(any)
