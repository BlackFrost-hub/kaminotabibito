...
const FRAME_NAME_PREFIX = "剧情主线引导_";
...
export function 创建主线引导帧(this: void): void {
  ...
  // 主线任务入口图标
  帧.主线任务 = DzCreateFrameByTagName("BACKDROP", FRAME_NAME_PREFIX + "主线任务", gameUI, "template", 0);
  ...
  // "主线引导" 标签
  帧.任务提示 = DzCreateFrameByTagName("TEXT", FRAME_NAME_PREFIX + "任务提示", 帧.主线任务, "template", 0);
  ...
  // 放大效果帧（默认隐藏）
  帧.放大效果 = DzCreateFrameByTagName("BACKDROP", FRAME_NAME_PREFIX + "放大效果", 帧.主线任务, "template", 0);
  ...
  // 文本框背景（默认隐藏）
  帧.文本框 = DzCreateFrameByTagName("BACKDROP", FRAME_NAME_PREFIX + "文本框", 帧.主线任务, "template", 0);
  ...
  // 提示文本
  帧.提示文本 = DzCreateFrameByTagName("TEXT", FRAME_NAME_PREFIX + "提示文本", 帧.文本框, "template", 0);
...
export function 创建主线引导按钮(this: void, onClick: (this: void) => void): void {
  ...
  帧.按钮 = DzCreateFrameByTagName("GLUETEXTBUTTON", FRAME_NAME_PREFIX + "按钮", 帧.主线任务, "template", 0);
