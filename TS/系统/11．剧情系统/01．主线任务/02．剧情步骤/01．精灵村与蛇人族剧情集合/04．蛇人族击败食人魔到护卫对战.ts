...
export const 蛇人族卫队长试炼紧凑剧情片段: 紧凑剧情片段配置 = {
  ...
  默认对白持续时间: 3,
  对白列表: [
    { 序号: 1, 说话者: "蛇人族卫队长", 文本: "管家大人，您竟把蛇纹印记交给外族？若他们把灾祸带回神殿，谁来负责？", 持续时间: 5 },
    { 序号: 2, 说话者: "蛇人族藏品管家", 文本: "他们已按规矩完成交换。蛇人族守信，不会因为猜疑撕毁承诺。", 持续时间: 4 },
    { 序号: 3, 说话者: "蛇人族卫队长", 文本: "规矩我认。但若他们连我的护卫都过不了，就没有资格带着印记离开。", 持续时间: 5 },
    { 序号: 4, 说话者: "玩家", 文本: "既然这是蛇人族的规矩，我们接下。但愿这场试炼之后，你们不再阻拦。", 持续时间: 4 },
  ],
  动作时间线: [
    {
      序号: 1, 挂点: "beforeDialog", 对白序号: 1,
...
export const 蛇人族卫队长试炼剧情片段: 剧情片段配置 = 编译紧凑剧情片段(蛇人族卫队长试炼紧凑剧情片段);

export const 蛇人族击败食人魔到护卫对战剧情片段: 剧情片段配置 = 合并剧情步骤列表("jlc_snake_ogre_defeated_to_guard_duel", "蛇人族击败食人魔到护卫对战", [
  蛇人族接受食人魔任务剧情片段,
  沙漠食人魔Boss启动剧情片段,
  沙漠食人魔一阶段死亡剧情片段,
  杀戮食人魔死亡剧情片段,
