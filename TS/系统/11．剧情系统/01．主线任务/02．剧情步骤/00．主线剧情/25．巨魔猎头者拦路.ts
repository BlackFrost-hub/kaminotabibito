...
export function 执行巨魔猎头者拦路(this: void): void {
  停止触发单位();
  设置触发单位控制状态(true, false);
}

export function 执行巨魔猎头者开战(this: void): void {
...
export function 执行清理巨魔猎头者运行时引用(this: void): void {
  清理剧情运行时单位("剧情运行时.巨魔猎头者守卫");
}
...
export const 巨魔猎头者拦路剧情动作注册表: Record<string, 剧情动作处理器> = {
  "JLC精灵城_巨魔猎头者拦路": 执行巨魔猎头者拦路,
  "JLC精灵城_巨魔猎头者开战": 执行巨魔猎头者开战,
  "JLC精灵城_清理巨魔猎头者运行时引用": 执行清理巨魔猎头者运行时引用,
