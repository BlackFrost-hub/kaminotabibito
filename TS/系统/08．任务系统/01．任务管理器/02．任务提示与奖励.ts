 ...
 */
export function showQuestFailedMessage(playerId: number, questId: string): void {
 ...
 */
export function showQuestAcceptedMessage(playerId: number, questId: string): void {
  const quest = questDB.getQuest(questId);
  if (!quest) return;
 ...
 */
export function showQuestCompletedMessage(playerId: number, questId: string): void {
  const quest = questDB.getQuest(questId);
  if (!quest) return;
 ...
 */
export function giveQuestRewards(playerId: number, questId: string): void {
  const quest = questDB.getQuest(questId);
  if (!quest) return;
