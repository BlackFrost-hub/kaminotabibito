...
const 莫尔特斯测试步兵1: Record<number, any> = {};
const 莫尔特斯测试步兵2: Record<number, any> = {};
...
function 准备测试场景(this: void, player: any, boss: any): void {
  ...
  莫尔特斯测试步兵1[pid] = 准备Boss测试固定步兵(莫尔特斯测试步兵1[pid], 临时测试场地中心X - 220, 临时测试玩家Y + 180, 90);
  莫尔特斯测试步兵2[pid] = 准备Boss测试固定步兵(莫尔特斯测试步兵2[pid], 临时测试场地中心X + 220, 临时测试玩家Y + 180, 90);
...
function 清理莫尔特斯测试(this: void, player: any, _context: any): void {
  ...
  移除Boss测试单位(莫尔特斯测试步兵1[pid]);
  移除Boss测试单位(莫尔特斯测试步兵2[pid]);
  移除Boss测试单位(boss);
  莫尔特斯测试步兵1[pid] = undefined;
  莫尔特斯测试步兵2[pid] = undefined;
