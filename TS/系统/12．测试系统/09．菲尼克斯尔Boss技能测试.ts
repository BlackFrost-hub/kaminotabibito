...
const { 获取或创建菲尼克斯尔上下文, 注册菲尼克斯尔运行时 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.03．运行时上下文") as {
  获取或创建菲尼克斯尔上下文: (this: void, boss: any) => any;
  注册菲尼克斯尔运行时: (this: void) => void;
};
const { 注册菲尼克斯尔技能结构 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.18．技能入口") as {
  注册菲尼克斯尔技能结构: (this: void) => void;
};
const { 初始化菲尼克斯尔永恒冰核与导管 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.05．永恒冰核与导管") as {
  初始化菲尼克斯尔永恒冰核与导管: (this: void, context: any) => void;
};
const { 释放菲尼克斯尔炽羽散射 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.06．炽羽散射") as {
  释放菲尼克斯尔炽羽散射: (this: void, context: any, target?: any) => void;
};
const { 释放菲尼克斯尔熔岩吐息 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.07．熔岩吐息") as {
  释放菲尼克斯尔熔岩吐息: (this: void, context: any, target?: any) => void;
};
const { 释放菲尼克斯尔凤凰漩涡 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.08．凤凰漩涡") as {
  释放菲尼克斯尔凤凰漩涡: (this: void, context: any, target?: any) => void;
};
const { 触发菲尼克斯尔P1转场 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.09．浴火重生准备") as {
  触发菲尼克斯尔P1转场: (this: void, context: any) => void;
};
const { 切换菲尼克斯尔第二形态 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.04．双形态转换") as {
  切换菲尼克斯尔第二形态: (this: void, context: any) => void;
};
const { 释放菲尼克斯尔骸骨弹幕 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.11．骸骨弹幕") as {
  释放菲尼克斯尔骸骨弹幕: (this: void, context: any) => void;
};
const { 释放菲尼克斯尔怨火链接 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.12．怨火链接") as {
  释放菲尼克斯尔怨火链接: (this: void, context: any) => void;
};
const { 释放菲尼克斯尔凤凰挽歌 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.13．凤凰挽歌") as {
  释放菲尼克斯尔凤凰挽歌: (this: void, context: any) => void;
};
const { 结算菲尼克斯尔元素爆发 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.14．元素爆发") as {
  结算菲尼克斯尔元素爆发: (this: void, context: any) => void;
};
const { 触发菲尼克斯尔怨火核心暴露 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.15．怨火核心暴露") as {
  触发菲尼克斯尔怨火核心暴露: (this: void, context: any) => void;
};
const { 触发菲尼克斯尔永恒轮回 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.16．永恒轮回") as {
  触发菲尼克斯尔永恒轮回: (this: void, context: any) => void;
};
const { 添加元素层数 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.06．双重凤凰菲尼克斯尔.19．公共工具") as {
