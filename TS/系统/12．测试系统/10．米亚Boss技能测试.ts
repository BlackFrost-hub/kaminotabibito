...
const { 获取或创建米亚上下文, 注册米亚运行时 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.03．运行时上下文") as {
  获取或创建米亚上下文: (this: void, boss: any) => any;
  注册米亚运行时: (this: void) => void;
};
const { 给单位添加米亚腐化层数 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.03．运行时上下文") as {
  给单位添加米亚腐化层数: (this: void, context: any, 单位: any, 层数: number, 原因: string) => number;
};
const { 注册米亚技能结构 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.16．技能入口") as {
  注册米亚技能结构: (this: void) => void;
};
const { 释放米亚腐化爪击 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.05．腐化爪击") as {
  释放米亚腐化爪击: (this: void, context: any, target?: any) => void;
};
const { 释放米亚污水喷吐 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.06．污水喷吐") as {
  释放米亚污水喷吐: (this: void, context: any) => void;
};
const { 尝试触发米亚灵猫分身 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.07．灵猫分身") as {
  尝试触发米亚灵猫分身: (this: void, context: any) => void;
};
const { 刷新米亚污染标记 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.08．污染标记") as {
  刷新米亚污染标记: (this: void, context: any, nowMs: number) => void;
};
const { 尝试触发米亚污染脉冲 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.09．污染脉冲") as {
  尝试触发米亚污染脉冲: (this: void, context: any, nowMs: number) => void;
};
const { 尝试触发米亚污水柱爆发 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.10．污水柱爆发") as {
  尝试触发米亚污水柱爆发: (this: void, context: any, nowMs: number) => void;
};
const { 尝试触发米亚腐化转移 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.11．腐化转移") as {
  尝试触发米亚腐化转移: (this: void, context: any, nowMs: number) => void;
};
const { 刷新米亚平台超载惩罚 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.12．平台超载惩罚") as {
  刷新米亚平台超载惩罚: (this: void, context: any, nowMs: number) => void;
};
const { 刷新米亚腐化黏液涂层 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.13．腐化黏液涂层") as {
  刷新米亚腐化黏液涂层: (this: void, context: any, nowMs: number) => void;
};
const { 尝试触发米亚终极污染 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.14．终极污染") as {
...
const {
  ...
  设置米亚场地配置,
  清理米亚安全域矩形组,
} = require("系统.03．技能系统.05．单位技能.03．Boss技能.04．污染之猫米亚.01．场地配置") as {
  米亚默认平台中心配置: any;
  米亚默认安全域配置表: any[];
