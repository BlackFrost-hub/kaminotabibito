...
const { 获取或创建巴尔扎罗斯上下文, 注册巴尔扎罗斯运行时 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.03．运行时上下文") as {
  获取或创建巴尔扎罗斯上下文: (this: void, boss: any) => any;
  注册巴尔扎罗斯运行时: (this: void) => void;
};
const { 注册巴尔扎罗斯技能结构 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.15．技能入口") as {
  注册巴尔扎罗斯技能结构: (this: void) => void;
};
const { 初始化巴尔扎罗斯熔核封印与护卫机制 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.04．熔核封印与护卫机制") as {
  初始化巴尔扎罗斯熔核封印与护卫机制: (this: void, context: any) => void;
};
const { 初始化巴尔扎罗斯格鲁姆技能 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.01．护卫A格鲁姆.index") as {
  初始化巴尔扎罗斯格鲁姆技能: (this: void, context: any) => void;
};
const { 初始化巴尔扎罗斯塞拉技能 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.02．护卫B塞拉.index") as {
  初始化巴尔扎罗斯塞拉技能: (this: void, context: any) => void;
};
const { 初始化巴尔扎罗斯地核召唤节点, 释放巴尔扎罗斯地核召唤 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.11．地核召唤") as {
  初始化巴尔扎罗斯地核召唤节点: (this: void, context: any) => void;
  释放巴尔扎罗斯地核召唤: (this: void, context: any) => void;
};
const { 初始化巴尔扎罗斯熔岩护盾节点 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.12．熔岩护盾") as {
  初始化巴尔扎罗斯熔岩护盾节点: (this: void, context: any) => void;
};
const { 初始化巴尔扎罗斯末日熔爆节点, 释放巴尔扎罗斯末日熔爆 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.13．末日熔爆") as {
  初始化巴尔扎罗斯末日熔爆节点: (this: void, context: any) => void;
  释放巴尔扎罗斯末日熔爆: (this: void, context: any) => void;
};
const { 释放巴尔扎罗斯恶魔咆哮波 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.07．恶魔咆哮波") as {
  释放巴尔扎罗斯恶魔咆哮波: (this: void, context: any) => void;
};
const { 释放巴尔扎罗斯王者天罚 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.08．王者天罚") as {
  释放巴尔扎罗斯王者天罚: (this: void, context: any) => void;
};
const { 释放巴尔扎罗斯熔岩喷发 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.09．熔岩喷发") as {
  释放巴尔扎罗斯熔岩喷发: (this: void, context: any) => void;
};
const { 释放巴尔扎罗斯火焰锁链 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.10．火焰锁链") as {
  释放巴尔扎罗斯火焰锁链: (this: void, context: any) => void;
};
const { 释放格鲁姆重锤, 释放格鲁姆火径 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.01．护卫A格鲁姆.index") as {
  释放格鲁姆重锤: (this: void, context: any, target: any) => void;
  释放格鲁姆火径: (this: void, context: any, target: any) => void;
};
const { 释放冰焰双星, 释放绝对零度领域, 切换塞拉形态 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.02．护卫B塞拉.index") as {
...
const { 巴尔扎罗斯战斗区域配置, 巴尔扎罗斯固定安全区配置表 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.01．场地配置") as {
  巴尔扎罗斯战斗区域配置: any;
  巴尔扎罗斯固定安全区配置表: any[];
};
const { 巴尔扎罗斯护卫配置 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.05．熔岩恶魔王巴尔扎罗斯.02．数值与表现配置") as {
  巴尔扎罗斯护卫配置: any;
};
