...
const { 获取或创建菲利斯上下文 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.01．运行时上下文") as {
  获取或创建菲利斯上下文: (this: void, boss: any) => any;
};
const { 注册菲利斯被动效果 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.10．被动效果") as {
  注册菲利斯被动效果: (this: void) => void;
};
const { 释放菲利斯剑魂杀 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.04．剑魂杀") as {
  释放菲利斯剑魂杀: (this: void, context: any) => void;
};
const { 释放菲利斯剑气灵斩 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.05．剑气灵斩") as {
  释放菲利斯剑气灵斩: (this: void, context: any) => void;
};
const { 释放菲利斯全力封印斩 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.06．全力封印斩") as {
  释放菲利斯全力封印斩: (this: void, context: any) => void;
};
const { 释放菲利斯异形化 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.08．菲利斯.07．异形化") as {
  释放菲利斯异形化: (this: void, context: any) => void;
};

const { 获取或创建里科特上下文 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.01．运行时上下文") as {
  获取或创建里科特上下文: (this: void, boss: any) => any;
};
const { 注册里科特被动效果 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.12．被动效果") as {
  注册里科特被动效果: (this: void) => void;
};
const { 释放里科特四重风刃 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.04．四重风刃") as {
  释放里科特四重风刃: (this: void, context: any) => void;
};
const { 释放里科特追击风刃 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.05．追击风刃") as {
  释放里科特追击风刃: (this: void, context: any) => void;
};
const { 释放里科特湮灭之炮 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.07．湮灭之炮") as {
  释放里科特湮灭之炮: (this: void, context: any) => void;
};
const { 释放里科特湮灭之风 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.08．湮灭之风") as {
  释放里科特湮灭之风: (this: void, context: any) => void;
};
const { 释放里科特破魔反击 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.09．里科特.09．破魔反击") as {
  释放里科特破魔反击: (this: void, context: any) => void;
};

const { 获取或创建卡瑟拉上下文 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.01．运行时上下文") as {
  获取或创建卡瑟拉上下文: (this: void, boss: any) => any;
};
const { 注册卡瑟拉被动效果 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.13．被动效果") as {
  注册卡瑟拉被动效果: (this: void) => void;
};
const { 释放卡瑟拉深渊召唤 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.06．深渊召唤") as {
  释放卡瑟拉深渊召唤: (this: void, context: any) => void;
};
const { 释放卡瑟拉深海涡流 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.03．深海涡流") as {
  释放卡瑟拉深海涡流: (this: void, context: any) => void;
};
const { 释放卡瑟拉触手鞭笞 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.04．触手鞭笞") as {
  释放卡瑟拉触手鞭笞: (this: void, context: any) => void;
};
const { 释放卡瑟拉墨汁喷吐 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.05．墨汁喷吐") as {
  释放卡瑟拉墨汁喷吐: (this: void, context: any) => void;
};
const { 释放卡瑟拉高压水炮 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.07．高压水炮") as {
  释放卡瑟拉高压水炮: (this: void, context: any) => void;
};
const { 尝试触发卡瑟拉触手解放 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.08．触手解放") as {
  尝试触发卡瑟拉触手解放: (this: void, context: any) => void;
};
const { 尝试释放卡瑟拉共生电击 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.10．深渊巨鱿卡瑟拉.09．共生电击") as {
  尝试释放卡瑟拉共生电击: (this: void, context: any, nowMs: number) => void;
};

const { 获取或创建莫尔特斯上下文 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.01．运行时上下文") as {
  获取或创建莫尔特斯上下文: (this: void, boss: any) => any;
};
const { 注册莫尔特斯被动效果 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.15．被动效果") as {
  注册莫尔特斯被动效果: (this: void) => void;
};
const { 释放莫尔特斯腐朽根须穿刺 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.04．腐朽根须穿刺") as {
  释放莫尔特斯腐朽根须穿刺: (this: void, context: any) => void;
};
const { 释放莫尔特斯腐败孢子云 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.05．腐败孢子云") as {
  释放莫尔特斯腐败孢子云: (this: void, context: any) => void;
};
const { 释放莫尔特斯扭曲荆棘鞭笞 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.06．扭曲荆棘鞭笞") as {
  释放莫尔特斯扭曲荆棘鞭笞: (this: void, context: any) => void;
};
const { 释放莫尔特斯腐败之种 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.07．腐败之种") as {
  释放莫尔特斯腐败之种: (this: void, context: any) => void;
};
const { 尝试触发莫尔特斯根系觉醒 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.08．根系觉醒") as {
  尝试触发莫尔特斯根系觉醒: (this: void, context: any) => void;
};
const { 尝试触发莫尔特斯腐朽领域 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.09．腐朽领域") as {
  尝试触发莫尔特斯腐朽领域: (this: void, context: any) => void;
};
const { 尝试释放莫尔特斯共生腐朽虫群 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.10．共生腐朽虫群") as {
  尝试释放莫尔特斯共生腐朽虫群: (this: void, context: any, nowMs: number) => void;
};
const { 释放莫尔特斯古木悲鸣 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.11．古木之蚀莫尔特斯.11．古木悲鸣") as {
  释放莫尔特斯古木悲鸣: (this: void, context: any) => void;
};

const { 获取或创建影骨莫特斯上下文 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.01．运行时上下文") as {
  获取或创建影骨莫特斯上下文: (this: void, boss: any) => any;
};
const { 注册影骨莫特斯被动效果 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.10．被动效果") as {
  注册影骨莫特斯被动效果: (this: void) => void;
};
const { 释放影骨暗影禁锢 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.05．暗影禁锢") as {
  释放影骨暗影禁锢: (this: void, context: any, target: any) => void;
};
const { 释放影骨阴影穿梭 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.03．阴影穿梭") as {
  释放影骨阴影穿梭: (this: void, context: any) => void;
};
const { 释放影骨骸骨召唤 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.04．骸骨召唤") as {
  释放影骨骸骨召唤: (this: void, context: any) => void;
};
const { 释放影骨幽影爆发 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.06．幽影爆发") as {
  释放影骨幽影爆发: (this: void, context: any) => void;
};
const { 释放影骨盗贼遗产 } = require("系统.03．技能系统.05．单位技能.03．Boss技能.12．影骨莫特斯.07．盗贼的遗产") as {
