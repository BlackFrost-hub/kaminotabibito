...
import { BossAI配置表 } from "./01．BossAI配置表";
import { 杂鱼AI配置表 } from "./02．杂鱼AI配置表";
import { 精英AI配置表 } from "./03．精英AI配置表";
import { 英雄BossAI配置表 } from "./04．英雄BossAI配置表";
import { 异界BossAI配置表 } from "./05．异界BossAI配置表";
