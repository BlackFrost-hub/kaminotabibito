...
function 写入整数属性(this: void, unit: any, 属性名: string, 值: number | undefined): void {
  if (值 == null) return;
  YDUserDataSetSafe("unit", unit, 属性名, "integer", 值);
}

function 写入实数属性(this: void, unit: any, 属性名: string, 值: number | undefined): void {
  if (值 == null) return;
  YDUserDataSetSafe("unit", unit, 属性名, "real", 值);
}

function 写入布尔属性(this: void, unit: any, 属性名: string, 值: boolean | undefined): void {
  if (值 == null) return;
