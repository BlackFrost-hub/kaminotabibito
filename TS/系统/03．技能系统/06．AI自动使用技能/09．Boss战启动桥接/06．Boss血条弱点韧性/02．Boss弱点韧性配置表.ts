...
import type { 战斗启动属性配置 } from "../03．战斗启动属性/00．配置类型";
import { Boss弱点反馈默认配置, Boss弱点候选列表, Boss弱点YD字段 } from "./01．常量定义";
import { Boss战斗启动属性配置表 } from "../03．战斗启动属性/01．Boss战斗启动属性配置表";
import { 英雄Boss战斗启动属性配置表 } from "../03．战斗启动属性/02．英雄Boss战斗启动属性配置表";
import { 异界Boss战斗启动属性配置表 } from "../03．战斗启动属性/03．异界Boss战斗启动属性配置表";
