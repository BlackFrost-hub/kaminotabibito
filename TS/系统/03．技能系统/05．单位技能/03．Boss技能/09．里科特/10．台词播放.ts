...
import { 里科特单位技能配置, 里科特台词类型 } from "./00．配置";
...
export function 播放里科特台词(this: void, boss: any, 类型: 里科特台词类型, index?: number): void {
  播放Boss台词广播(boss, 里科特单位技能配置.台词, 类型, 里科特单位技能配置.广播持续时间Ms, index);
}
