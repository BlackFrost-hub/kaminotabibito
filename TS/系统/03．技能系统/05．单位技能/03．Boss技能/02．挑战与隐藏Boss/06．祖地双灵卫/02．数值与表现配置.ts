...
export const 祖地双灵卫数值与表现配置 = {
  ...
  表现资源: {
    ...
    月纹缚魂: {
      月纹地面特效路径: 'Common\\Effect\\Form\\Debuff\\SpiritGuardMoonBind.mdx',
      禁锢生效特效路径: 'Common\\Effect\\Form\\RiseFall\\AronkosSoulLightPillar.mdx',
    },
    封门校验: {
      半场灵魂潮特效路径: 'Common\\Effect\\Form\\Line\\DeathWave.mdx',
      誓盾阻挡特效路径: 'Common\\Effect\\Form\\Explosion\\AlbedoDarkGoldBarrierBreak.mdx',
    },
    断誓践踏: {
      践踏落地特效路径: 'Common\\Effect\\Form\\Explosion\\dustwave.mdx',
      短时魂裂特效路径: 'Common\\Effect\\Form\\Explosion\\AronkosGraveDustWhirl.mdx',
      镇魂压制特效路径: 'Common\\Effect\\Form\\MagicCircle\\SpiritGuardSoulSeal.mdx',
    },
    裂魂坠斩: {
      重斩拖尾特效路径: 'Common\\Effect\\Form\\Line\\AronkosSoulSlashVolley.mdx',
      扇形落地特效路径: 'Common\\Effect\\Form\\Explosion\\dustwave.mdx',
      直线余震特效路径: 'Common\\Effect\\Form\\Line\\BansheeGrayShockwave.mdx',
    },
    失名祷潮: {
    ...
    双钥净化: {
      节点污染外壳特效路径: 'Common\\Effect\\Form\\Shield\\YellowOrbShield.mdx',
      节点破壳特效路径: 'Common\\Effect\\Form\\Explosion\\CorruptionShieldBreak.mdx',
      节点校准特效路径: 'Common\\Effect\\Form\\MagicCircle\\SpiritGuardSoulSeal.mdx',
      节点净化完成特效路径: 'Common\\Effect\\Form\\RiseFall\\AronkosSoulReleasePillar.mdx',
    },
    封门误判: {
      入侵区域覆盖特效路径: 'Common\\Effect\\Form\\Aura\\AronkosGraveSoulField.mdx',
      月白安全通道特效路径: 'Common\\Effect\\Form\\Line\\AronkosSoulSlashTrail.mdx',
      封门中心砸击特效路径: 'Common\\Effect\\Form\\Explosion\\dustwave.mdx',
