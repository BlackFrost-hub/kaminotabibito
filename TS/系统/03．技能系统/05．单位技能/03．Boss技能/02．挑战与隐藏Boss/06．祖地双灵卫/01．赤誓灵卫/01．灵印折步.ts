...
export function 创建赤誓镇魂印(this: void, context: 祖地双灵卫运行时上下文, x: number, y: number): void {
  ...
  for (let i = 0; i < heroes.length; i++) {
    ...
    造成AOE技能伤害({ 来源: boss, 目标: hit, 伤害: damage, attack: false, ranged: false, attackType: ATTACK_TYPE_MAGIC, 伤害类型: DAMAGE_TYPE_MAGIC, weaponType: WEAPON_TYPE_WHOKNOWS, 来源类型: 'Boss技能', 标签: '祖地双灵卫·灵印折步镇魂印' });
  }
