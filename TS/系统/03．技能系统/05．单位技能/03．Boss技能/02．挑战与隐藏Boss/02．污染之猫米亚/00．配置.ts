...
export const 米亚单位技能配置 = {
  ...
  配音台词: {
    ...
    转阶段2: [
      "[sickly sweet] Deeper now... into the pool. [possessive whisper] Let the clean water learn my color.",
      "[torn with pain] The water remembers pain. [furious curse] So will you!",
    ],
    转阶段3: [
      "[frightened whisper] Don't wash it away... don't wash me away...",
      "[pained delight] It spills from me... all of it. [obsessive] Let it cling to you.",
    ],
    腐化爪击: [
      "[playful whisper] I see you, little one... so far away.",
      "[playful menace] The scar will stay.",
    ],
    污水喷吐: [
      "[sickly breath] My throat is full... [warning] move, if you still want to stay clean.",
      "[sickly sweet] Drink it... [darkly amused] and you will never be clean again.",
    ],
    灵猫分身: [
    ...
    污染标记: [
      "[obsessive] You are the filthiest... [sickly sweet] and the sweetest.",
      "[softly possessive] Don't wash it off. [intimate whisper] I like that smell.",
      "[pained delight] Broken already? [hungry] Then I'll drink you clean.",
    ],
    污染脉冲: [
    ...
    污水柱爆发: [
      "[playful whisper] The ground is laughing.",
      "[soft warning] Don't stand there.",
      "[quick playful] Pop!",
      "[sickly sweet] The bubble burst, but the mud remains.",
    ],
    腐化转移: [
      "[obsessive whisper] Not safe. Not clean. [cold] Not anymore.",
      "[obsessive] This place, too... must turn black.",
    ],
    平台超载惩罚: [
      "[teasing menace] All huddled together? [delighted] You'll rot even faster.",
      "[softly amused] Don't push away. [possessive whisper] I like you close together.",
    ],
    腐化黏液涂层: [
      "[softly] Come close, and you'll stick.",
      "[pained playful] My claws touched the mud.",
      "[obsessive] Every inch of you should smell like me.",
      "[pained] It hurts... [excited whisper] but the filthy water flows faster.",
    ],
    终极污染: [
    ...
    死亡: [
      "[fading] The water... [peaceful] is quiet at last...",
    ],
  },
  配音资源: {
    开场: [
      "Sound\\Boss\\Mia\\Voice\\mia_opening_purity_burns_ilinca_02_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_opening_no_hurt_anymore_ilinca_02_v3.mp3",
    ],
    转阶段2: [
      "Sound\\Boss\\Mia\\Voice\\mia_phase2_pool_learn_color_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_phase2_water_remembers_pain_ilinca_02_v3.mp3",
    ],
    转阶段3: [
      "Sound\\Boss\\Mia\\Voice\\mia_phase3_dont_wash_me_away_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_phase3_spills_cling_ilinca_01_v3.mp3",
    ],
    腐化爪击: [
      "Sound\\Boss\\Mia\\Voice\\mia_claw_far_target_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_claw_scar_stays_ilinca_01_v3.mp3",
    ],
    污水喷吐: [
      "Sound\\Boss\\Mia\\Voice\\mia_spit_throat_full_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_spit_never_clean_ilinca_01_v3.mp3",
    ],
    灵猫分身: [
    ...
    污染标记: [
      "Sound\\Boss\\Mia\\Voice\\mia_mark_filthiest_sweetest_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_mark_like_smell_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_mark_drink_clean_ilinca_01_v3.mp3",
    ],
    污染脉冲: [
    ...
    污水柱爆发: [
      "Sound\\Boss\\Mia\\Voice\\mia_water_column_ground_laughing_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_water_column_dont_stand_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_water_column_pop_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_water_column_mud_remains_ilinca_01_v3.mp3",
    ],
    腐化转移: [
      "Sound\\Boss\\Mia\\Voice\\mia_transfer_not_safe_clean_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_transfer_place_turn_black_ilinca_01_v3.mp3",
    ],
    平台超载惩罚: [
      "Sound\\Boss\\Mia\\Voice\\mia_overload_rot_faster_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_overload_close_together_ilinca_01_v3.mp3",
    ],
    腐化黏液涂层: [
      "Sound\\Boss\\Mia\\Voice\\mia_slime_coating_come_close_stick_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_slime_coating_claws_mud_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_slime_coating_smell_like_me_ilinca_01_v3.mp3",
      "Sound\\Boss\\Mia\\Voice\\mia_slime_coating_filthy_water_flows_ilinca_01_v3.mp3",
    ],
    终极污染: [
    ...
    死亡: [
      "Sound\\Boss\\Mia\\Voice\\mia_defeat_water_quiet_ilinca_02_v3.mp3",
    ],
  },
} as const;
