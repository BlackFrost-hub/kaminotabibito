...
export const 米亚单位技能配置 = {
  ...
  台词: {
    ...
    转阶段2: [
      "米亚跳入中央水池，战斗进入P2；污染波即将开始。（站上白色安全平台，避开红色扩散区域。）",
      "P2水池污染已启动，平台是安全位置。（分散站位，留意红色扩散波。）",
    ],
    转阶段3: [
      "米亚进入P3，腐化黏液涂层生效。（近战攻击会叠加腐化感染，非必要不要贴身。）",
      "P3腐化黏液每10秒向全场扩散1层腐化感染。（保持分散并及时降低腐化层数。）",
    ],
    腐化爪击: [
      "米亚锁定目标并跃击落点，落地造成当前攻击力×300%伤害并施加1层腐化感染。（离开红色扑击路径和落点。）",
      "落地点将留下持续10秒、半径180码的腐化爪痕，每秒叠加1层腐化感染。（立即离开爪痕区域。）",
    ],
    污水喷吐: [
      "米亚将在1秒后向正面喷吐1.5秒，覆盖900码、90°扇形。（离开米亚正面，站到侧后方。）",
      "喷吐首次命中会额外施加2层腐化感染，结束后留下持续5秒、半径220码的污水区。（离开红色扇形和污水区。）",
    ],
    灵猫分身: [
    ...
    污染标记: [
      "污染标记锁定当前腐化感染层数最高的玩家，米亚的腐化爪击和污水喷吐对其伤害提高20%。（被标记者注意躲避技能。）",
      "污染标记每1秒重新判定并持续1.5秒；被标记者承受米亚腐化爪击和污水喷吐的伤害提高20%。（降低腐化层数，避免持续被标记。）",
      "污染标记目标已死亡，米亚恢复自身最大生命值10%。（控制腐化层数，避免被标记者倒下。）",
    ],
    污染脉冲: [
    ...
    污水柱爆发: [
      "污水柱锁定随机玩家位置，1-2人模式1个、3-4人模式2个；2秒后在预警圈内爆发。（离开绿色预警圈。）",
      "污水柱还有0.5秒爆发，爆发半径180码。（立即离开预警圈。）",
      "污水柱爆发，半径180码内造成当前攻击力×90%+目标最大生命值×2%的伤害并增加2层腐化感染。（离开爆发圈。）",
      "爆发后留下半径220码、持续15秒的腐化水坑；每秒造成当前攻击力×8%+目标最大生命值×0.4%的伤害并增加1层腐化感染。（离开水坑。）",
    ],
    腐化转移: [
      "米亚将在1.5秒后跳向目标平台并使其污染10秒。（离开红色预警平台，转移到其他平台。）",
      "目标平台已被污染10秒，平台内每秒叠加2层腐化感染。（立即离开该平台。）",
    ],
    平台超载惩罚: [
      "平台超载：1-2人模式超过1人、3-4人模式超过2人时，每秒增加1层腐化感染；腐化爪击、污水喷吐、污染脉冲和污水柱爆发对你的伤害提高30%。（分散到未超载平台。）",
      "平台仍在超载：每秒增加1层腐化感染；腐化爪击、污水喷吐、污染脉冲和污水柱爆发对你的伤害提高30%。（保持人数不超过平台容量。）",
    ],
    腐化黏液涂层: [
      "腐化黏液涂层已覆盖米亚：米亚受到的所有伤害提高20%。（输出时避免不必要的近战攻击。）",
      "近战反噬：攻击米亚的玩家增加1层腐化感染，同一玩家5秒内不会重复触发。（远离米亚或改用远程攻击。）",
      "米亚每10秒使所有有效玩家增加1层腐化感染。（保持分散并及时降低腐化层数。）",
      "腐化黏液使米亚受到的所有伤害提高20%。（保持输出，但避免近战触发反噬。）",
    ],
    终极污染: [
