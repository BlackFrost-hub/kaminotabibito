...
export const 菲利斯单位技能配置 = {
  ...
  主动技能提示: [
    { 技能ID: "A0LP", 提示: "剑魂杀", 扩展提示: "蓄力后释放剑气狼，命中后在终点化为小狼或大狼追击玩家。" },
    { 技能ID: "A0LR", 提示: "剑气灵斩", 扩展提示: "向前方劈出剑气并留下侵蚀区域，持续伤害并汲取魔法。" },
    { 技能ID: "A0LS", 提示: "全力封印斩", 扩展提示: "锁定 QWER 全冷却玩家，扣除魔法并眩晕。" },
    { 技能ID: "A0LT", 提示: "异形化", 扩展提示: "消耗满魔法进入强化形态，刷新剑气灵斩并牵引附近玩家。" },
  ],
  广播持续时间Ms: 4200,
  配音裁断距离: 4000,
  配音生成配置: {
