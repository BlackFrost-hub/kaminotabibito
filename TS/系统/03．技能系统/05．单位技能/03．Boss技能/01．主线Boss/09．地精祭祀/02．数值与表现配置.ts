...
export const 地精祭祀技能配置 = {
  ...
  血爆: {
    ...
    目标最大生命比例: 0.2,
    眩晕秒: 0.8,
    预警特效: { 路径: 'Abilities\\Spells\\Orc\\CommandAura\\CommandAuraTarget.mdl', Z: 200, 朝向: 270, 缩放: 2.5, 动画速度: 1, 持续秒: 1 },
    爆炸特效: { 路径: 'Objects\\Spawnmodels\\Undead\\UDeathMedium\\UDeath.mdl', Z: 200, 朝向: 270, 缩放: 1.33, 动画速度: 1, 持续秒: 2 },
  ...
  毒蕴: {
    ...
    酸性基础伤害: 300,
    酸性每难度N伤害: 150,
    预警特效: { 路径: 'Objects\\Spawnmodels\\NightElf\\EntBirthTarget\\EntBirthTarget.mdl', Z: 50, 朝向: 270, 缩放: 1, 动画速度: 1, 持续秒: 1 },
    爆炸特效: { 路径: 'Objects\\Spawnmodels\\Undead\\UDeathMedium\\UDeath.mdl', Z: 200, 朝向: 270, 缩放: 1.33, 动画速度: 1, 持续秒: 2 },
