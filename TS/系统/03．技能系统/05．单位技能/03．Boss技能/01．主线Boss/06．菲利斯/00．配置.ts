...
export const 菲利斯单位技能配置 = {
  ...
  主动技能提示: [
    { 技能ID: "AT15", 提示: "剑魂杀", 扩展提示: "1.5秒蓄力后释放2条剑魂路径；飞行1.4秒，命中造成菲利斯当前攻击力×400%，终点按本次总命中次数生成小狼或大狼。" },
    { 技能ID: "BT15", 提示: "剑气灵斩", 扩展提示: "基础冷却12秒；菲利斯低于50%生命时冷却缩短50%，变为6秒。释放1500码剑气；初始命中为当前攻击力×200%+目标最大生命值10%，残留240秒，每秒追加当前攻击力×50%+目标最大生命值5%并扣当前魔法10%。" },
    { 技能ID: "CT15", 提示: "全力封印斩", 扩展提示: "1秒蓄力，标记QWER全在冷却的玩家；扣当前魔法值35%+难度×5%，眩晕0.3+难度×0.2秒，并瞬移到随机目标身边96码。" },
  ],
  广播持续时间Ms: 4200,
  配音裁断距离: 4000,
  配音生成配置: {
