...
export const 菲尼克斯尔单位技能配置 = {
  ...
  主动技能提示: [
    { 技能ID: "A0F8", 提示: "炽羽散射", 扩展提示: "读条0.7秒，14枚羽毛锁定目标周围80~520码落点，落点半径150；飞行0.75秒后造成当前攻击力×95%+目标最大生命值2%，并生成半径180、持续5秒燃烧区，每秒造成目标最大生命值0.8%。（离开落点和燃烧区。）" },
    { 技能ID: "A0F7", 提示: "熔岩吐息", 扩展提示: "预警0.45秒后持续2.5秒，正面70°、半径720扇形每0.25秒结算一次；每次为（当前攻击力×45%+目标最大生命值1.2%）×50%，累计命中3次后减速25%持续2秒。（离开正面扇形。）" },
    { 技能ID: "A0F9", 提示: "凤凰漩涡", 扩展提示: "锁定目标当前位置预警2秒，生成半径420漩涡持续4秒；每0.5秒造成当前攻击力×35%+目标已损失生命值4%，并向中心牵引36码，中心140码内不再牵引。（离开锁定圆圈，别停留在漩涡内。）" },
  ],
  机制单位ID: {
    永恒冰核: "N0P0",
    能量导管: "N0P1",
