...
export const 树魔首领单位技能配置 = {
  ...
  主动技能提示: [
    ...
    { 技能ID: "AN06", 提示: "树魔图腾", 扩展提示: "吟唱0.8秒后按存活随从抽取图腾：巫医→静止陷阱（600码触发，0.75秒后全体眩晕8秒）、猎头者→生命陷阱（持续20秒、影响半径900码、每秒造成目标最大生命3%并降低治疗50%+难度×5%）、投掷者→爆炸陷阱（10秒、被摧毁0.5秒后全体承受当前生命50%+难度×1800魔法伤害）；多种随从按存活数量加权，无随从时随机。" },
  ],
  召唤物ID: {
    猎头者: "ohun",
    巫医: "odoc",
