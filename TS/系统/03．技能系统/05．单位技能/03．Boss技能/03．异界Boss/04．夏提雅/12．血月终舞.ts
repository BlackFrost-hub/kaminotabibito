  ...
  for (let i = 0; i < count; i++) {
    ...
    const barrage = 创建原生弹幕({
      ...
      on命中: function 夏提雅血月终舞扇区弹幕命中(this: void, target: any): void {
        ...
        造成AOE技能伤害({ 来源: boss, 目标: target, 伤害: damage, attack: false, ranged: true, attackType: ATTACK_TYPE_NORMAL, 伤害类型: 弹幕伤害类型, weaponType: WEAPON_TYPE_METAL_HEAVY_SLICE, 来源类型: 'Boss技能', 标签: '夏提雅·血月终舞-扇区弹幕' });
      },
    });
  ...
  stages.push(创建立即执行阶段(function 夏提雅血月终舞冲锋(this: void): void {
    ...
    开始冲锋(boss, {
      ...
      命中回调: function 夏提雅血月终舞冲锋命中(this: void, _source: any, hit: any): void {
        ...
        造成AOE技能伤害({ 来源: boss, 目标: hit, 伤害: damage, attack: false, ranged: false, attackType: ATTACK_TYPE_NORMAL, 伤害类型: DAMAGE_TYPE_ENHANCED, weaponType: WEAPON_TYPE_METAL_HEAVY_SLICE, 来源类型: 'Boss技能', 标签: '夏提雅·血月终舞-俯冲' });
      },
