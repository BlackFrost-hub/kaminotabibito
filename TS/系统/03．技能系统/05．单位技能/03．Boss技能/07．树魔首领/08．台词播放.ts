...
import { 树魔首领单位技能配置, 树魔首领台词类型 } from "./00．配置";
...
export function 播放树魔首领台词(this: void, boss: any, 类型: 树魔首领台词类型, index?: number): void {
  播放Boss台词广播(boss, 树魔首领单位技能配置.台词, 类型, 树魔首领单位技能配置.广播持续时间Ms, index);
}
