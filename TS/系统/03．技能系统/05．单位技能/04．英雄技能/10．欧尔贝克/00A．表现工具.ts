...
export function 播放欧尔贝克单位音效(this: void, unit: any, soundKey: string): void {
...
export function 播放欧尔贝克配置动作(this: void, unit: any, animationIndex: number, timeScale: number): void {
