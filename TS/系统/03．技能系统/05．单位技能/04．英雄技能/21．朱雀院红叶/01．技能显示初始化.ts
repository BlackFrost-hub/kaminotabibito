...
const 技能显示 = [
  { 技能ID: 朱雀院红叶技能配置.Q.技能ID, 名称: 朱雀院红叶技能配置.Q.名称, 图标: 朱雀院红叶技能配置.Q.图标, 说明: "向目标方向突进斩击，并开启短暂回身斩窗口。", 快捷键: "Q" },
  { 技能ID: 朱雀院红叶技能配置.W.技能ID, 名称: 朱雀院红叶技能配置.W.名称, 图标: 朱雀院红叶技能配置.W.图标, 说明: "展开正面招架窗口，成功后反击攻击来源。", 快捷键: "W" },
  { 技能ID: 朱雀院红叶技能配置.E.技能ID, 名称: 朱雀院红叶技能配置.E.名称, 图标: 朱雀院红叶技能配置.E.图标, 说明: "连续施展三段斩击，并留下可供技能读取的剑痕。", 快捷键: "E" },
  { 技能ID: 朱雀院红叶技能配置.R.技能ID, 名称: 朱雀院红叶技能配置.R.名称, 图标: 朱雀院红叶技能配置.R.图标, 说明: "蓄势后沿窄直线释放终式斩击。", 快捷键: "R" },
  { 技能ID: 朱雀院红叶技能配置.D.技能ID, 名称: 朱雀院红叶技能配置.D.名称, 图标: 朱雀院红叶技能配置.D.图标, 说明: "获得三次强化机会，用于强化后续技能。", 快捷键: "D" },
] as const;
