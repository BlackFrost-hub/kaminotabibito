...
function 释放E锚定魔法阵(this: void, _context: any, 施法者: any, 技能实例ID: number | undefined): void {
  ...
  const 预警缩放 = 塞莉亚克莱尔E配置.生效延迟秒 <= 0 ? 1 : 塞莉亚克莱尔表现子配置.E锚定阵.预警缩放系数;
  const 预警 = 创建点特效({
    模型路径: 塞莉亚克莱尔表现子配置.E锚定阵.模型路径,
    X: 中心X,
    Y: 中心Y,
    Z: 塞莉亚克莱尔表现子配置.E锚定阵.高度,
    缩放: 预警缩放 * 塞莉亚克莱尔E配置.区域半径 / 塞莉亚克莱尔表现子配置.E锚定阵.基准半径,
    持续秒: 塞莉亚克莱尔E配置.生效延迟秒,
  });
  void 预警;
  ...
  实例.登记延迟回调(addDelayedCallback(塞莉亚克莱尔E配置.生效延迟秒 * 1000, function E生效(this: void): void {
    ...
    数据.阵特效 = 创建点特效({
      ...
      Y: 中心Y,
      Z: 塞莉亚克莱尔表现子配置.E锚定阵.高度,
      缩放: 塞莉亚克莱尔E配置.区域半径 / 塞莉亚克莱尔表现子配置.E锚定阵.基准半径 * 塞莉亚克莱尔表现子配置.E锚定阵.基准缩放,
      持续秒: 塞莉亚克莱尔表现子配置.E锚定阵.持续秒,
    });
