...
export function 播放提米诺斯单位音效(this: void, unit: any, soundKey: string): void {
...
export function 播放提米诺斯配置动作(this: void, unit: any, animationIndex: number, timeScale: number): void {
