...
export const 塞拉斯技能配置 = {
  ...
  E: {
    ...
    // 属性提升：魔法伤害 = 10% + 3% × 技能等级（首次学习额外+10%基础）。
    // 由英雄技能成长系统（H014/A0JX）学习时写入玩家属性「魔法伤害」，
    // 伤害系统主计算流程 Step 8 统一加算，作用于塞拉斯全部魔法伤害。
  },
  ...
  R: {
    ...
    魔法穿透: "每次学习+1%，由英雄技能成长系统（H014/A0JY）写入玩家属性「魔法穿透」，伤害系统按魔抗×(1-穿透)结算",
