...
function R创建领域(
  ...
  const 区域 = 创建持续危险区域({
    ...
    on销毁: function R区域销毁(this: void): void {
      ...
      创建点特效({
        ...
        X: 中心X,
        Y: 中心Y,
        Z: 爱蜜莉雅R配置.表现.最终冰爆.高度,
        缩放: 半径 / 爱蜜莉雅R配置.表现.最终冰爆.基准半径 * 爱蜜莉雅R配置.表现.最终冰爆.基准缩放,
        持续秒: 爱蜜莉雅R配置.表现.最终冰爆.持续秒,
      });
      控制器.完成();
    },
  });
  ...
  const 领域主体特效 = 创建点特效({
    ...
    X: 中心X,
    Y: 中心Y,
    Z: 爱蜜莉雅R配置.表现.领域主体.高度,
    缩放: 半径 / 爱蜜莉雅R配置.表现.领域主体.基准半径 * 爱蜜莉雅R配置.表现.领域主体.基准缩放,
    持续秒: 爱蜜莉雅R配置.表现.领域主体.持续秒,
  });
    ...
    const 爆发ID = addDelayedCallback(爆发延迟 * 1000, function R冰晶爆发(this: void): void {
      ...
      if (移除结果 != null) {
        创建点特效({
          ...
          X: 移除结果.X,
          Y: 移除结果.Y,
          Z: 爱蜜莉雅R配置.表现.冰晶读取爆发.高度,
          缩放: 爱蜜莉雅R配置.表现.冰晶读取爆发.缩放,
          持续秒: 爱蜜莉雅R配置.表现.冰晶读取爆发.持续秒,
        });
        // 冰晶爆发伤害（冰晶点小范围实时快照）
  ...
  开始充能(施法者, {
    ...
    开始回调: function R蓄力开始(this: void, _单位: any, _充能ID: number): void {
      法阵特效 = 创建点特效({
        ...
        X: 中心X,
        Y: 中心Y,
        Z: 爱蜜莉雅R配置.表现.蓄力法阵.高度,
        缩放: 半径 / 爱蜜莉雅R配置.表现.蓄力法阵.基准半径 * 爱蜜莉雅R配置.表现.蓄力法阵.基准缩放,
        持续秒: 爱蜜莉雅R配置.表现.蓄力法阵.持续秒,
      });
    },
