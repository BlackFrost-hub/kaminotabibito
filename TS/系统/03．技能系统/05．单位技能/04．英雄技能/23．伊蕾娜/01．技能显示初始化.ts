...
const 技能显示 = [
  { 技能ID: 伊蕾娜技能配置.Q.技能ID, 名称: 伊蕾娜技能配置.Q.名称, 图标: 占位图标, 说明: 伊蕾娜技能配置.Q.说明, 快捷键: "Q" },
  { 技能ID: 伊蕾娜技能配置.W.技能ID, 名称: 伊蕾娜技能配置.W.名称, 图标: 占位图标, 说明: 伊蕾娜技能配置.W.说明, 快捷键: "W" },
  { 技能ID: 伊蕾娜技能配置.E.技能ID, 名称: 伊蕾娜技能配置.E.名称, 图标: 占位图标, 说明: 伊蕾娜技能配置.E.说明, 快捷键: "E" },
  { 技能ID: 伊蕾娜技能配置.R.技能ID, 名称: 伊蕾娜技能配置.R.名称, 图标: 占位图标, 说明: 伊蕾娜技能配置.R.说明, 快捷键: "R" },
  { 技能ID: 伊蕾娜技能配置.D.技能ID, 名称: 伊蕾娜技能配置.D.名称, 图标: 占位图标, 说明: 伊蕾娜技能配置.D.说明, 快捷键: "D" },
] as const;
