...
const 技能显示 = [
  { 技能ID: 伊蕾娜技能配置.Q.技能ID, 名称: 伊蕾娜技能配置.Q.名称, 图标: 占位图标, 说明: "发射追迹魔弹并记录风行见闻。", 快捷键: "Q" },
  { 技能ID: 伊蕾娜技能配置.W.技能ID, 名称: 伊蕾娜技能配置.W.名称, 图标: 占位图标, 说明: "展开镜界保护并记录镜界见闻，成功时偏折一次攻击。", 快捷键: "W" },
  { 技能ID: 伊蕾娜技能配置.E.技能ID, 名称: 伊蕾娜技能配置.E.名称, 图标: 占位图标, 说明: "骑乘扫帚调整位置并记录远行见闻。", 快捷键: "E" },
  { 技能ID: 伊蕾娜技能配置.R.技能ID, 名称: 伊蕾娜技能配置.R.名称, 图标: 占位图标, 说明: "蓄力展开回廊，读取至多三条见闻形成追加魔法。", 快捷键: "R" },
  { 技能ID: 伊蕾娜技能配置.D.技能ID, 名称: 伊蕾娜技能配置.D.名称, 图标: 占位图标, 说明: "切换下一次技能使用的即兴魔法变式。", 快捷键: "D" },
] as const;
