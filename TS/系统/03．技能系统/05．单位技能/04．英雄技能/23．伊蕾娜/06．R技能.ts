...
function 执行R完成结算(this: void, 施法者: any, 实例: 战斗技能实例控制器, 数据: R领域数据): void {
  ...
  // R 持续层：涡旋（上层）+ 地面星尘（底层），叠加于 R持续领域 之上不改原表现；随实例收束由篮子统一销毁
  if ((伊蕾娜表现配置.R持续涡旋.模型路径 as string) !== "") {
    实例.登记特效(创建点特效({
      模型路径: 伊蕾娜表现配置.R持续涡旋.模型路径,
      RGB: 伊蕾娜表现配置.R持续涡旋.RGB,
      X: 数据.中心X,
      Y: 数据.中心Y,
      Z: 伊蕾娜表现配置.R持续涡旋.高度,
      缩放: 伊蕾娜表现配置.R持续涡旋.缩放,
  ...
  if ((伊蕾娜表现配置.R持续星尘.模型路径 as string) !== "") {
    实例.登记特效(创建点特效({
      模型路径: 伊蕾娜表现配置.R持续星尘.模型路径,
      RGB: 伊蕾娜表现配置.R持续星尘.RGB,
      X: 数据.中心X,
      Y: 数据.中心Y,
      Z: 伊蕾娜表现配置.R持续星尘.高度,
      缩放: 伊蕾娜表现配置.R持续星尘.缩放,
