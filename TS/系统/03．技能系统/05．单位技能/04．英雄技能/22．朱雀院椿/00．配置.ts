...
export const 朱雀院椿技能配置 = {
  单位类型ID: "E0L2",
  Q: { 技能ID: "ATQ1", 名称: "居合·返（Q）", 图标: "ReplaceableTextures\\CommandButtons\\Tsubaki\\BTNTsubakiQ.blp", 快捷键: "Q", 冷却秒: 5, 魔耗百分比: 0.04, 说明: "技能说明：向目标方向施展居合斩；拥有回锋或反击准备时会改为返刃，二刀姿态还会追加交叉斩。|n伤害：基础斩造成攻击力90%的物理伤害。|n伤害范围：半径260、扇形60度|n冷却时间：5秒|n魔法消耗：最大魔法值的4%" },
  W: { 技能ID: "ATW1", 名称: "VF场·后之先（W）", 图标: "ReplaceableTextures\\CommandButtons\\Tsubaki\\BTNTsubakiW.blp", 快捷键: "W", 冷却秒: 10, 魔耗百分比: 0.055, 说明: "技能说明：展开正面VF招架场，成功招架时化解一次主要攻击并反击，未受击则以收刀斩结束。|n伤害：反击造成攻击力100%的物理伤害；未受击时释放收刀斩。|n防御范围：正面90度|n招架持续时间：0.6秒|n冷却时间：10秒|n魔法消耗：最大魔法值的5.5%" },
  E: { 技能ID: "ATE1", 名称: "刃道·间合（E）", 图标: "ReplaceableTextures\\CommandButtons\\Tsubaki\\BTNTsubakiE.blp", 快捷键: "E", 冷却秒: 9, 魔耗百分比: 0.065, 说明: "技能说明：向目标方向位移，在终点施展横斩；二刀姿态会追加横斩，并建立决斗距离。|n伤害：横斩造成攻击力90%的物理伤害。|n施法距离：位移300距离|n伤害范围：半径240、扇形90度|n决斗距离持续时间：2.5秒|n冷却时间：9秒|n魔法消耗：最大魔法值的6.5%" },
  R: { 技能ID: "ATR1", 名称: "炎姬·黄泉凤凰（R）", 图标: "ReplaceableTextures\\CommandButtons\\Tsubaki\\BTNTsubakiR.blp", 快捷键: "R", 冷却秒: 70, 魔耗百分比: 0.14, 说明: "技能说明：蓄力后沿目标方向释放决斗终式，一刀姿态追加反击斩，二刀姿态追加交错斩。|n伤害：主斩造成攻击力200%的物理伤害。|n施法距离：700|n伤害范围：目标方向直线|n蓄力时间：0.7秒|n冷却时间：70秒|n魔法消耗：最大魔法值的14%" },
  D: { 技能ID: "ATD1", 名称: "浴火鸟·二刀解放（D）", 图标: "ReplaceableTextures\\CommandButtons\\Tsubaki\\BTNTsubakiD.blp", 快捷键: "D", 冷却秒: 8, 魔耗百分比: 0.025, 说明: "技能说明：切换一刀守势与二刀攻势，二刀状态会消耗VF，VF归零后自动回到一刀守势。|n伤害：本技能不直接造成伤害。|n技能类型：天赋技能，初始获得|n状态持续时间：12秒|nVF消耗：每秒4点|n冷却时间：8秒|n魔法消耗：最大魔法值的2.5%" },
} as const;
