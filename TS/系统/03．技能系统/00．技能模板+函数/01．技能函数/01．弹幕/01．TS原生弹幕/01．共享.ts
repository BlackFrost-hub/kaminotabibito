...
// 弹幕单位使用 JASS 原生染色；部分运行环境没有 DzSetUnitVertexColor JAPI。
export const SetUnitVertexColor = jass.SetUnitVertexColor as (unit: any, r: number, g: number, b: number, a: number) => void;
