...
let 单位倒计时Stes触发器: any | null = null;

function 读取单位类型参数(this: void, name: string): string | number | undefined {
...
function 读取单位倒计时事件参数(this: void): any {
  const 参数: any = {
...
export function 根据Stes事件启动单位倒计时(this: void): number {
  try {
...
function on单位倒计时Stes事件Action(this: void): void {
  根据Stes事件启动单位倒计时();
}
...
function onRetryRegisterUnitTimerStes(this: void): void {
...
function tryRegisterUnitTimerStes(this: void): void {
...
export function 注册单位倒计时Stes桥接(this: void): void {
  tryRegisterUnitTimerStes();
}
