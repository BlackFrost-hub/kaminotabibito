...
export const 四Boss战利品装备名 = {
  亡冥归魂巨剑: "亡冥归魂巨剑", 最后阵地重铠: "最后阵地重铠", 亡者凝视面甲: "亡者凝视面甲",
  英灵送葬法典: "英灵送葬法典", 旧誓残响徽记: "旧誓残响徽记", 安魂守墓灯: "安魂守墓灯",
  赤誓断界剑: "赤誓断界剑", 裂誓战躯重铠: "裂誓战躯重铠", 苍影校魂法典: "苍影校魂法典",
  无面记忆面纱: "无面记忆面纱", 灵印折步靴: "灵印折步靴", 双钥归一棱镜: "双钥归一棱镜",
  月白归静圣铃: "月白归静圣铃", 超位魔法残章天空坠落: "超位魔法残章·天空坠落",
  光辉翠绿宝石: "光辉翠绿宝石", 黑翼守护重盾: "黑翼守护重盾", 滴管长枪投影: "滴管长枪投影",
  真祖女武神血铠: "真祖女武神血铠", 英灵战乙女蔷薇镜: "英灵战乙女蔷薇镜",
} as const;

export const 祖地秘境战利品装备名 = {
  执刑巨刃: "执刑巨刃",
  金鳞守誓铠: "金鳞守誓铠",
  深渊潮汐法典: "深渊潮汐法典",
  鳞影裂波刃: "鳞影裂波刃",
