...
export interface 主动技能流程模板参数 {
  ...
  结束回调?: (this: void, 上下文: 主动技能流程模板上下文, 原因: 技能阶段链结束原因) => void;
}

export interface 主动技能流程模板实例 {
  阶段链ID: number;
  停止(this: void, 原因?: 技能阶段链结束原因): boolean;
}
...
export function 开始主动技能前摇预警执行模板(this: void, 参数: 主动技能流程模板参数): 主动技能流程模板实例 {
  ...
  const 阶段链ID = 开始技能阶段链(参数.施法者, 阶段列表, {
    数据: 参数.数据,
    结束回调: function 主动技能流程模板结束(this: void, _单位: any, 原因: 技能阶段链结束原因, _阶段链ID: number, 阶段上下文: 技能阶段链上下文): void {
      if (参数.结束回调 != null) {
        参数.结束回调(创建模板上下文(参数, 阶段上下文), 原因);
      }
    },
  });
  ...
  return {
    阶段链ID,
    停止: function 主动技能流程模板停止(this: void, 原因: 技能阶段链结束原因 = "中断"): boolean {
      return 停止技能阶段链(阶段链ID, 原因);
    },
  };
}
