...
export function 创建牵引到达伤害回调(半径: number, 伤害: number, 来源?: any, 标记?: 牵引伤害标记选项): (单位: any, 牵引ID: number) => void {
...
export function 创建牵引回调(选项: 牵引回调选项): 牵引回调结果 {
  ...
  if (选项.到达伤害 != null && 选项.到达伤害 > 0 && 选项.到达伤害半径 != null && 选项.到达伤害半径 > 0) {
    到达回调列表.push(创建牵引到达伤害回调(选项.到达伤害半径, 选项.到达伤害, 选项.到达伤害来源, 选项.到达伤害标记));
  }
  if (到达回调列表.length > 0) {
