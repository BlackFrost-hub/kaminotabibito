...
export const 鹿目圆Buff表: Record<string, BuffData> = {
  [鹿目圆BuffID.因果之力]: {
    buffID: 鹿目圆BuffID.因果之力,
    buffName: "因果之力",
