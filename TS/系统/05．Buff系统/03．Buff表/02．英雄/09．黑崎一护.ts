...
export const 黑崎一护Buff表: Record<string, BuffData> = {
  [黑崎一护BuffID.卍解]: {
    buffID: 黑崎一护BuffID.卍解,
    buffName: "天锁斩月·卍解",
