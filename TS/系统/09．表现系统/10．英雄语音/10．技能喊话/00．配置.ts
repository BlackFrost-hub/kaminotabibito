...
export interface 英雄技能喊话配置 {
  英雄名: string;
  技能ID: string;
  技能槽: string;
  候选台词: readonly [string, string];
  候选语音列表: readonly [string, string];
  随机播放: true;
  语音冷却秒: number;
  三D裁断距离: number;
}
 ...
 */
export const 英雄技能喊话配置列表: readonly 英雄技能喊话配置[] = [
  {
    英雄名: "伊蕾娜",
    技能ID: "AIQ1",
    技能槽: "Q",
...
export type 伊蕾娜变式喊话键 = "迅行" | "镜界" | "灰烬";

/** 伊蕾娜 D 切换成功后的专用喊话，每个变式各两条随机候选。 */
export const 伊蕾娜D变式喊话配置: Record<伊蕾娜变式喊话键, 英雄技能喊话配置> = {
  迅行: {
    英雄名: "伊蕾娜",
    技能ID: "AID1",
    技能槽: "D",
