...
import { createFrame, FrameType } from "../09．表现系统/UI工具";
import { frameSetScriptByCode } from "../00．核心系统/硬件函数";
...
function createDialogFrames(): Frame[] {
  ...
  dzSetAbsPoint(nameText, 3, 0.2425, 0.3);
  dzSetSize(nameText, 0.1, 0.02);
  dzSetText(nameText, "");
