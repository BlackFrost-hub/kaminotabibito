...
function 选取伤害颜色(this: void, damageType: 伤害类型快照): { r: number; g: number; b: number } {
  ...
  if (damageType.isThunderDamage) return { r: 170, g: 220, b: 255 };
  if (damageType.isMetalDamage) return { r: 255, g: 210, b: 80 };
  if (damageType.isWoodDamage) return { r: 120, g: 255, b: 120 };
  if (damageType.isLightDamage) return { r: 255, g: 255, b: 170 };
