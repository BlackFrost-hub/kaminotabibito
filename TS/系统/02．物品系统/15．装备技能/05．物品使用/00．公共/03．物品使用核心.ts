...
const 超位魔法残章天空坠落 = require("系统.02．物品系统.15．装备技能.00．物品.186．超位魔法残章天空坠落") as { 处理超位魔法残章天空坠落使用: (this: void, ctx: 物品技能事件上下文) => void };
const 黑翼守护重盾 = require("系统.02．物品系统.15．装备技能.00．物品.188．黑翼守护重盾") as { 处理黑翼守护重盾使用: (this: void, ctx: 物品技能事件上下文) => void };
const 深井活水囊 = require("系统.02．物品系统.15．装备技能.00．物品.192．深井活水囊") as { 处理深井活水囊使用: (this: void, ctx: 物品技能事件上下文) => void };
const 深渊潮汐法典 = require("系统.02．物品系统.15．装备技能.00．物品.195．深渊潮汐法典") as { 处理深渊潮汐法典使用: (this: void, ctx: 物品技能事件上下文) => void };
const 潮汐蓝宝石 = require("系统.02．物品系统.15．装备技能.00．物品.200．潮汐蓝宝石") as { 处理潮汐蓝宝石使用: (this: void, ctx: 物品技能事件上下文) => void };
const 守灵人指环 = require("系统.02．物品系统.15．装备技能.00．物品.202．守灵人指环") as { 处理守灵人指环使用: (this: void, ctx: 物品技能事件上下文) => void };
...
function on物品使用链路(this: void, ctx: 物品技能事件上下文): void {
  ...
  switch (物品类型ID) {
    ...
    case 物品使用装备ID.阴影陷阱装置:
      ...
      break;
    case 物品使用装备ID.超位魔法残章天空坠落:
      超位魔法残章天空坠落.处理超位魔法残章天空坠落使用(ctx);
      break;
    case 物品使用装备ID.黑翼守护重盾:
      黑翼守护重盾.处理黑翼守护重盾使用(ctx);
      break;
    case 物品使用装备ID.深井活水囊:
      深井活水囊.处理深井活水囊使用(ctx);
      break;
    case 物品使用装备ID.深渊潮汐法典:
      深渊潮汐法典.处理深渊潮汐法典使用(ctx);
      break;
    case 物品使用装备ID.潮汐蓝宝石:
      潮汐蓝宝石.处理潮汐蓝宝石使用(ctx);
      break;
