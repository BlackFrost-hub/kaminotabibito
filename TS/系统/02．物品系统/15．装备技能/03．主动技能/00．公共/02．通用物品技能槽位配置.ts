...
export const 通用物品技能槽位配置表: 通用物品技能槽位配置项[] = [
  ...
  },
  {
    ...
    施法距离: 0,
    施法区域: 0,
    说明: "使用：饮下深井活水，立即恢复30%最大生命与30%最大魔法，冷却15秒。",
  },
  {
  ...
  {
    装备名称: 主动技能装备名称.深渊潮汐法典,
    物编ID: "I0KL", 技能ID: "IP03", 目标类型: "点目标", 命令ID: "shockwave", 冷却间隔组: "IP03",
    冷却时间: 18, 魔法消耗: 0, 施法距离: 700, 施法区域: 160,
    说明: "使用：向目标点方向释放潮汐波，对直线450码、宽160码内敌人造成攻击力100%魔法伤害并减速25%，持续2秒。",
  },
  {
    装备名称: 主动技能装备名称.潮汐蓝宝石,
    物编ID: "I0KQ", 技能ID: "IN14", 目标类型: "无目标", 命令ID: "holybolt", 冷却间隔组: "潮汐蓝宝石-活水回蓝",
    冷却时间: 25, 魔法消耗: 0, 施法距离: 0, 施法区域: 0,
    说明: "使用：立即恢复25%最大魔法，并在5秒内魔法恢复提高100%，冷却25秒。",
  },
  {
    装备名称: 主动技能装备名称.守灵人指环,
    物编ID: "I0KS", 技能ID: "IU14", 目标类型: "单位目标", 命令ID: "heal", 冷却间隔组: "守灵人指环-守灵守护",
    冷却时间: 20, 魔法消耗: 0, 施法距离: 700, 施法区域: 0, 目标允许: "ground,air,friend,self,nonsapper",
    说明: "使用：为一名友方目标施加持有者智力×3的护盾，持续5秒。",
  },
  ...旧主动物品技能壳配置表,
];
