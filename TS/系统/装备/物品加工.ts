...
const itemsData = (require("系统.装备.装备数据") as { default: Record<string, { recipe?: string }> }).default;
const { LeakWatcher } = require("系统.00_核心.泄露审计") as { LeakWatcher: any };
const { CreateFloatTextAtPoint } = require("系统.00_核心.漂浮文字函数") as {
